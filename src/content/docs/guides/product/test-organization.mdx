...
- Has its own organization ID for programmatic API calls
- Can be used with the [By Organization](/guides/product/by-organization) section in the SSO quickstart
