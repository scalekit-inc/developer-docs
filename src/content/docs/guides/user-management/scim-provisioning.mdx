...
browseCentral:
  label: "Automate user and group lifecycle management using SCIM provisioning."
  filterType: ["tutorial"]
...
2. ## Enable admin portal for enterprise customer onboarding
    ...
    <LinkButton href="/directory/guides/onboard-enterprise-customers/" target="_blank" variant='secondary' class='sk-secondary' icon='right-arrow'>See how to onboard enterprise customers</LinkButton>
