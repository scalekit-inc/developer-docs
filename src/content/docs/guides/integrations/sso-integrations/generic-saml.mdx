---
title: "Generic SAML"
description: "Learn how to configure a generic SAML identity provider for secure single sign-on (SSO) with your application."
tags: [sso, saml, identityprovider, enterprise, integration, guide]
prev: false
next: false
sidebar:
  order: 7
