...
description: "Learn how to configure PingIdentity as a SAML identity provider for secure single sign-on (SSO) with your application."
tags: [sso, saml, pingidentity, identityprovider, enterprise, integration, guide]
prev: false
next: false
sidebar:
  order: 5
