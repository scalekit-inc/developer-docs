...
2. ## SAML configuration
   ...
   **OneLogin Admin Portal**
   ...
   ![OneLogin SAML Custom Connector configuration with Recipient, ACS (Consumer) URL Validator, and ACS (Consumer) URL fields highlighted](@/assets/docs/onelogin-saml/2025-12-18-14-28-46.png)
