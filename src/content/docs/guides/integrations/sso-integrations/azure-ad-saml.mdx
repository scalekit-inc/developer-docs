...
3. To map new claims, click **Add a new claim** and select the claim to map. If you created a user attribute in the Scalekit dashboard (for example, `department`), enter that attribute name in the **Name** field. <Badge text="optional" />
