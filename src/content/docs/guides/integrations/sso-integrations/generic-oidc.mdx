---
title: "Generic OIDC"
description: "Learn how to configure a generic OIDC identity provider for secure single sign-on (SSO) with your application."
tags: [sso, oidc, identityprovider, enterprise, integration, guide]
prev: false
next: false
sidebar:
  order: 9
