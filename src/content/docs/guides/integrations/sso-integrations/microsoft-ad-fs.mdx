...
description: "Learn how to configure Microsoft AD FS as a SAML identity provider for secure single sign-on (SSO) with your application."
tags: [sso, saml, microsoft, adfs, identityprovider, enterprise, integration, guide]
prev: false
next: false
sidebar:
  order: 5
...
1. #### Begin the configuration
   ...
   ![Setup SSO Connection dialog with ADFS selected as the identity provider](@/assets/docs/guides/sso-integrations/microsoft-ad-fs/-1-1.png)

   Download Metadata XML file so that you can configure AD FS Server going forward

   ![Service Provider Details panel with the Download Metadata XML link highlighted](@/assets/docs/guides/sso-integrations/microsoft-ad-fs/-1.png)
...
3. #### Create a Relying Party Trust
   ...
   ![AD FS Management Console with the Add Relying Party Trust option selected](@/assets/docs/guides/sso-integrations/microsoft-ad-fs/0-1.png)
...
4. #### Configure Trust Settings
   ...
   ![Select Data Source step in the Add Relying Party Trust Wizard with the metadata file import option selected](@/assets/docs/guides/sso-integrations/microsoft-ad-fs/2.png)
...
7. #### Review Trust Configuration
   ...
   ![Finish step of the Add Relying Party Trust Wizard with the claims issuance policy checkbox selected](@/assets/docs/guides/sso-integrations/microsoft-ad-fs/6.png)
...
8. #### Create claim rule
   ...
   ![Edit Claim Issuance Policy dialog with the Add Rule button highlighted](@/assets/docs/guides/sso-integrations/microsoft-ad-fs/7.png)
   
   Select 'Send LDAP Attributes as Claims' template
   ![Select Rule Template step with Send LDAP Attributes as Claims chosen](@/assets/docs/guides/sso-integrations/microsoft-ad-fs/8.png)
...
9. #### Map User Attributes
   ...
   ![Edit Rule dialog mapping LDAP attributes to outgoing claim types for email, given name, surname, and name ID](@/assets/docs/guides/sso-integrations/microsoft-ad-fs/9.png)
...
10. #### Complete Admin Portal Configuration
    ...
    ![Identity Provider Configuration form with manual entry fields for the IdP entity ID, SAML URL, and X.509 certificate](@/assets/docs/guides/sso-integrations/microsoft-ad-fs/12-1.png)
...
11. #### Test the Integration
    ...
    ![Test single sign-on step showing a successful connection and the received user attributes](@/assets/docs/guides/sso-integrations/microsoft-ad-fs/13.png)
...
12. #### Enable Connection
    ...
    ![Enable single sign-on step with the Enable Connection button](@/assets/docs/guides/sso-integrations/microsoft-ad-fs/14.png)
