...
<Steps>
1. The following user profile attributes must be mapped in Okta so that Scalekit receives user details during SSO login:
...
- [Map custom user attributes](/sso/guides/sso-user-attributes/) to pass additional profile details (e.g., employee number) from Okta to your application.
