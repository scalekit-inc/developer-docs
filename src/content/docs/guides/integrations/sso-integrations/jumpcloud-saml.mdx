...
description: "Learn how to configure JumpCloud as a SAML identity provider for secure single sign-on (SSO) with your application."
tags: [sso, saml, jumpcloud, identityprovider, enterprise, integration, guide]
prev: false
next: false
sidebar:
  order: 4
