...
1. ## Create an Application
   ...
   Sign in to **Microsoft Entra ID** in the <a href="https://portal.azure.com/" target="_blank">Microsoft Azure Portal</a>. Go to **App registrations** and click **New registration** to create a new app. 
