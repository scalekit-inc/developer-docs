...
5. ## Assign users and groups
   ...
   To assign groups and users to the newly integrated application:
   ...
   2. If required, create a new group under "User Management" → "User Groups".
   3. Add users to the group. If no users exist, create them under "User Management" → "Users".
   4. Select the group to be assigned to the application and click "Save".
   5. Confirm the newly created group is assigned to the application.
