...
4. ## Select SCIM Outbound connector
   ...
   1. **Select Identity Store**: Click **Select** to choose an identity store.
      ![](@/assets/docs/pingidentity-scim/select-identity-store.png)
   2. **Choose SCIM Outbound**: From the catalog, select **SCIM Outbound**.
      ![](@/assets/docs/pingidentity-scim/scim-outbound-catalog.png)
   3. **Name and Description**: Provide a name for the application you are onboarding (e.g., "Hero SaaS") and add an optional description. Click **Next**.
       ![](@/assets/docs/pingidentity-scim/name-descriptionpng.png)
...
5. ## Configure connection settings
   ...
   ![](@/assets/docs/pingidentity-scim/config-setuppng.png)
...
6. ## Configure preferences and save
   ...
   ![](@/assets/docs/pingidentity-scim/configure-pref.png)
...
7. ## Configure provisioning rules
   ...
   ![](@/assets/docs/pingidentity-scim/create-rule.png)
   ...
   ![](@/assets/docs/pingidentity-scim/setup-rule.png)
...
8. ## Verify the integration
   ...
   ![](@/assets/docs/pingidentity-scim/synced-users.png)
