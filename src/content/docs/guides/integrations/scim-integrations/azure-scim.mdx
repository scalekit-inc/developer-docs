...
2. ## Add a new application in Entra ID
   ...
   In the "Manage > Enterprise applications" tab, click "+ New application".
...
5. ## Assign User and Group
   ...
   In the created application, go to "Users and groups" and click "+ Add user/group"
   ...
   ![Assign users to application](@/assets/docs/guides/scim-integrations/entra-id-scim/023.png)

   Once the users are selected, the "Assign" button is automatically enabled. Click "Assign".
