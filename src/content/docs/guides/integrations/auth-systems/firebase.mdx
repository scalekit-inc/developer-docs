...
1. #### Add Scalekit as an OpenID Connect provider
...
2. #### Retrieve configuration from Scalekit
...
3. #### Configure Firebase OIDC provider
...
4. #### Add redirect URI to Scalekit
...
5. #### Implement SSO in your application
...
graph LR
    ...
    IdentityProvider --> Scalekit
    Scalekit --> YourBackend[Your Backend]
    YourBackend --> CustomToken[Custom Firebase Token]
    CustomToken --> FirebaseAuth[Firebase Auth]
    FirebaseAuth --> YourApp[Your App]
```
...
1. #### Set up your backend with Scalekit SDK
...
2. #### Create SSO authentication endpoint
...
4. #### Add authorization URL endpoint
...
For detailed implementation instructions, refer to the [IdP-Initiated SSO guide](/guides/sso/idp-init-sso/).
