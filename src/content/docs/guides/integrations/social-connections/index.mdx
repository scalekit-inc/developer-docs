...
tags: [sociallogin, oauth2, authentication, integration, overview]
...
<CardGrid>
  ...
  <FoldCard title="Twitter (X)" href="/guides/integrations/social-connections/twitter" iconKey="twitter">
    Allow users to sign in with their Twitter (X) accounts using OAuth 2.0
  </FoldCard>
</CardGrid>