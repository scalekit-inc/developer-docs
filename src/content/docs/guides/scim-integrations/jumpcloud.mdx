...
<figure>
  ![SCIM Provisioning
  Setup](@/assets/docs/guides/scim-integrations/jumpcloud-scim/1-select-jumpcloud.png)
...
<figure>
  ![Application
  Selection](@/assets/docs/guides/scim-integrations/jumpcloud-scim/3-custom-integration.png)
...
<figure>
  ![Successful
  addition](@/assets/docs/guides/scim-integrations/jumpcloud-scim/5-success-app-creation.png)
...
<figure>
  ...
  Settings](@/assets/docs/guides/scim-integrations/jumpcloud-scim/6-scim-config-page.png)
...
<figure>
  ![Provisioning
  Settings](@/assets/docs/guides/scim-integrations/jumpcloud-scim/7-group-management.png)
