...
TODO: Add screenshot showing webhook logs interface
...
**Endpoint unavailable (5xx errors)**
Your application server is down, experiencing high load, or unreachable. Verify your endpoint is running and accessible from Scalekit's servers.

**Request validation failures (4xx errors)**
Your endpoint rejected the request due to signature verification failure, malformed payload, or business logic validation. Check your signature verification implementation and request handling logic.

**Timeout errors**
Your endpoint took longer than 10 seconds to respond. Optimize your webhook processing to respond quickly, then handle time-consuming operations asynchronously.

**Network connectivity issues**
Firewall rules, DNS resolution failures, or SSL certificate problems prevented delivery. Ensure your endpoint is publicly accessible and has valid SSL certificates.

## Next steps

Now that you understand webhook logs, explore these resources to build robust webhook integrations:
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Common patterns for user lifecycle and organization management"
  />
  <LinkCard
...
<Aside type="note" title="Need help with webhook issues?">
If you're experiencing persistent webhook delivery failures or need assistance debugging your integration, please [contact our support team](/support/contact-us) for personalized help.
</Aside>
