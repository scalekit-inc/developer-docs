...
This guide is a continuation of [Manage organizations](/fsa/guides/manage-organization/). It explains how to set up SSO or SCIM configurations for your customers directly from the Scalekit Dashboard, as an alternative to sending them an admin portal link.
