...
If signed-in users in your application need a broader self-serve portal (members, profiles, security, domains, session policy, and enterprise setup), see [Hosted UI widgets](/authenticate/manage-users-orgs/hosted-widgets/). Use the Admin portal when you need a shareable link or an iframe embed for enterprise SSO and SCIM setup.
