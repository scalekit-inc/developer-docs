...
on implementing the IdP-initiated SSO flow, refer to [Implement IdP-Initiated SSO](/sso/guides/setup-sso/implement-idp-initiated-sso) guide. This guide walks you through the necessary steps to set up and handle SSO requests originating from the identity provider.
...
```javascript {2, 6-8, 13 } title="Login.js" showLineNumbers
