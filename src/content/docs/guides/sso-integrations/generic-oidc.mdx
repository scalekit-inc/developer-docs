...
<figure>
  ...
  Configure](@/assets/docs/guides/sso-integrations/oidc-custom-provider/0.png)
...
<figure>
  ![Copy Redirect
  URI](@/assets/docs/guides/sso-integrations/oidc-custom-provider/1.png)
...
<figure>
  ...
  ](@/assets/docs/guides/sso-integrations/oidc-custom-provider/2.png)
...
<figure>
  ...
  Portal](@/assets/docs/guides/sso-integrations/oidc-custom-provider/3.png)
  <figcaption>
...
<figure>
  ...
  Portal](@/assets/docs/guides/sso-integrations/oidc-custom-provider/4.png)
  <figcaption>
...
<figure>
  ...
  Update](@/assets/docs/guides/sso-integrations/oidc-custom-provider/5.png)
...
<figure>
  ...
  Portal](@/assets/docs/guides/sso-integrations/oidc-custom-provider/6.png)
  <figcaption>
...
<figure>
  ![Test SSO
  Configuration](@/assets/docs/guides/sso-integrations/oidc-custom-provider/7.png)
...
<figure>
  ...
  ](@/assets/docs/guides/sso-integrations/oidc-custom-provider/8.png)
