...
<figure>
  ![Select SAML Custom Connector from drop down (GIF)](@/assets/docs/guides/sso-integrations/onelogin-saml/2-5.gif)
...
<figure>
  ...
  Portal](@/assets/docs/guides/sso-integrations/onelogin-saml/5.png)
  <figcaption>
...
<figure>
  ...
  Portal](@/assets/docs/guides/sso-integrations/onelogin-saml/7.png)
...
<figure>
  ![Paste attributes on OneLogin Admin Portal](@/assets/docs/guides/sso-integrations/onelogin-saml/10-5.gif)
