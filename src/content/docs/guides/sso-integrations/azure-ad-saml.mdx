...
<figure>
  ![Download Metadata
  XML](@/assets/docs/guides/sso-integrations/azure-ad-saml/0.png)
...
<figure>
  ![Locate Enterprise
  applications](@/assets/docs/guides/sso-integrations/azure-ad-saml/1.png)
...
<figure>
  ![Click on New
  application](@/assets/docs/guides/sso-integrations/azure-ad-saml/2.png)
...
<figure>
  ...
  ID](@/assets/docs/guides/sso-integrations/azure-ad-saml/3.gif)
...
<figure>
  ...
  sign-on](@/assets/docs/guides/sso-integrations/azure-ad-saml/4.png)
...
<figure>
  ...
  file](@/assets/docs/guides/sso-integrations/azure-ad-saml/4-5.png)
...
<figure>
  ![**SSO Configuration
  Portal**](@/assets/docs/guides/sso-integrations/azure-ad-saml/7.png)
  <figcaption>SSO Configuration Portal</figcaption>
</figure>

<figure>
  ![**Microsoft Entra
  ID**](@/assets/docs/guides/sso-integrations/azure-ad-saml/8.png)
...
<figure>
  ...
  application](@/assets/docs/guides/sso-integrations/azure-ad-saml/9.gif)
...
<figure>
  ...
  URL](@/assets/docs/guides/sso-integrations/azure-ad-saml/10.png)
...
<figure>
  ...
  URL](@/assets/docs/guides/sso-integrations/azure-ad-saml/11.png)
...
<figure>
  ...
  SSO](@/assets/docs/guides/sso-integrations/azure-ad-saml/12.png)
...
<figure>
  ![Enable SSO on Entra
  ID](@/assets/docs/guides/sso-integrations/azure-ad-saml/13.png)
