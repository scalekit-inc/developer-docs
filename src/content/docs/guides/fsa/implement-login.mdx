 ...
 1. ## Install the Scalekit SDK
  ...
  2. ## Redirect to the login page
       Generate the authorization URL to redirect users to the Scalekit-managed login page. To get a `refreshToken` for session management, ensure you include `offline_access` in the scopes.
        ...
        String authorizationUrl = scalekit.authentication().getAuthorizationUrl(redirectUri, options);
      ...
      <Tabs syncKey="tech-stack">
        ...
        async def callback():
            ...
            try:
                ...
                auth_result = scalekit.authenticate_with_code(code, redirect_uri, options)
        ...
        func handleCallback(c *gin.Context) {
            ...
            authResult, err := scalekit.AuthenticateWithCode(code, redirectUri, options)
            if err != nil {
