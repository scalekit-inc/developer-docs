...
![Scalekit Redirect URLs settings showing allowed callback, initiate-login, and post-logout URLs using templated organization slug patterns](@/assets/docs/template-redirect-uris/2026-05-22-12-22-55.png)
