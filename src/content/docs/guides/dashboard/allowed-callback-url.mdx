...
![Scalekit Redirect URLs tab showing the Allowed callback URLs section with several registered callback endpoints and an Add URL button](@/assets/docs/allowed-callback-url/allowed-callback-url.png)
