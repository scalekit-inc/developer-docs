...
- **Browser extensions**: Use schemes like `extension://` for browser extension integration
...
- `extension://popup/auth` - For browser extension authentication
