...
![Scalekit Authentication settings showing the Initiate-login URL section with a registered endpoint and an Add URL button](@/assets/docs/intitate-login-endpoint/add-initiate-login-url.png)
