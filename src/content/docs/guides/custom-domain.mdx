...
tags: [customdomain, branding, configuration, authentication, guide]
sidebar:
...
<Aside type="note" title="Existing connections?">
If you have existing SSO or SCIM connections, they will continue to use your previous Scalekit environment domain. New connections will use your custom domain going forward.
</Aside>
