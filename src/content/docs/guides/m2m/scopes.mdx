---
title: Define and validate API client scopes
description: Learn how to define permissions for API client applications using scopes and validate them in your API server.
browseCentral:
  label: "API scopes and permissions"
  filterType: ["tutorial"]
  category: ["API authentication"]
  icon: "book"
sidebar:
  label: Define & validate API client scopes
prev:
