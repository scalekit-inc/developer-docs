   ...
   **Example implementation**
   ...
   # }
    ...
    <details>
      ...
      | `magiclink_auth_uri` | No | URL Endpoint to handle magic link token verification. Example: https://yourapp.com/passwordless/verify Required only for magic link authentication. <Badge variant="note" text="string" /> |
    </details>
