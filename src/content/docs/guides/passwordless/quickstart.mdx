...
This guide shows you how to implement passwordless authentication using Scalekit's APIs to send either verification codes or magic links to your user's email address and verify their identity.
