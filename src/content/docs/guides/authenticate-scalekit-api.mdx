---
title: Authenticate with Scalekit API
description: Learn how to authenticate your server applications with Scalekit API using OAuth 2.0 Client Credentials flow
tags: [m2m, api-auth, oauth2, client-credentials, server-app, tokens]
sidebar:
