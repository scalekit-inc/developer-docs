---
title: Preserve the user's intended destination
...
sidebar:
  label: "Preserve user destination after login"
browseCentral:
  label: "Send users to requested page post-auth"
  filterType: ["tutorial"]
...
prev:
  link: '/guides/webhooks-best-practices/'
  label: 'Following webhook practices'
next:
  link: '/guides/user-auth/external-id-system-integration/'
  label: 'Integrating external ID systems'
---
