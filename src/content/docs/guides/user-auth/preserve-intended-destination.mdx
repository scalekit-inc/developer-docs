...
description: Redirect users back to page they asked for after authentication using a signed return URL
tags: [authentication, redirect, return-url, oauth, callback, user-experience]
