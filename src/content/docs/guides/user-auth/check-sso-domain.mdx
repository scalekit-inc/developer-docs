...
tags: [sso, domain, validation, authentication, guide]
browseCentral:
  ...
  icon: "book"
sidebar:
  label: "Check SSO connection availability"
prev:
...
<Aside type="tip" title="Domain must be verified">
Home Realm Discovery only works for domains that have been verified by the organization. See [Organization domains](/authenticate/manage-users-orgs/organization-domains/) to understand how organizations verify domain ownership via DNS.
</Aside>
