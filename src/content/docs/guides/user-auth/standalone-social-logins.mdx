...
browseCentral:
  ...
  icon: book
sidebar:
  label: Building standalone social logins
head:
  - tag: style
    content: |
...
1. ## Set up Scalekit and register a callback endpoint
   ...
   Follow the [installation guide](/authenticate/installation/) to configure Scalekit in your application. Go to Dashboard > Authentication > General to turn off the Full-Stack Auth since you'd use the standalone social logins module. This disables user management and session management features and let's to only use social login authentication.
