...
#### Prerequisites
    ...
    *   A Scalekit account with access to the M2M authentication feature. [Get it now](/guides/setup-scalekit/).
    *   Familiarity with [authenticating requests to the Scalekit API](/guides/authenticate-scalekit-api/).
...
1. ### Register an M2M client
    ...
    |-----------|------|-------------|
    | <pre>name</pre> | <pre>string</pre> | A descriptive name for the M2M client (e.g., "GitHub Actions Deployment Service") |
...
2. ### Authenticate the M2M client
    ...
    Refer to [API Authentication for M2M clients](/guides/m2m/api-auth-m2m-clients/) for detailed information on how M2M clients authenticate.
