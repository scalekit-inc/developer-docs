...
<CardGrid>
  ...
  <LinkCard title="Connections" href="/agent-actions/connections">
    Configure authentication and provider settings
  </LinkCard>
  <LinkCard title="Tool Execution" href="/agent-actions/tools/execute">
...
<Aside type="note">
**Ready to get started?** Check out our [Quickstart Guide](/agent-actions/quickstart) to build your first Agent Actions integration in minutes.
</Aside>
