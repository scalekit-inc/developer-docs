...
1. Navigate to **Agent Actions** → **Connected Accounts**
...
- [Token Management](/agent-actions/authentication/token-management) - Understanding token lifecycle
- [Scopes and Permissions](/agent-actions/authentication/scopes-permissions) - Managing OAuth scopes
- [Multi-Provider Authentication](/agent-actions/authentication/multi-provider) - Managing multiple connections