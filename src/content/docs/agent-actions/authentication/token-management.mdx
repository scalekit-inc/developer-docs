...
- [Scopes and Permissions](/agent-actions/authentication/scopes-permissions) - Managing OAuth scopes and permissions
- [Authentication Troubleshooting](/agent-actions/authentication/troubleshooting) - Debugging authentication issues
