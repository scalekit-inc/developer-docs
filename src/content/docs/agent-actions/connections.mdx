---
title: Connections
description: Learn how to configure and manage connections in Agent Actions to enable authentication and tool execution with third-party providers.
sidebar:
  order: 3
  label: "Connections"
tableOfContents:
...
prev:
  label: "Providers"
  link: "/agent-actions/providers"
next:
  label: "Connected accounts"
  link: "/agent-actions/connected-accounts"
---
...
<Steps>
1. **Navigate to connections** in your Agent Actions dashboard
...
Next, learn how to create and manage [Connected accounts](/agent-actions/connected-accounts) that use these connections to authenticate and execute tools for your users.