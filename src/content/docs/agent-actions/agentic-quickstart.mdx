...
description: Learn how to authenticate a user to GMail and use LLMs to create an agentic tool calling workflow using LangChain or Google ADK.
---

import { LinkCard, CardGrid, Aside, Steps, Tabs, TabItem } from '@astrojs/starlight/components';
import InstallSDK from '@components/templates/_installsdk.mdx';

This quickstart guide will help you implement tool calling using LLMs to determine which tool to call with what parameters based on the user's input. Choose from popular AI frameworks like LangChain or Google ADK.
...
For more detailed framework-specific implementations, explore our AI framework guides:

<CardGrid>
  <LinkCard title="LangChain Framework" icon="star" href="/agent-actions/frameworks/langchain">
    Build agents using LangChain with advanced tool calling and workflow capabilities.
  </LinkCard>
  <LinkCard title="Google ADK Framework" icon="star" href="/agent-actions/frameworks/google-adk">
