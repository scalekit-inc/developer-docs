...
- **SQL execution tools**: Execute statements and manage status, partitions, and cancel operations
- **Metadata tools**: Supports `SHOW` commands and `INFORMATION_SCHEMA`-based queries for databases, schemata, tables, columns, and constraints
