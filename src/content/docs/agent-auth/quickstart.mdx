...
- [Secure user verification](/agent-auth/user-verification/) — Confirm the OAuth identity matches your logged-in user before activating a connected account. Required for production.
- [Connected accounts](/agent-auth/connected-accounts/) — Manage user connections across multiple providers.
- [Tool calling](/agent-auth/tools/agent-tools-quickstart/) — Use Scalekit's optimized tools to call APIs without managing endpoints yourself.
