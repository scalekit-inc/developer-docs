---
title: Auth patterns
description: Learn the supported auth types, provider payload fields, and auth pattern configuration used by bring your own provider.
tags: [agentauth, providers, auth, oauth2, proxy, guide]
sidebar:
  label: "Auth patterns"
tableOfContents:
  maxHeadingLevel: 3
