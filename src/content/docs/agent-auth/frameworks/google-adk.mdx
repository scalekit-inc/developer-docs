---
title: Google ADK
description: Build a Google ADK agent that authenticates users with Gmail and executes tools on their behalf using Scalekit Agent Auth.
...
seeAlso:
  ...
  expanded: true
  items:
    - title: "Agent Auth code examples"
      icon: "github"
