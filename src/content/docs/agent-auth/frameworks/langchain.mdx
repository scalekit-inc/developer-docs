---
title: LangChain
description: Learn how to use LangChain with Agent Auth.
...
<Aside >
  Find the full code for this quickstart on [Github](https://github.com/scalekit-inc/sample-langchain-agent)
</Aside>
...
- **Scalekit API credentials** Client ID and Client Secret environment from  [app.scalekit.com](https://app.scalekit.com)
