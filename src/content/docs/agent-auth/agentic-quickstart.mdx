...
description: Learn how to authenticate a user to GMail and use LLMs to determine which tool to call with what parameters based on the user's input.
tags: [agent-auth, quickstart, ai-agents, agentic-tool-calling, oauth, llm, tool-integration]
---
