---
title: Dryrun
description: Validate your Scalekit configuration by running a complete OAuth flow locally before writing integration code.
tableOfContents: true
prev: false
sidebar:
  label: Dryrun
  order: 1
tags: [scalekit, tools, testing, oauth, dev-kit]
head:
  - tag: style
    content: |
...
Use Dryrun when you want to confirm your Scalekit authentication configuration works end-to-end before writing integration code.

Validate your Scalekit environment before writing integration code. Dryrun executes a complete OAuth flow locally - spinning up a server, opening your browser, and displaying the authenticated user’s profile and tokens, so you can catch configuration errors early.
