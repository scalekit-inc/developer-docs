...
If you need a provider that is not yet available with Scalekit credentials, we add new providers based on customer demand. You can request a provider using this [request form](https://www.notion.so/scalekitinc/27887a580a3780fbb4b8fad28038392a?pvs=106), or join our [Slack community](https://docs.scalekit.com/support/contact-us/) and ask in the `#ask-anything` channel.
</Aside>
