...
sidebar:
  label: 'Use Scalekit credentials'
---
...
![Scalekit dashboard Social Login settings for Google with "Use Scalekit credentials" selected under OAuth Configuration](@/assets/docs/use-scalekit-credentials/01.png)
