...
<Aside type="note" title="Choosing a region (US or EU)">
  Environments live within a workspace, and a workspace's region (US or EU) is chosen at signup and can't be changed afterward. See [Set up EU data residency](/dev-kit/guides/dashboard/data-residency/) if you need your production environment hosted in the EU.
</Aside>
