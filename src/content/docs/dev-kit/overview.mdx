...
Scalekit provides official SDKs for Node.js, Python, Go, and Java with production-ready auth helpers, automatic retries, and typed models to help you integrate faster. Additionally, you can connect your AI coding assistants to Scalekit through our Model Context Protocol (MCP) server for natural language-based development.
...
4. ## Set up Scalekit MCP Server (Optional)
   ...
   If you're building your own MCP server and need to add OAuth-based authorization, check out our guide: [Add auth to your MCP server](/mcp/quickstart/).
   </Aside>
