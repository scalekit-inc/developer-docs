...
sidebar:
  label: "Following authorization practices"
browseCentral:
  label: "Secure authorization best practices"
  filterType: ["tutorial"]
...
seeAlso:
  ...
  items:
    ...
    - title: "Set up roles"
      icon: "user"
      url: "/authenticate/authz/create-roles-permissions/"
...
next:
  link: '/guides/security/csrf-protection/'
  label: 'Implement CSRF protection'
---
