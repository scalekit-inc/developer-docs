...
<ProductAgentBlock skill="implementing-saaskit" syncKey="setup-scalekit-cli" />

Or another shipped skill: `integrating-agentkit`, `adding-mcp-oauth`, `implementing-modular-sso`, `implementing-scim-provisioning`.

Full guide: [Build with AI](/dev-kit/build-with-ai/).
