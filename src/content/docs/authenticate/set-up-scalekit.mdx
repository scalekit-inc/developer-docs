...
<ProductAgentBlock
  skill="implement-saaskit"
  example="Use implement-saaskit to add login, sessions, and logout."
...
| ------- | -------------- |
| AgentKit | `Use integrate-agentkit to connect this agent to Gmail.` |
| MCP authentication | `Use add-mcp-oauth to add OAuth 2.1 to this MCP server.` |
| Single sign-on (SSO) | `Use implement-sso to add SAML and OIDC SSO.` |
| SCIM | `Use implement-scim to add user provisioning.` |
