...
tags: [mcp-auth, oauth2, model-context-protocol, ai-agents, security, authorization]
tableOfContents: false
browseCentral:
  label: "Mechanism behind auth for MCP servers"
  category:
    - "MCP authentication"
  filterType:
    - "tutorial"
...
seeAlso:
  items:
    ...
    - title: "Explore MCP architecture"
      icon: "blog"
...
next:
  ...
  label: 'Integrate custom auth with MCP'
---
