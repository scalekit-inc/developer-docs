---
title: Bring your own auth into your MCP server
description: Federated authentication system with Scalekit's OAuth 2.1 authorization layer for MCP servers
tags: [mcp-auth, oauth2, federation, custom-auth, integration, tutorial]
sidebar:
