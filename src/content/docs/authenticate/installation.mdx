...
1. #### Create a Scalekit account
   ...
   <LinkButton href="https://app.scalekit.com/ws/signup" variant="minimal"  icon='right-arrow'>Create a Scalekit Account</LinkButton>
...
5. #### Verify your setup
   ...
   You're all set. [Continue to pick your auth challenge →](/authenticate/welcome#for-agent-developers)
