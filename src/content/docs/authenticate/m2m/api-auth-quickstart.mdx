...
3. ## Validate access tokens in your API server
   ...
   Find complete code examples in the <a href="https://github.com/scalekit-inc/gists/tree/main/m2m" target="_blank" rel="noopener">Scalekit M2M Gists repository</a>.
