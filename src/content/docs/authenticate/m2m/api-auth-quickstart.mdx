...
browseCentral:
  label: Build authentication into your APIs
  filterType: ["tutorial"]
...
1. ## Installation
   ...
   ```
   Alternatively, you can use the [REST APIs directly](https://docs.scalekit.com/apis/#tag/api-auth).

   <Aside>
   Currently Scalekit supports Python SDKs, <a href="/support/contact-us" target="_blank">contact us</a> if you need support for your tech stack.
   </Aside>
