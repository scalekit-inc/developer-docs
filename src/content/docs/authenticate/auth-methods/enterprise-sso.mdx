...
4. ## Identify and enforce SSO for organization users
    ...
    <Aside>
    If you use discovery (for example, `domain_hint`), consider a lightweight pre‑check to avoid dead‑end redirects. See [onboard enterprise customers guide](/fsa/guides/onboard-enterprise-customers/).
    </Aside>
