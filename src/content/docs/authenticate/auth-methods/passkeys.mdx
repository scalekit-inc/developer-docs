...
tags: [passkeys, webauthn, passwordless, authentication, biometric-auth, security]
...
3. ## Users can login with passkeys
   ...
   During sign-up, you'll continue to use established authentication methods like [verification codes, magic links](/fsa/guides/passwordless/) or [social logins](/authenticate/auth-methods/social-logins/). Once a user is registered, they can then add passkeys as an additional, convenient login option.
</Steps>