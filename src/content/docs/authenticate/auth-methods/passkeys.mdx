...
To use passkeys, users must signed up using one of the existing authentication methods such as [verification codes, magic links](/authenticate/auth-methods/passwordless/) or [social logins](/authenticate/auth-methods/social-logins/).
