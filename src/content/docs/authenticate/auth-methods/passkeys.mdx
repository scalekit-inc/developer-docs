...
tags: [passkeys, webauthn, passwordless, authentication, biometric-auth, security, guide]
...
2. ## Manage passkey registration
    ...
    <Aside type="note" title="The hosted page does not redirect back to your app">
    After a user registers or manages a passkey, Scalekit doesn't redirect them back to your application from this page. Give users a clear way to return — for example, open the page in a new browser tab, or place the "Manage passkeys" entry point where users can navigate back to your app.
    </Aside>
