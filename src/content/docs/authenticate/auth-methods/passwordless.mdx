---
title: Sign in with  magic link or Email OTP
description: Enable passwordless sign-in with email verification codes or magic links
tags: [passwordless, magic-link, email-otp, authentication, users, security]
sidebar:
  label: "Magic link or email OTP"
prev:
  label: "Quickstart"
