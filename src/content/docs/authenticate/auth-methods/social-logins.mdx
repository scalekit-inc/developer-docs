...
tags: [social-login, social-auth, authentication, oauth2, oidc, google, microsoft, github]
sidebar:
  label: "Social logins"
...
3. ## Test the social connection
    ...
    ![Scalekit Test Connection panel for Google showing sign-in test instructions, common error causes, and a Retry Test button](@/assets/docs/social-logins-quickstart/test-connection.png)
