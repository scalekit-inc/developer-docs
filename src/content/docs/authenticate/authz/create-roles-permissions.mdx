...
tags: [rbac, roles, permissions, authorization, access-control, users]
sidebar:
...
import {
  Tabs, TabItem, Badge, Aside, LinkCard, Steps, Code, LinkButton
...
![Scalekit dashboard Roles & Permissions page showing the Manage Roles table with admin, member, and viewer roles and a Default Roles panel](@/assets/docs/app-roles/app-roles-view.png)
...
![Organization Roles tab for a single organization, showing application roles, organization roles, and a default organization role selector](@/assets/docs/app-roles/add-organization-role.png)
