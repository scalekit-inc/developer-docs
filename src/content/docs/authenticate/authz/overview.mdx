...
By default, Scalekit assigns the first user in an organization the `admin` role, and subsequent users receive the `member` role. You can customize these defaults and create additional roles specific to your application's needs through the dashboard.
