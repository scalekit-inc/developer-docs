...
description: "Learn how to assign roles to users in your application using to dashboard, SDK, or automated provisioning"
tags: [rbac, roles, permissions, users, authorization, access-control, provisioning]
...
![Roles & Permissions page listing admin, member, and viewer roles, with a Default Roles panel for choosing the creator and member roles](@/assets/docs/assign-roles/full-page-highlighth-defaults.png)
...
![Organization roles view with a Default organization role dropdown for assigning a role to new users joining that organization](@/assets/docs/assign-roles/default_org_member_role.png)
