...
Scalekit SDK -> Your App: Signature validation result
Your App -> Your App: Process event data
Your App -> Event Queue: Return 200 OK response

Event Queue: {
  shape: class
  Retry Logic: "3 retries with exponential backoff"
  Timeout: "10 seconds per attempt"
  Dead Letter: "Failed events stored for analysis"
}
```
...
<CardGrid>
  <LinkCard 
    ...
    description="Complete reference of all available webhook events and payloads"
  />
  <LinkCard 
    title="Webhooks best practices" 
