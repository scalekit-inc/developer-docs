...
<details>
<summary>Domains to whitelist for customer VPNs and firewalls</summary>
...
<Aside type="tip">
Replace `your-app.scalekit.com` with your actual Scalekit environment URL. Customers can find this in their Scalekit dashboard under **Settings > API Config**.
</Aside>

</details>

- [ ] Verify customer firewalls allow Scalekit domains (see table above)
