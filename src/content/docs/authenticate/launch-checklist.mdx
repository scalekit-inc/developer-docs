...
<Aside type="tip" title="Track your progress">
  Copy this checklist to your project management tool or create a spreadsheet to track completion status and assign owners for each item.
</Aside>
