...
2. ## Check the session before handling requests
   ...
   <Tabs syncKey="tech-stack">
     ...
     Full reference: [requiresAuth](/saaskit/sdks/express/#requiresauth).
     ...
     Full reference: [withAuth](/saaskit/sdks/nextjs/#withauth) and [createMiddleware](/saaskit/sdks/nextjs/#createmiddleware).
