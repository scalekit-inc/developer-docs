...
You will see a list of applications already created for the selected environment. Every environment includes a **default application**. This application is environment-scoped and **cannot be deleted**.
