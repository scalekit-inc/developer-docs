...
1. ### Create applications in Scalekit
    Create [applications](/authenticate/fsa/multiapp/manage-apps) in Scalekit for each of your apps. During setup, select the app type. Use the [guide]((/authenticate/fsa/multiapp/overview/#choose-your-app-type)) below to choose the right one.
