...
<Aside type="tip" title="Build with a coding agent">
  Use Claude Code, Cursor, or GitHub Copilot CLI to implement this integration in minutes. [See the coding agent guide →](/dev-kit/build-with-ai/full-stack-auth/)
</Aside>
