...
description: "Configure user management settings, including user attributes and configuration options from to Scalekit dashboard."
tags: [users, organizations, settings, management, dashboard, configuration]
browseCentral:
...
prev:
  link: '/authenticate/manage-users-orgs/merge-identities/'
...
![Scalekit dashboard User Management settings tab with toggles for sign-up, user limit per organization, invitation expiry, and organization meta name](@/assets/docs/fsa/user-management/2-configuration.png)
...
![Organization User limit setting enabled with a maximum of 25 users, including active users and pending invitations](@/assets/docs/manage-organization/limit-org-users.png)
...
![Scalekit dashboard Users page listing application users with their email and active or inactive status](@/assets/docs/fsa/user-management/1-user-profile.png)
