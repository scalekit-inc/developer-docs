...
Use AI coding agents to accelerate your Full Stack Auth integration. This guide shows you how to configure and use coding agents like Claude Code to implement Scalekit's full-stack authentication end-to-end in your web applications.
...
4. ## Generate authentication implementation
   ...
   1. Loads the Full Stack Auth skill from the marketplace
   2. Analyzes your existing application structure
   3. Generates Scalekit client initialization with environment credentials
   4. Creates the login redirect handler
   5. Implements the OAuth callback to exchange the authorization code for tokens
   6. Adds secure session storage and a logout endpoint
