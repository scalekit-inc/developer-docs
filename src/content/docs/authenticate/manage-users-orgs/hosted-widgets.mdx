...
If you need a shareable link or iframe embed for enterprise IT admins to configure SSO, SCIM, and organization domain verification, use the [Admin portal](/guides/admin-portal/) instead. Hosted UI widgets are the better fit for signed-in users who open self-serve settings from inside your product.
...
No. Use the [Admin portal](/guides/admin-portal/) for iframe embeds and shareable links. The Admin portal supports enterprise setup for SSO, SCIM, and organization domain verification. Hosted UI widgets are full-page experiences only; redirect users to `/ui/`.
