...
tags: [organizations, email-domains, security, users, validation, multi-tenant]
...
2. ### Configure restriction options
   ...
   ![Authentication General tab showing Sign-up Settings with toggles to block sign-up for public email domains and disposable email domains](@/assets/docs/signup-restrictions/ui.png)
...
![Organization settings page with the Allowed email domains section listing acmecorp.com and an Add domain button](@/assets/docs/allowed-email-domains/dashboard.png)
