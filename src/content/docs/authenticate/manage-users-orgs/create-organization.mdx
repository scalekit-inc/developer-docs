...
Applications often provide options for users to create their own organizations. For example, show an option for users such "Create new workspace" within their app. Use the Scalekit SDK to power such options:
