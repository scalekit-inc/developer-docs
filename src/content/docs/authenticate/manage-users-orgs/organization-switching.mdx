...
tags: [organizations, multi-organization, organization-switching, users, sessions, multi-tenant]
sidebar:
...
![Scalekit organization switcher screen listing a user's organizations and a pending invitation with a Join button](@/assets/docs/fsa/org-switcher/1-switcher.png)
