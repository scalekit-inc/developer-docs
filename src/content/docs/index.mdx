  ...
  <div class="fold-container">
    <div class="agent-home-layout">
      <div class="agent-home-copy">
        <h1>Auth and actions for your agents</h1>
        <div style="font-size: 1.1rem; text-align: left;">
          <p style="margin: 0;">Connect SaaS apps and APIs on behalf of users without building OAuth edge cases and token lifecycle plumbing yourself.</p>
