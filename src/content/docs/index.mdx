...
<LinkButton href="/fsa/quickstart" variant="primary" icon='rocket'>
  ...
  <div class="auth-modules-section" id="auth-modules">
    ...
    <h2 style={{ textAlign: 'center', marginTop: '2rem', marginBottom: '0rem' }}>Drop in only the auth module you need</h2>
    ...
    <div>
      <h3 style={{ marginTop: '0.2rem' }}>Secure APIs and MCP servers</h3>
      <div class="card-grid-3">
     <Card title="Add API Auth">
      ...
      <Card title="Add MCP Auth">
        <p>Ship MCP servers with OAuth 2.1 built-in including DCR, PKCE, and scoped token issuance</p>
        <LinkButton href="/guides/mcp/overview/" variant="minimal" icon='right-arrow'>Launch MCP Auth</LinkButton>
      </Card>
      </div>
    </div>
        <div>
      <h3 style={{ marginTop: '0.2rem' }}>Other auth methods</h3>
      <div class="card-grid-3">
     <Card title="Passwordless">
      ...
      <Card title="Social Logins">
        <p>Offer social logins with Google, Microsoft, LinkedIn, Salesforce, and more</p>
      ...
      <div class="card-grid-3">
        <Card>
          Power every customer’s unique setup:
            ...
            - Support multitenancy with per org auth policies
            - Enable any login method from SSO to passwordless
            - Configure users and session lifecycles
            </div>

            <div style={{ marginBottom: '0rem' }}>
            - Drop in ready-made UI components
            - Integrate roles, permissions, and access controls
            - Secure MCP servers and APIs
            </div>
