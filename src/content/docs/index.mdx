...
<div>
  ...
  <p>
    Learn how to [sign in](/manual/getting-started/authenticate-users), [manage sessions](/manual/getting-started/manage-user-sessions), [provision users](/coming-soon), and [sign out users](/manual/getting-started/sign-out).
  </p>
</div>
