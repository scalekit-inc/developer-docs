...
- Single API for all integrations with Azure AD, Google Workspace, Rippling, and more directories
    ...
    <LinkButton href="/scim/quickstart" variant="secondary">SCIM Quickstart &rarr;</LinkButton>
</Card>
...
- Leverage trusted social platforms to provide secure, verified logins to users
    ...
    <LinkButton href="/sso/social-login" variant="secondary">Social Logins Quickstart &rarr;</LinkButton>
</Card>
...
- Customize the portal with UI, colors that match your app's look and feel
    ...
    <LinkButton href="/sso/quickstart-admin-portal" variant="secondary">Configure Admin Portal &rarr;</LinkButton>
</Card>
