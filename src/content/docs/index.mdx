...
<h5>Ship SSO in a day, no custom dev</h5>
...
- Includes SP-initiated and IdP-initiated SSO flows
    ...
    <LinkButton href="/sso/quickstart" variant="secondary">SSO Quickstart &rarr;</LinkButton>
</Card>

<Card>
<div class="card-content">
<h5>SCIM Provisioning, ready in hours</h5>
...
<Card>
<div class="card-content">
<h5>Social Logins, out of the box</h5>
...
- Leverage trusted social platforms to provide secure, verified logins to users
    ...
    <LinkButton href="/social-logins/quickstart/" variant="secondary">Social Logins Quickstart &rarr;</LinkButton>
</Card>

<Card>
<div class="card-content">
<h5>Self-serve setup with admin portal</h5>
...
- Customize the portal with UI, colors that match your app's look and feel
    ...
    <LinkButton href="/guides/sso/admin-portal/" variant="secondary">Configure Admin Portal &rarr;</LinkButton>
</Card>
