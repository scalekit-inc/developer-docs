...
seeAlso:
  items:
    - title: "MCP server with auth example"
      icon: "github"
...
6. ## Enable additional authentication methods
   ...
   **[Enterprise SSO](/authenticate/auth-methods/enterprise-sso/)**
   ...
   <Aside type="note" title="Enterprise SSO">
    This requires the organization administrators to register the domain their organization owns with Scalekit through [the admin portal](/fsa/guides/onboard-enterprise-customers/#verify-domain-ownership).
   </Aside>
