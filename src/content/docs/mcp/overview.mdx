...
<LinkCard href="/mcp/oauth" title="MCP OAuth 2.1 implementation guide" description="Step-by-step instructions for setting up production-ready authorization for your MCP server, including code examples and best practices." />