...
7. ## Connect with an MCP client
    ...
    ![MCP Inspector](@/assets/docs/guides/mcp/mcp-inspector-fastmcp.png)
     ...
     <Aside>
     Leave the Inspector's Authentication fields empty. This quickstart uses dynamic client registration (DCR); entering a Client ID/Secret disables DCR and causes errors.
     </Aside>
