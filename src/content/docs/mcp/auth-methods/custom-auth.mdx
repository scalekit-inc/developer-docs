...
If your url is `https://yourapp.scalekit.com/api/v1/connections/conn_1234567890/auth-requests/{{login_request_id}}/user`, the your connection_id is `conn_1234567890`.
