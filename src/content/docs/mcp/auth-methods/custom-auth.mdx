...
try:
    response, _ = scalekit.auth.update_login_user_details(
...
func updateLoggedInUserDetails() error {
	...
	resp, err := skClient.Auth().UpdateLoginUserDetails(context.Background(), &scalekit.UpdateLoginUserDetailsRequest{
