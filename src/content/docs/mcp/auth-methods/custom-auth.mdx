...
**Try out our BYOA MCP Server:** We have also put together a demo MCP server to illustrate the flow that your MCP Auth will flow if you were to implement your own auth integration. If you are keen on using your own auth implementation, it is highly recommended for you to clone and test this <a href="https://github.com/scalekit-inc/byoa-demo-mcp" target="_blank" rel="noopener">GitHub</a> repo as well.