...
**Try out the BYOA MCP Server**: Scalekit provides a demo MCP server that shows how to implement your own auth integration. Clone the BYOA MCP server to test end-to-end authentication in your environment.