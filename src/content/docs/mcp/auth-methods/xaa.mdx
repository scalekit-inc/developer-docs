...
- **Pre-registered confidential clients** — If your MCP client requires a fixed `client_id` and `client_secret`, pre-register it and provide your customer with the client id and secret for them to configure in their MCP clients.
