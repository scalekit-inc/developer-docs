...
description: Use Scalekit's out-of-the-box enterprise SSO connections to authenticate your MCP server from first request.
tags: [mcp-auth, sso, enterprise, saml, oidc, okta, azure-ad]
tableOfContents:
  maxHeadingLevel: 3
sidebar:
  order: 2
