...
tags: [sso, codesamples, authentication, integration, guide]
sidebar:
  label: "Modular SSO"
  order: 2
...
<FoldCard
  title="Add SSO to PHP Symfony apps"
  iconKey="php"
  href="https://github.com/scalekit-developers/scalekit-php-symfony-sso"
  variant="secondary"
  target="_blank"
  showCta={false}
  clickable={true}
>
  <p>Call Scalekit OIDC endpoints from Symfony with no PHP SDK. Try handshake-only login or Modular SSO with a local user store</p>
</FoldCard>
