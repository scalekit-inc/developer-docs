...
1. ### No-Code Admin Portal
    ...
    ![Integrate via Shareable Link](@/assets/docs/common/admin-portal-1.png)
...
2. ### Embedded Admin Portal
    ...
    ```json title="Generate Portal Link (Response Object)"
    {
...
3. ### UI Events
    ...
    ```javascript title="Listening to events from the embedded admin portal"
