...
<div class="fold-section fold-full-width">
  <div class="fold-container" style="gap: 0.15rem;">
    ...
    <div style="margin-top: 0.15rem;">
      <p style="font-size: 0.875rem; color: var(--sl-color-text-muted); margin: 0 0 0.75rem;">1 command · ~5 minutes · works with any AI coding agent</p>

      ```bash showLineNumbers=false frame="none"
      npx @scalekit-inc/cli setup
      ```

      <SupportedAgents compact hideCommand />
