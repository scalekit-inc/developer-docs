...
import { LinkButton, TabItem } from '@astrojs/starlight/components'
    ...
    <div style="margin-top: 0.15rem;">
      ...
      <Tabs syncKey="coding-agent">
        <TabItem label="Claude Code" icon="claude">
          ...
          Then load the shipped skill `implement-saaskit`. [Full setup guide →](/dev-kit/build-with-ai/full-stack-auth/)
        </TabItem>
...
<div class="fold-section fold--background-muted fold-full-width" data-docsearch-ignore>
  <div class="fold-container">
    ...
    <div class="platform-features-grid">
      <ResponsiveCardGrid>
        <FoldCard title="Webhooks" iconKey="webhooks" href="/authenticate/implement-workflows/implement-webhooks/" clickable={true}>
