...
You've completed the Scalekit quickstart and enabled secure authentication for your users and sign-in flow. It's time to add more [authentication methods](/manual/social-logins-quickstart/) to expand user choice, security and improve user acquisition.