...
1.  **Set up an Initiate login endpoint**: This endpoint in your application starts the authentication process. When Scalekit receives an IdP-initiated SSO request, it redirects the user to this endpoint with an `idp_initiated_login` parameter.
