...
description: "Learn to basics of Single Sign-On (SSO), including how SAML and OIDC protocols work, and how Scalekit simplifies enterprise authentication."
tags: [sso, saml, oidc, enterprise, identity-provider, authentication, guide]
browseCentral:
  label: "Understand SSO, SAML, OIDC essentials"
  filterType:
    - "tutorial"
  category:
...
prev:
  link: '/authenticate/mcp/custom-auth/'
