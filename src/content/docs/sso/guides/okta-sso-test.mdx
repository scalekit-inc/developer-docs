...
browseCentral:
  label: Test SSO with Okta as IdP
  filterType: ["tutorial"]
  category: ["Enterprise authentication"]
  icon: book
sidebar:
  label: Testing SSO with Okta
prev: false
next:
...
2. Generate an [Admin Portal link](/guides/admin-portal/) in the overview section of the created organization
...
You can [customize the admin portal](/guides/admin-portal/#customize-the-admin-portal) and theme it according to your
