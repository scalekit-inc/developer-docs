...
sidebar:
  label: Test SSO with IdP Simulator
prev:
  link: /sso/quickstart
  label: Integrate SSO
next:
...
To locate test organization in your account, navigate to **Organizations** and select **Test Organization**.

  ![SP initiated SSO](@/assets/docs/sso/testing-sso/2.png)
...
<Aside>
To receive custom attributes from the IdP Simulator, first register them in Scalekit Workspace at Development > Single Sign-On > Custom Attributes.
</Aside>
