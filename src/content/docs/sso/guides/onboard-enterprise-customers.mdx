...
tags: [sso, enterprise, onboarding, customers, self-service]
...
---
import OnboardEnterpriseCustomersSSO from '@components/templates/_onboard-enterprise-customers-sso.mdx';

<OnboardEnterpriseCustomersSSO />
