...
- [Handle authentication callback](/sso/guides/handle-callback/) - Exchange authorization codes for user data and tokens
- [Manage user sessions](/sso/guides/manage-session/) - Store and validate session tokens securely
- [Configure session policies](/sso/guides/session-policy/) - Control token lifetimes and refresh behavior
