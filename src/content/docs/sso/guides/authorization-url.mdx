---
title: 'Authorization URL to initiate SSO'
...
browseCentral:
  label: "Construct authorization URL to SSO"
  category:
    - "User authentication"
  filterType:
    - "tutorial"
...
If you identify SSO connection using `domain` or `login_hint`, the domain must be registered to the organization. Register domains in **Dashboard > Organizations > General**, or let customers add them via the admin portal. See [Onboard enterprise customers](/fsa/guides/onboard-enterprise-customers/).
