...
2. ### Authorize users
    ...
    Scalekit only accepts authorization requests that specify a `redirect_uri` **exactly** matching one of the **Allowed Redirect URIs** configured in **Dashboard → API&nbsp;Config**.
