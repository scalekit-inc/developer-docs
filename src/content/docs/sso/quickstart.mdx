...
<Aside type="tip" title="Let AI write the code for you">
Why read docs when AI can write the code for you? Paste this prompt into your favorite LLM to get a personalized SSO integration.
