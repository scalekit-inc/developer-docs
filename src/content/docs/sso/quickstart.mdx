...
1. ### Environment Setup
    ...
    Before implementing SSO with Scalekit, [prepare your development environment with the necessary credentials and SDK](/guides/setup-scalekit).
...
2. ### Authorize users
    ...
    <Aside type="tip">
    For social login, use `provider=google` to bypass all enterprise SSO parameters and direct users straight to Google's login screen. See [Social Login](/sso/social-logins-quickstart/) for more information.
    </Aside>
