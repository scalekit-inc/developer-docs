...
2. ### Authorize users
   ...
   **SSO connection identifiers**
   ...
   <Aside type='tip'>
     For social login, use `provider=google` to bypass all enterprise SSO parameters and direct users straight to
     Google's login screen. See [Social Logins](/social-logins/quickstart/) for more information.
   </Aside>
