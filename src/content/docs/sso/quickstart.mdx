...
seeAlso:
  ...
  items:
    ...
    - title: "Browse examples in nodejs"
      icon: "github"
      url: "https://github.com/scalekit-inc/nodejs-example-apps/tree/main/sso-express-example"
    - title: "Browse PHP Symfony SSO sample"
      icon: "github"
      url: "https://github.com/scalekit-developers/scalekit-php-symfony-sso"
    - title: "Add SSO to Firebase Auth"
      icon: "book"
      url: "/guides/integrations/auth-systems/firebase/"
    - title: "Add SSO to AWS Cognito"
      icon: "book"
      url: "/guides/integrations/auth-systems/aws-cognito/"
    - title: "Add SSO to Auth0"
      icon: "book"
      url: "/guides/integrations/auth-systems/auth0/"
...
>
  <ProductAgentBlock
    skill="implementing-modular-sso"
    example="Use implementing-modular-sso to add SAML and OIDC SSO."
    syncKey="sso-cli-install"
  />
...
1. ## Set up Scalekit
   ...
   <InstallSDK />
    ...
    Since we will using Modular SSO, you need to disable complete auth:
...
2. ## Redirect the users to their enterprise identity provider login page
    ...
    Use the Scalekit SDK to construct authorization URL with your redirect URI and required scopes. Scalekit will automatically redirect the user to the user's enterprise identity provider login page to authenticate.
...
3. ## Get user details from the callback
   ...
   ```
    ...
    <Tabs syncKey="auth-result">
        ...
        ```js
        {
          iss: '<SCALEKIT_ENVIRONMENT_URL>', // Issuer: Scalekit environment URL (must match your environment)
