...
description: "Learn how to configure and validate Allowed Callback URIs in Scalekit for secure post-authentication flows, including rules for development and production environments."
sidebar:
