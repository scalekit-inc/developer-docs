...
import { Aside, Steps, Badge, TabItem, LinkCard, LinkButton } from '@astrojs/starlight/components';
...
3. ## Redirect users to sign up (or) login
   ...
   **Example implementation**
   ...
   <Aside type="note" title="Headless passwordless authentication">
   ...
   <LinkButton href="/passwordless/quickstart" class='sk-secondary' variant='secondary' icon="right-arrow">
