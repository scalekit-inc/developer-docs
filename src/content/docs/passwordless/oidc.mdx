...
browseCentral:
  label: "Integrate auth with email OTP & Magic links"
  filterType: ["tutorial"]
...
3. ## Redirect users to sign up (or) login
   ...
   **Example implementation**
   ...
   You can implement passwordless authentication without relying on Scalekit's managed login pages. This approach lets you build your own UI for collecting verification codes or handling magic links, giving you complete control over the user experience.
