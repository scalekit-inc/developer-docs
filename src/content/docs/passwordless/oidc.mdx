...
User -> Scalekit: "Inputs email address"
Scalekit -> User: "Verifies identity and sends OTP or magic link"
Scalekit -> Your app: "Exchanges code for user details"
Your app -> User: "Logs in user and continues to creating a session"
