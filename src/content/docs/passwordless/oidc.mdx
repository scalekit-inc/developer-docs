...
2. #### Initiate authorize request
   ...
   **Example implementation**
    ...
    After redirecting users to the Scalekit authorization endpoint, handle the callback at your `redirect_uri` to retrieve the user profile and complete the authentication process. Make sure this is registered as an Allowed Callback URI in your Scalekit dashboard.
    ...
    <Tabs>
      ...
      <TabItem value="idToken" label="Decoded idToken">
        ```json showLineNumbers=false
        {
          ...
          "exp": 1751697469,
          "iat": 1751438269,
          // External identifiers if linked to your system
