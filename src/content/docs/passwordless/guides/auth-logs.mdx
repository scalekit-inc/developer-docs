---
title: Auth logs
description: Monitor and troubleshoot your authentication system using comprehensive auth logs.
sidebar:
...
| **Success** | A successful exchange of the code grant has occurred, and the system has verified the user's identity and granted them access. The authentication flow has completed successfully. In passwordless flows, if a user enters an incorrect OTP initially but later provides the correct one, the final status will be Success. |
