...
browseCentral:
  label: "Passwordless Headless API quickstart"
  filterType: ["tutorial"]
...
1. ## Set up Scalekit
   ...
   To support magic link verification, add a callback endpoint in your application, typically at https://your-app.com/passwordless/verify, and implement it to verify the magic link token and complete the user authentication process.
