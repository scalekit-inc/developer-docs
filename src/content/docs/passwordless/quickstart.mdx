...
<Card title="Get moving, instantly, with your go-to AI assistant" icon={IconRiAiGenerate2}>
  <div class="llm-prompt-card">
    <div class="llm-prompt-content">
      <p>Input this prompt in your IDE to analyze your existing code base and generate magic link and OTP implementation code accordingly.</p>
    ...
    <div class="llm-prompt-action">
      <CopyPrompt
        ...
        variant="secondary"
        title="Generate magic link and OTP integration code"
      />
    </div>
  </div>
</Card>
