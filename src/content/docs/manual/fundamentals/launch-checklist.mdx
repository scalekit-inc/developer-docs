...
2. Follow our [security best practices](/sso/guides/key-concepts/manage-client-secrets) for detailed guidance.
...
2. Implement security measures:
   ...
   Learn more in our [webhook security guide](/scim/webhooks).
...
3. Follow our [domain customization guide](/scim/domain-and-theme-customization) for detailed steps.
