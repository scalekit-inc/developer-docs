...
| Term | Definition |
|------|------------|
| Authorization endpoint | An OAuth 2.0 endpoint that initiates the authentication process |
...
With just a few additional parameters, your application can initiate either a Social Login flow or a Single Sign-On (SSO) flow through Scalekit. See the [Social Login](/docs/manual/getting-started/social-login/) and [Single Sign-On](/docs/manual/getting-started/single-sign-on/) guides to get started quickly.
