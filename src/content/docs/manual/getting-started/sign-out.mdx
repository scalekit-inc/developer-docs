...
<Aside type='tip'>
You can whitelist redirect URIs in your Scalekit environment settings or [programmatically via the API](/apis-scalar#tag/client-configs/PUT/api/v1/clients/{client_id}).
</Aside>
...
- Learn how to [refresh user tokens](/manual/getting-started/refresh-tokens)
- Explore how to [configure session policies](/guides/product/session-policies)
