...
You may refer to our <a href="https://github.com/scalekit-inc/Nextjs-Django-Org-Switcher-Example/tree/main" target="_blank" rel="noopener noreferrer"> Sample Org Swithcer </a> application to better understand how the API calls enable this custom org switcher that is embedded inside your application.