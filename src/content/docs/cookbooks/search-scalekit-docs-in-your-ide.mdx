---
title: 'Search Scalekit docs in your AI coding assistant'
...
import { TabItem, Tabs, Aside, Steps } from '@astrojs/starlight/components';
...
- [M2M authentication overview](/m2m/overview) — machine-to-machine auth patterns frequently searched via ref
