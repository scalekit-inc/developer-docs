...
2. ### Add the MCP server to your AI assistant
   ...
   > **Caution:** Never commit your ref.tools API key to source control. For project-level configs checked into git, pass the key through an environment variable and reference it as `$REF_API_KEY` in your config, or add the config file to `.gitignore`.
