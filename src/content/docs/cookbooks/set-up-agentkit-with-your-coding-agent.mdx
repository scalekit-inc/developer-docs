...
- A connector configured under **AgentKit** > **Connections**. The playbook defaults to Gmail. Name another connector (for example `github-connect`) if you want that instead.
...
<Tabs syncKey="coding-agent">
  <TabItem label="Recommended: one command" icon="sparkle">
    ...
    Then paste the playbook below (or describe your goal naturally).
  </TabItem>
...
<ProductAgentBlock
  skill="integrate-agentkit"
  syncKey="cookbook-agentkit-cli"
/>
