...
<Steps>
 ...
 3. ### Handle user invitation acceptance
    ...
    When invited users click the invitation link in their email, Scalekit redirects them to your application's [registered initiate login endpoint](/fsa/reference/redirects/#redirect-types). Your application then completes the authentication flow.
