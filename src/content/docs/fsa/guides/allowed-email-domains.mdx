...
![](@/assets/docs/allowed-email-domains/2025-12-09-14-47-04.png)

<Steps>

1. Log in to your [Scalekit Dashboard](https://app.scalekit.com).
2. Navigate to **Organizations** and **select an organization**.
3. Navigate to **Overview** > **User Management** > **Allowed email domains**.
...
```js title="Add a new domain to an organization"
...
```js title="List all domains in an organization"
...
```sh title="Get details of a specific domain"
...
```js title="Fetch details of a specific domain"
...
```js title="Remove a domain from an organization"
