...
description: "Learn how to customize the look and feel of your Scalekit-hosted login page to match your brand."
tags: [branding, customization, login-page, hosted-login, ui, css, theming]
sidebar:
...
![Scalekit Branding page with a login page preview and controls for logo, favicon, button colors, border radius, and logo position](@/assets/docs/login-page-branding/login.png)
