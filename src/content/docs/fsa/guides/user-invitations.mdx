---
title: "Build invite system for your application"
...
<Steps>
 ...
 3. ### Resend user invitation
    ...
    **When to resend invitations:**
    ...
    The invitation email includes a secure magic link that allows the user to complete their account setup and join the organization. Each resend operation increments the resend counter and updates the invitation's expiration timestamp.
    ...
    **Response:**
    ...
    <Aside type="note" title="Response status codes">
      ...
      - **404**: Not Found - No pending invitation exists for the specified user
