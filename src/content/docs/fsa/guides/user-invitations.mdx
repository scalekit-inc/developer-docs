...
description: "Build comprehensive user invitation systems in your application. Send verification emails, track invitation status, and create seamless onboarding experiences"
tags: [users, organizations, invitations, email, onboarding, multi-tenant, members]
browseCentral:
  label: "Add members to workspaces with invites"
...
<Steps>
    ...
    <Tabs syncKey="tech-stack">
      ...
      <TabItem value="python" label="Python">
        ...
        try:
            ...
            new_user = scalekit_client.users.create_user_and_membership(
    ...
    <Tabs syncKey="tech-stack">
      <TabItem value="node" label="Node.js">
        ...
        try {
          ...
          const invitation = await scalekit.user.resendInvite(
      ...
      <TabItem value="python" label="Python">
        ...
        try:
            # Resend invitation to the user
            invitation = scalekit_client.users.resend_invite(
 ...
 4. ### Handle invitation acceptance
    ...
    ![Invitation email reading "You have been invited to Your App" with an Accept Invitation button and a 15-day expiry note](@/assets/docs/fsa/user-management/2-email-invite.png)
