...
<Steps>
 ...
 4. ### Handle user invitation acceptance
    ...
    When invited users click the invitation link in their email, Scalekit redirects them to your application's [registered initiate login endpoint](/guides/dashboard/redirects/#understanding-redirect-types). Your application then completes the authentication flow.
