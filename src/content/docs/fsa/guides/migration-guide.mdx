...
Password-based authentication migration support is on the way. If you need to migrate existing passwords, please [contact us](/support/contact-us).
</Aside>
