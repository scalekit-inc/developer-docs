...
4. ## Update your application code
   ...
   **Replace session middleware:**
   ...
   <Aside type="tip">Use our language SDKs for ready-to-use middlewares in Node, Go, Python, and Java.</Aside>
