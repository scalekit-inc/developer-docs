...
<Aside type="note">
Learn more about [domain verification](/fsa/guides/onboard-enterprise-customers/#organization-domain-verification) in the Enterprise SSO guide.
</Aside>
...
- Explore [Enterprise SSO](/fsa/guides/onboard-enterprise-customers/) setup and configuration
