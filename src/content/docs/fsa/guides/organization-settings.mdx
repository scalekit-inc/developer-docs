...
The **Users** tab shows current organization members with:

- User status (active, invited, suspended)
- Provisioning source (manual, SSO, SCIM)
...
- **Built-in roles** - Admin and Member roles with predefined permissions
- **Custom roles** - Create roles specific to your application's needs
- **Role assignment** - Assign roles to users during invitation or after sign-up