...
<Aside type="note">
**Before you begin:** Ensure you have the organization ID for the organization where you want to manage users. You can get this from the [organization management](/fsa/guides/manage-organization/) workflow.
</Aside>
...
<Aside type="tip">
**Custom metadata** is perfect for storing application-specific information like department, job title, or preferences that you've defined in [User management settings](/fsa/reference/session-configs/).
</Aside>
