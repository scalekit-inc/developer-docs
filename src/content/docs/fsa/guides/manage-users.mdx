...
When a user signs up for your application, Scalekit automatically generates a user profile and associated organization.
...
If the default fields for a user object are not sufficient, you can even add custom fields to user profiles, navigate to **Dashboard** > **User Attributes** or refer to the [custom user attributes](/fsa/guides/custom-user-attributes/).

## Manage users and memberships <Badge text="API" variant="tip" />
