...
Users, when they are created in Scalekit, when they sign up for your app, are assigned a default **Member**. Only organization creator is assigned the **Creator** role.
