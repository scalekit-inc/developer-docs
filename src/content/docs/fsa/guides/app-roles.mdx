...
![](@/assets/docs/app-roles/2025-12-10-19-49-27.png)
...
<Tabs>
  ...
  --data '{
  "description": "Manage access to resources.",
...
You can also set a default role that is automatically assigned to any new user who joins a particular organization. This setting overrides the application-level default role.

![](@/assets/docs/app-roles/2025-12-10-19-48-16.png)
