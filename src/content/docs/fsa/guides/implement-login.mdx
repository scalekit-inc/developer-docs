...
```javascript title="Express.js" collapse={1-2} {11} "getAuthorizationUrl"
...
The authorization endpoint connects to the authentication server configured for your environment. It redirects users to Scalekit's hosted login page, where they can sign in / sign up, to verify their identity.
