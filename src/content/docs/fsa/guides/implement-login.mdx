  ...
  2. ## Redirect to the login page
      ...
      <Tabs syncKey="tech-stack">
        <TabItem value="node" label="Node.js">
          ...
          ```
          <Aside type="note">
        Pass `prompt: 'login'` as an option to explicitly take users to the log in flow even if they are already logged in.
      </Aside>
        </TabItem>
        ...
        <TabItem value="java" label="Java">
          ...
          ```
          <Aside type="note">
        Pass `options.setPrompt("login")` as an option to explicitly take users to the log in flow even if they are already logged in.
      </Aside>
        </TabItem>
      </Tabs>
