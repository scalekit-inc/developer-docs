...
The [quickstart](/authenticate/fsa/quickstart/) details how Scalekit's hosted signup automatically creates an organization for first-time customers. During initial sign-up, the platform generates an organization and designates the first user as an _administrator_ and rest of them as _members_.
