...
<Aside>
This check returns results only when the customer has added their domains in Scalekit. See the [connections API reference](/apis/#tag/connections/get/api/v1/connections).
</Aside>
