...
You can modify the magic link & OTP behavior from the Scalekit dashboard without changing your code.
 ...
 ![Scalekit dashboard Passwordless settings showing method selection, expiry period, and security options for magic links and OTP](@/assets/docs/unlisted/passwordless/1-v2.png)
