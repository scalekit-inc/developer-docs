...
<LinkButton href="#sign-up-with-scalekits-hosted-signup-page" variant='secondary'>Use Scalekit's hosted signup page</LinkButton>
<LinkButton href="#bring-your-own-signup-form" variant='secondary'>Bring your own signup UI</LinkButton>
