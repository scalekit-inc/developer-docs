...
Cases where each organizations represents a department or reflects the pricing plans your app offers, you want to limit number of users in an organization.

You can set the number of users in an organization by updating the organization settings.
