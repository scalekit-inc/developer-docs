...
![Scalekit User limit setting enabled and set to a maximum of 25 users per organization, with Save and Cancel buttons](@/assets/docs/manage-organization/limit-org-users.png)
...
- [Add users to organizations](/authenticate/manage-organizations/add-users-to-organization/) to invite and provision user accounts
