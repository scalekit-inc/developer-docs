...
You can set the logo for an organization by adding logo URL. The URL should be publicly accessible.
...
Set `logo_url` to an empty string to remove a logo. The hosted interfaces fall back to your workspace logo immediately.
