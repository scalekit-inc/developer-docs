...
For these scenarios, implement a dedicated login endpoint that initiates the OAuth flow. This endpoint should be registered as one of the **initiate login redirects** in your Scalekit dashboard.
