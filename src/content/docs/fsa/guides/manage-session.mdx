...
1. ## Store session tokens securely
    ...
    After successful identity verification using any of the auth methods (passwordless, social, enterprise SSO), your application receives session tokens — access and refresh tokens.
