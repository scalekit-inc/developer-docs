...
<CardGrid>
  ...
  <LinkCard
    title="Passkeys"
    href="/authenticate/auth-methods/passkeys/"
    description="Users sign in with a device-based authenticator, like Face ID or Windows Hello, for a secure, passwordless, and frictionless experience"
  />
