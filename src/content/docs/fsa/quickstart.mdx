...
This quickstart guides you through integrating Full-Stack Authentication into your application. You'll configure hosted sign-in and sign-up pages, manage user accounts and sessions, and enable secure logout for your users. Built for B2B SaaS, Scalekit's multi-tenant architecture automatically respects your app's workspace and workspace-owner model out of the box.
...
3. ## Allow users to sign in or sign up
      ...
      ![User journey from sign-in to Scalekit callback](@/assets/docs/fsa/quickstart/1.png)
...
6. ## Log out the user
      ...
      The logout process completes in two steps: Scalekit invalidates the user's session on our servers, then redirects them to your app's home page or another URL you registered in one of the [post-logout redirects](/fsa/reference/redirects).
</Steps>
...
- [Design your data model](/fsa/guides/data-model/) to learn how to model your data to best work with Scalekit.
- [Manage users](/fsa/guides/manage-users/) to create, update, and delete user accounts.
