  ...
  2. ## Redirect the user to the authentication page
       Generate the authorization URL by passing a [registered](/fsa/reference/redirects) _callback URL_ and _scopes_ to the Scalekit SDK.
        ...
        const options = {
          ...
          prompt: 'create', // optional - 'login' for login flow or 'create' for sign up flow
        };
        ...
        options.prompt='create'  # optional - 'login' for login flow or 'create' for sign up flow
        ...
        options.setPrompt("create"); // optional - 'login' for login flow or 'create' for sign up flow
