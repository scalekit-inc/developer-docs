...
4. #### Create a session and log in the user
      ...
      Enable the session option to retrieve the session tokens from the `authResult` object. This allows for setting cookies and verify authentication state across multiple requests.
