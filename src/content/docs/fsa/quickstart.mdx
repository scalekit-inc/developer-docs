...
2. ## Redirect users to hosted login page
       Generate the authorization URL by passing a [registered callback URL](/guides/dashboard/redirects) and scopes to the Scalekit SDK.
        <Tabs syncKey="tech-stack">
...
5. ## Log out the user
      ...
      The logout process completes when Scalekit invalidates the user's session and redirects them to your [specified post-logout URL](/guides/dashboard/redirects).
