...
codeSamples:
  items:
    - title: "React Example"
      url: "https://github.com/example/react-sample"
    - title: "Vue.js Example"
      url: "https://github.com/example/vue-sample"
  expanded: false
  label: "Code samples"
---
...
3. ## Get user details from the callback
   ...
   <TabItem value="node" label="Node.js">
        ...
        <TabItem value="java" label="Java">
        ```java collapse={1-10, 40-47} wrap "authenticateWithCode"
...
4. ## Create and manage user sessions
      ...
      <Tabs syncKey="tech-stack">
        ...
        <TabItem value="java" label="Java">
        ```java collapse={1-5} { "1": 6-7 } { "2": 8-14 } { "3": 24}
...
- [Customize the login page](/fsa/guides/login-page-branding/). Apply your brand’s design and style.
