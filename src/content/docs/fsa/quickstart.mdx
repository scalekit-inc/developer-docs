...
3. ## Get user details from the callback
   ...
   Let's define the callback URL registered in the previous steps. After successful authentication, Scalekit creates a user record and sends the user information to your callback endpoint.
