...
seeAlso:
  ...
  expanded: false
  items:
    - title: "Block disposable and generic emails"
      icon: "shield"
      url: "/fsa/guides/signup-restrictions/"
prev:
  label: "Set up auth stack"
  link: "/fsa/quickstart"
next:
  label: "Build session management"
  link: "/fsa/guides/manage-session/"
---

import { CardGrid, Steps, TabItem, Tabs, Aside, LinkCard, Badge } from '@astrojs/starlight/components';

Scalekit offers different login methods that suit your users' preferences. You can offer passwordless (email verification code or magic link), social, or enterprise SSO. Configure these methods in the dashboard after completing our [quickstart](/fsa/quickstart/).
