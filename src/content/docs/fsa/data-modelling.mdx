...
tags: [users, organizations, groups, memberships, multi-tenant, data-model, rbac]
sidebar:
  label: "Overview"
prev: false
head:
...
![Data model diagram: a B2B project containing two organizations, each with users showing id, name, email, and role attributes](@/assets/docs/fsa/model-your-data/1-k.png)
