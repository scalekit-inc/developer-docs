...
All sign-in pages are managed by Scalekit and can be customized to match your brand. [Learn how to customize your sign-in pages](/fsa/guides/login-page-branding/) with your logo and brand colors.

## Next steps

- [Set up your first authentication method](/fsa/guides/social-logins/)
- [Configure session management](/fsa/guides/manage-session/)
- [Customize your sign-in pages](/fsa/guides/login-page-branding/)