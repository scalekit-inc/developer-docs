...
This webhook is triggered when a new directory connection is created. The event type is `organization.directory_created`
...
This webhook is triggered when a directory connection is deleted. The event type is `organization.directory_deleted`
