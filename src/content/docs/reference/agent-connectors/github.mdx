...
<div class="grid grid-cols-5 gap-4 items-center">
 ...
 <div class="flex justify-center">
  <img src="https://cdn.scalekit.cloud/sk-connect/assets/provider-icons/github.png" width="64" height="64" alt="Github logo" />
 </div>
</div>
...
Star a repository for the authenticated user. Requires authentication and starring permissions.

| Properties | Description | Type |
| --- | --- | --- |
| `owner` | The account owner of the repository | string |
| `repo` | The name of the repository without the .git extension | string |
