...
{/* Node.js - commented out, uncomment when ready
  <TabItem label="Node.js">
    ...
    const connectionName = 'bigquery'; // get your connection name from connection configurations
...
*/}
  <TabItem label="Python">
    ...
    connection_name = "bigquery"  # get your connection name from connection configurations
    ...
    print("🔗 Authorize BigQuery:", link_response.link)
