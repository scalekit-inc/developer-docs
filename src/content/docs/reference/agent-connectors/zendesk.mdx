...
{/* Node.js - commented out, uncomment when ready
  <TabItem label="Node.js">
    ...
    console.log('🔗 Authorize Zendesk:', link);
...
*/}
  <TabItem label="Python">
    ...
    try:
        ...
        print(f"✗ Failed to initialize Scalekit client: {e}")
        exit(1)
    ...
    try:
        ...
        print(f"✓ Authorization link generated successfully")
        print("🔗 Authorize Zendesk:", link_response.link)
        input("Press Enter after authorizing...")
    except Exception as e:
        print(f"✗ Failed to get authorization link: {e}")
        exit(1)
