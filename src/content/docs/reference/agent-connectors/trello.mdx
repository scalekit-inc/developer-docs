...
{/* Node.js - commented out, uncomment when ready
  <TabItem label="Node.js">
    ...
    const connectionName = 'trello'; // get your connection name from connection configurations
...
*/}
  <TabItem label="Python">
    ...
    connection_name = "trello"  # get your connection name from connection configurations
    ...
    print("🔗 Authorize Trello:", link_response.link)
