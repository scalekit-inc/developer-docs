...
import useOwnCredentialsImg from '@/assets/docs/agent-connectors/google_docs/use-own-credentials-redirect-uri.png'
...
2. ## Create a Google Docs connection

   Find **Google Docs** from the list of providers and click **Create**.
...
3. ## Copy the redirect URI
   ...
   <img src={useOwnCredentialsImg.src} alt="Configure Google Docs Connection with redirect URI" width="500" />
...
2. ## Search for the Google Docs API

   Search for "Google Docs" in the API Library
