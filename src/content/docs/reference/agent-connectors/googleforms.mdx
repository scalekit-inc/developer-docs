...
{/* Node.js - commented out, uncomment when ready
  <TabItem label="Node.js">
    ...
    const connectionName = 'googleforms'; // get your connection name from connection configurations
...
*/}
  <TabItem label="Python">
    ...
    connection_name = "googleforms"  # get your connection name from connection configurations
