...
import useOwnCredentialsImg from '@/assets/docs/agent-connectors/google_ads/use-own-credentials-redirect-uri.png'
...
<div class="grid grid-cols-5 gap-4 items-center">
 ...
 <div class="flex justify-center">
  <img src="https://cdn.scalekit.cloud/sk-connect/assets/provider-icons/google_ads.png" width="64" height="64" alt="Google Ads logo" />
 </div>
</div>
...
2. ## Create a Google Ads connection

   Find **Google Ads** from the list of providers and click **Create**.
...
3. ## Copy the redirect URI
   ...
   <img src={useOwnCredentialsImg.src} alt="Configure Google Ads Connection with redirect URI" width="500" />
...
2. ## Search for the Google Ads API

   Search for "Google Ads" in the API Library
