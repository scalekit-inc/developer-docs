...
<div class="grid grid-cols-5 gap-4 items-center">
 ...
 <div class="flex justify-center">
  <img src="https://cdn.scalekit.cloud/sk-connect/assets/provider-icons/notion.svg" width="64" height="64" alt="Notion logo" />
 </div>
</div>

Supports authentication: <Badge text="OAuth 2.0" /> , <Badge text="Bearer Token" />
