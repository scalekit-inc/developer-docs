...
{/* Node.js - commented out, uncomment when ready
  <TabItem label="Node.js">
    ...
    const connectionName = 'microsoftexcel'; // get your connection name from connection configurations
...
*/}
  <TabItem label="Python">
    ...
    connection_name = "microsoftexcel"  # get your connection name from connection configurations
    ...
    print("🔗 Authorize Microsoft Excel:", link_response.link)
