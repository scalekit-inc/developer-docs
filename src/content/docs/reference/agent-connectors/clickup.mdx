...
<Aside type="caution">
  ClickUp OAuth apps are registered per workspace. You need workspace admin access to create an OAuth application in ClickUp.
</Aside>
...
4. Navigate to [ClickUp's App Settings](https://app.clickup.com/settings/apps) in your workspace.

5. Select **Create an App** and give it a name.

   {/* Screenshot: ClickUp Create App button */}

6. Under **Redirect URL(s)**, paste the redirect URI copied from Scalekit, then click **Create App**.

   {/* Screenshot: ClickUp redirect URL input field */}
</Steps>
...
2. Enter your credentials:
   ...
   - Permissions (scopes — see [ClickUp OAuth Scopes](https://clickup.com/api/developer-portal/authentication/))
...
{/* Node.js - commented out, uncomment when ready
  <TabItem label="Node.js">
    ...
    const connectionName = 'clickup'; // get your connection name from connection configurations
