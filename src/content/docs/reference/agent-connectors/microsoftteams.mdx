...
<div class="grid grid-cols-5 gap-4 items-center">
 ...
 <div class="flex justify-center">
  <img src="https://cdn.scalekit.com/sk-connect/assets/provider-icons/microsoft-teams.svg" width="64" height="64" alt="Teams logo" />
 </div>
</div>
...
*/}
  <TabItem label="Python">
    ...
    connection_name = "microsoftteams"  # get your connection name from connection configurations
    ...
    print("🔗 Authorize Microsoft Teams:", link_response.link)
