...
{/* Node.js - commented out, uncomment when ready
  <TabItem label="Node.js">
    ...
    const connectionName = 'googledrive'; // get your connection name from connection configurations
...
*/}
  <TabItem label="Python">
    ...
    connection_name = "googledrive"  # get your connection name from connection configurations
