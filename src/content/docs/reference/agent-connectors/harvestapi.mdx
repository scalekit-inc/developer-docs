...
Retrieve information about the current HarvestAPI user account, including credit balance, usage statistics, and account details. Use this to monitor remaining credits before making high-volume scraping requests. Takes no parameters.

## `get_private_account_pools`

Retrieve the list of private LinkedIn account pools configured on your HarvestAPI account. Private pools allow dedicated LinkedIn accounts to be used for API requests, providing better rate limit isolation and reliability for high-volume workflows. Takes no parameters.
