---
title: Outlook
description: Connect to Microsoft Outlook to manage emails, calendar events, contacts, tasks, and mailbox settings.
sidebar:
  label: Outlook
...
| `end_datetime` | string | No | Event end time in RFC3339 format (e.g. `2026-01-27T10:00:00Z`) |
