...
Query Granola about the user's meetings using natural language. Returns a tailored response with inline citation links in Markdown (e.g. `[0](https://granola.ai/...)`) that reference source meeting notes.
