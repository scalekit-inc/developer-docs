...
{/* Node.js - commented out, uncomment when ready
  <TabItem label="Node.js">
    ...
    const connectionName = 'googlemeet'; // get your connection name from connection configurations
...
*/}
  <TabItem label="Python">
    ...
    connection_name = "googlemeet"  # get your connection name from connection configurations
