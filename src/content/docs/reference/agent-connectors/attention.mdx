...
{/* Node.js - commented out, uncomment when ready
  <TabItem label="Node.js">
    ...
    const connectionName = 'attention'; // get your connection name from connection configurations
...
*/}
  <TabItem label="Python">
    ...
    connection_name = "attention"  # get your connection name from connection configurations
    ...
    print("🔗 Authorize Attention:", link_response.link)
