...
{/* Node.js - commented out, uncomment when ready
  <TabItem label="Node.js">
    ...
    const connectionName = 'onedrive'; // get your connection name from connection configurations
...
*/}
  <TabItem label="Python">
    ...
    connection_name = "onedrive"  # get your connection name from connection configurations
    ...
    print("🔗 Authorize OneDrive:", link_response.link)
