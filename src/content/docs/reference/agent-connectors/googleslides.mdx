...
{/* Node.js - commented out, uncomment when ready
  <TabItem label="Node.js">
    ...
    const connectionName = 'googleslides'; // get your connection name from connection configurations
...
*/}
  <TabItem label="Python">
    ...
    connection_name = "googleslides"  # get your connection name from connection configurations
