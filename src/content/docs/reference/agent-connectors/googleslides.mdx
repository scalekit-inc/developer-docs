...
import useOwnCredentialsImg from '@/assets/docs/agent-connectors/googleslides/use-own-credentials-redirect-uri.png'
...
2. ## Create a Google Slides connection

   Find **Google Slides** from the list of providers and click **Create**.
...
3. ## Copy the redirect URI
   ...
   <img src={useOwnCredentialsImg.src} alt="Configure Google Slides Connection with redirect URI" width="500" />
...
2. ## Search for the Google Slides API

   Search for "Google Slides" in the API Library

3. ## Select the Google Slides API

   Select **Google Slides API**
...
*/}
  <TabItem label="Python">
    ...
    connection_name = "google_slides"  # get your connection name from connection configurations
    ...
    print("🔗 Authorize Google Slides:", link_response.link)
