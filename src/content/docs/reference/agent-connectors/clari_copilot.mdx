...
{/* Node.js - commented out, uncomment when ready
  <TabItem label="Node.js">
    ...
    const connectionName = 'clari_copilot'; // get your connection name from connection configurations
...
*/}
  <TabItem label="Python">
    ...
    connection_name = "clari_copilot"  # get your connection name from connection configurations
    ...
    print("🔗 Authorize Clari Copilot:", link_response.link)
