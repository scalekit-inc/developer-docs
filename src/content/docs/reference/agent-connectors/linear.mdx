...
2. Find **Linear** from the list of providers and click **Create**.
...
4. Navigate to [Linear's API Settings](https://linear.app/settings/api) and select **OAuth applications**.

5. Click **Create new application** and enter a name and description.

   {/* Screenshot: Linear Create new application button */}

6. Under **Callback URLs**, paste the redirect URI copied from Scalekit, then click **Create**.

   {/* Screenshot: Linear callback URL field */}
</Steps>
...
2. Enter your credentials:
   ...
   - Permissions (scopes — see [Linear OAuth Scopes](https://developers.linear.app/docs/oauth/authentication#scopes))
