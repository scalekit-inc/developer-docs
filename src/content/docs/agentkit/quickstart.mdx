...
<Tabs syncKey="build-mode">
  <TabItem label="Using a coding agent">
    ...
    Use the playbook in **Build with a coding agent** above. It names `integrate-agentkit` and defaults to Gmail. Name GitHub if you want this page's connector instead.
