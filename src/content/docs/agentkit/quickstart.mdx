...
<Tabs syncKey="build-mode">
  <TabItem label="Using a coding agent">
    ...
    The CLI detects your installed coding agents and configures them with Scalekit's AgentKit plugin. Complete the browser authorization when prompted. Then paste the prompt below.
