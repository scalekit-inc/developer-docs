---
title: "Quickstart: AgentKit to fetch user's emails"
...
<Tabs syncKey="build-mode">
  <TabItem label="Using a coding agent">
    ...
    Install the Scalekit Auth Stack for your coding agent, then paste the implementation prompt. The agent scaffolds connected account setup, the OAuth flow, and tool execution.
