...
![Custom connector shown alongside built-in connectors in the connector selection view](@/assets/docs/agentkit/bring-your-own-provider/custom-provider-in-catalog.png)
