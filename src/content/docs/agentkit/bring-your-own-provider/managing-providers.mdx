...
prev:
  label: "Auth patterns"
  link: "/agentkit/bring-your-own-provider/auth-types-and-patterns"
next:
...
The recommended way to manage connectors is with the <a href="https://github.com/scalekit-inc/skills/tree/main/skills/agentkit/sk-actions-custom-provider" target="_blank" rel="noopener noreferrer">`sk-actions-custom-provider` skill</a>. It keeps payload generation, review, and promotion consistent across Dev and Production.
</Aside>
...
If you prefer to manage custom connectors with the APIs directly, use the `curl` commands on this page and the JSON bodies from [Auth patterns](/agentkit/bring-your-own-provider/auth-types-and-patterns).
...
Use one of the JSON payloads from [Auth patterns](/agentkit/bring-your-own-provider/auth-types-and-patterns) as the request body:
...
Use the updated JSON body from [Auth patterns](/agentkit/bring-your-own-provider/auth-types-and-patterns) and the connector `identifier` in the update request:
...
Use the same JSON body from [Auth patterns](/agentkit/bring-your-own-provider/auth-types-and-patterns) for the Production create or update request. This keeps the connector definition consistent between environments.
