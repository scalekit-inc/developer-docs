...
description: Learn how to use your own OAuth authentication credentials with Agent Auth for complete whitelabeling and control.
tags: [agentauth, advanced, oauth2, federation, integration, guide]
---
...
![Bring your own Auth Credentials](@/assets/docs/agentkit/byoc.png)
