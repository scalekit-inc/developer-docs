...
description: Replace the default Scalekit endpoint with your own branded domain using CNAME configuration.
tags: [agentauth, advanced, customdomain, branding, configuration]
sidebar:
  label: Custom domain
prev:
...
![Scalekit Settings Custom Domain tab showing the subdomain URL field and a CNAME record in the DNS configuration table](@/assets/docs/guides/custom-domains/1.png)
