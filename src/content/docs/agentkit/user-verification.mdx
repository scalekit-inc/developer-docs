...
tableOfContents:
  maxHeadingLevel: 4
prev:
  label: "Quickstart: AgentKit"
  link: "/agentkit/quickstart"
next:
  label: "Tool calling"
  link: "/agentkit/tools/agent-tools-quickstart"
---
...
![Agent Actions User Verification showing Custom user verifier and Scalekit users only](@/assets/docs/agentkit/user-verification-config.png)
