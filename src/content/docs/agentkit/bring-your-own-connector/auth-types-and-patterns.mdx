...
Use the payload body from this page in the create and update requests on the [Managing connectors](/agentkit/bring-your-own-connector/managing-providers) page.
