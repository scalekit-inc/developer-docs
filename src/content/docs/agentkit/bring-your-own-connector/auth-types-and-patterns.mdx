...
prev:
  ...
  link: "/agentkit/bring-your-own-provider/overview"
next:
...
Use the payload body from this page in the create and update requests on the [Managing connectors](/agentkit/bring-your-own-provider/managing-providers) page.
