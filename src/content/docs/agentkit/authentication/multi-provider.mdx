...
tags: [agentauth, authentication, oauth2, multiprovider, integration, guide]
sidebar:
  order: 8
...
- [Troubleshoot connection errors](/agentkit/authentication/troubleshooting) — Debug multi-provider connection issues
