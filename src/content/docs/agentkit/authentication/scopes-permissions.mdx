...
description: Learn how to manage OAuth scopes and permissions for AgentKit connections to control what your application can access.
tags: [agentauth, authentication, oauth2, scopes, permissions, guide]
sidebar:
  order: 7
...
- [Troubleshoot connection errors](/agentkit/authentication/troubleshooting) — Debug connection and scope issues
