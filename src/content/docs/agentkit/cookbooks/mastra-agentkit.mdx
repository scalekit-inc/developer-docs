...
- **A pattern you can extend** to any of Scalekit's [200+ connectors](/agentkit/connectors/) by changing a single string.
...
**Add more connectors.** Change `CONNECTION_NAME` to `slack`, `notion`, `googlecalendar`, or any of the [200+ supported connectors](/agentkit/connectors/). The code is identical — only the connection name changes.
