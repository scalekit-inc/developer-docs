...
- **[LiteLLM inbox triage cookbook](/agentkit/cookbooks/litellm-agentkit-inbox-triage)** — A more complex multi-connection agent with a web approval interface.
