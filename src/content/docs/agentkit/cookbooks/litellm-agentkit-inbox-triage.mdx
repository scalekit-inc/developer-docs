...
2. ## Configure AgentKit connections
   ...
   3. For **GitHub**, confirm the connection includes the **`repo`** OAuth scope (needed to create issues and search across repositories). Check **AgentKit → Connections → GitHub → Scopes** in the dashboard. See [Configure scopes](/agentkit/connections/#configure-scopes) and the [GitHub connector](/agentkit/connectors/github/).
...
For deeper debugging patterns, see [Troubleshoot connection errors](/agentkit/authentication/troubleshooting/).
