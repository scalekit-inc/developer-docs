...
The MCP URL you generated is a standard Streamable HTTP MCP endpoint. Any spec-compliant MCP client can connect to it — no additional auth configuration, no SDK calls, no tool schema definitions. The client discovers available tools automatically.
...
For full end-to-end agent examples with LangChain, Google ADK, and other frameworks, see the [Examples](/agentkit/openclaw/) section.
