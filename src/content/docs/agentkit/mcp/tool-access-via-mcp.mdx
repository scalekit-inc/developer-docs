...
<CardGrid>
  <LinkCard
    ...
    href="/agentkit/frameworks/langchain"
  />
  <LinkCard
    title="Google ADK integration"
    description="Connect Scalekit tools to agents built with Google's Agent Development Kit."
    href="/agentkit/frameworks/google-adk"
  />
  <LinkCard
    title="Manage connections"
    description="Learn how to configure and manage connector connections in Scalekit."
    href="/agentkit/connections"
  />
</CardGrid>
