...
<div class="sdk-method-section">
  <CB.ClassBrowser name="ToolsClient" type="class" language="typescript" source="https://github.com/scalekit-inc/scalekit-sdk-node/blob/main/src/tools.ts">
    <CB.ClassMethod name="searchTools" open={true}>
      ...
      <CB.ClassProperty name="READY" label="state" highlight="constant">
        Usable now. Pass this connection's `connectedAccountId` to `executeTool`.
      </CB.ClassProperty>
      <CB.ClassProperty name="NEEDS_CONNECTION" label="state" highlight="constant">
        A connected account exists for the provider but is inactive. Send the user through the connect flow again.
      </CB.ClassProperty>
      <CB.ClassProperty name="NEEDS_REAUTH" label="state" highlight="constant">
