...
<MethodParams label="Input schema" params={[
  ...
  { name: 'organizationId', type: 'string', required: false, description: '' },
...
<MethodParams label="Input schema" params={[
  ...
  { name: 'organizationId', type: 'string', required: false, description: '' },
  { name: 'userId', type: 'string', required: false, description: '' },
  { name: 'apiConfig', type: 'Record<string, unknown>', required: false, description: '' },
]} />
...
<MethodParams label="Input schema" params={[
  { name: 'connectionName', type: 'string', required: false, description: '' },
  { name: 'identifier', type: 'string', required: false, description: '' },
  { name: 'connectedAccountId', type: 'string', required: false, description: '' },
  { name: 'organizationId', type: 'string', required: false, description: '' },
  { name: 'userId', type: 'string', required: false, description: '' },
]} />
...
<MethodParams label="Input schema" params={[
  ...
  { name: 'organizationId', type: 'string', required: false, description: '' },
  { name: 'userId', type: 'string', required: false, description: '' },
  { name: 'pageSize', type: 'number', required: false, description: '' },
  { name: 'pageToken', type: 'string', required: false, description: '' },
...
<MethodParams label="Input schema" params={[
  { name: 'connectionName', type: 'string', required: true, description: '' },
  { name: 'identifier', type: 'string', required: true, description: '' },
  { name: 'authorizationDetails', type: 'object', required: true, description: 'OAuth token or static auth details' },
  { name: 'organizationId', type: 'string', required: false, description: '' },
  { name: 'userId', type: 'string', required: false, description: '' },
  { name: 'apiConfig', type: 'Record<string, unknown>', required: false, description: '' },
]} />
...
<MethodParams label="Input schema" params={[
  ...
  { name: 'identifier', type: 'string', required: false, description: '' },
  { name: 'connectedAccountId', type: 'string', required: false, description: '' },
  { name: 'authorizationDetails', type: 'object', required: false, description: '' },
  { name: 'organizationId', type: 'string', required: false, description: '' },
  { name: 'userId', type: 'string', required: false, description: '' },
  { name: 'apiConfig', type: 'object', required: false, description: '' },
]} />
...
<MethodParams label="Input schema" params={[
  ...
  { name: 'queryParams', type: 'Record<string, unknown>', required: false, description: '' },
  { name: 'body', type: 'unknown', required: false, description: '' },
  { name: 'formData', type: 'Record<string, unknown>', required: false, description: '' },
  { name: 'headers', type: 'Record<string, string>', required: false, description: '' },
...
Lists tools available for a given identifier — tools that can be activated but may not yet be scoped to the user.
...
<MethodParams label="Input schema" params={[
  { name: 'toolName', type: 'string', required: true, description: '' },
  { name: 'identifier', type: 'string', required: false, description: '' },
  { name: 'params', type: 'Record<string, unknown>', required: false, description: '' },
  { name: 'connectedAccountId', type: 'string', required: false, description: '' },
  { name: 'connector', type: 'string', required: false, description: '' },
  { name: 'organizationId', type: 'string', required: false, description: '' },
  { name: 'userId', type: 'string', required: false, description: '' },
]} />
