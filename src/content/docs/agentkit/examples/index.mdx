...
Each example builds a working agent that reads a user's Gmail inbox using Scalekit-authenticated tools. Pick the framework you're already using.
...
| [OpenClaw](/agentkit/openclaw/) | Python | Skill | Conversational agent platform. No code required to connect 50+ services. |
