...
![Creating a Virtual MCP in the Scalekit dashboard](@/assets/docs/agentkit/recipes/voice-assistant/vmcp-scalekit.png)
...
![Registering the MCP tool in the Vapi dashboard](@/assets/docs/agentkit/recipes/voice-assistant/tool-registration-scalekit.png)
