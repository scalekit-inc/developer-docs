...
- **Employees bulk scrape company** — Bulk-list the employees of one or more LinkedIn companies via HarvestAPI's dedicated Apify actor, same pattern as the existing Bulk Scrape LinkedIn Profiles tool
