...
description: 'Connect to HarvestAPI to scrape LinkedIn profiles, companies, and job listings, and search for people and jobs using LinkedIn data. Enables AI agents to acce'
sidebar:
  label: 'HarvestAPI'
...
3. ### Set up the connector
   ...
   Register your HarvestAPI credentials with Scalekit so it handles the token lifecycle. You do this once per environment.
...
4. ### Make your first call
   ...
   <QuickstartGenericApikeySection connector="harvestapi" toolName="harvestapi_bulk_scrape_profiles" providerName="HarvestAPI" />
