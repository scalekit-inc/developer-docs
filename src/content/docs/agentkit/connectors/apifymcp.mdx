...
import { SectionAfterSetupApifymcpCommonWorkflows 2 } from '@components/templates'
...
- **Get actor run, actor output** — Get detailed information about a specific Actor run by runId
...
<SectionAfterSetupApifymcpCommonWorkflows 2 />
