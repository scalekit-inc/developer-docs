...
connectorCategories: [Analytics, Databases, Productivity]
head:
  - tag: style
    content: |
...
import { SectionAfterSetupGooglelookerCommonWorkflows 2 } from '@components/templates'
...
<SectionAfterSetupGooglelookerCommonWorkflows 2 />
