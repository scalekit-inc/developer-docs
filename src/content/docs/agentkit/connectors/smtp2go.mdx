...
import { SetupSmtp2goSection } from '@components/templates'
...
3. ### Set up the connector
   ...
   Register your SMTP2GO credentials with Scalekit so it can authenticate requests on your behalf. You do this once per environment.
