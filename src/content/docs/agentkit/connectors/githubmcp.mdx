...
- **Search commits, users, repositories** — Search for GitHub commits by commit message and other metadata
- **List issue fields, tags, repository collaborators** — List custom issue fields available for a GitHub repository or organization
