...
3. ### Authorize and make your first call
   ...
   <QuickstartGenericOauthSection connector="circlebackmcp" toolName="circlebackmcp_findcompanies" providerName="Circleback MCP" toolInputNode="{ searchTerms: [] }" toolInputPython='{"searchTerms":[]}' />
...
- **Findcompanies records** — Find companies matching the given search terms
