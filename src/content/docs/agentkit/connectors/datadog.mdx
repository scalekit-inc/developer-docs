...
connectorCategories: [developer_tools, devops, monitoring, observability]
head:
  - tag: style
    content: |
...
import { SectionAfterSetupDatadogCommonWorkflows 2 } from '@components/templates'
...
<SectionAfterSetupDatadogCommonWorkflows 2 />
