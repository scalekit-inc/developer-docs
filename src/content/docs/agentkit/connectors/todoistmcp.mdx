...
- **Import-project-template records** — Import a template into an existing project, adding its tasks, sections and comments to whatever is already there
- **Export-project-template records** — Export an existing project as a Todoist template, either as CSV content or as a shareable URL
