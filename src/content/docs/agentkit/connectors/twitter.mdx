...
3. ### Set up the connector
   ...
   Register your Twitter / X credentials with Scalekit so it handles the token lifecycle. You do this once per environment.
...
4. ### Make your first call
   ...
   <QuickstartGenericApikeySection connector="twitter" toolName="twitter_activity_subscription_create" providerName="Twitter / X" />
