...
- **Column excel add table** — Add a new column to an existing Excel table in OneDrive
- **Row excel add table** — Add a new row to an Excel table in a workbook stored in OneDrive
- **Range excel clear, excel merge, excel sort** — Clear the contents, formats, or both from a cell range in an Excel worksheet stored in OneDrive
- **Session excel close** — Close an active workbook session for an Excel file in OneDrive
- **Create excel** — Create a new chart in an Excel worksheet stored in OneDrive
- **Delete excel** — Delete a chart from an Excel worksheet stored in OneDrive
