...
- **Update outlook, teams** — Update an existing event on another user's calendar (shared or delegated access)
- **List outlook** — List tasks in a Microsoft To Do list belonging to another user (a colleague)
- **Get outlook, onedrive** — Get a single message from a shared mailbox by message ID
- **Create outlook, onedrive, word** — Create an event on another user's calendar (shared or delegated access)
