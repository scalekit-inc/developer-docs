...
import { SetupLushamcpSection } from '@components/templates'
...
3. ### Set up the connector
   ...
   Register your Lusha MCP credentials with Scalekit so it can authenticate requests on your behalf. You do this once per environment.

   <details>
   <summary>Dashboard setup steps</summary>

   <SetupLushamcpSection />
