...
import { SetupDropboxmcpSection } from '@components/templates'
...
3. ### Set up the connector
   ...
   Register your Dropbox MCP credentials with Scalekit so it handles the token lifecycle. You do this once per environment.
