---
title: 'Leadfeeder MCP connector'
...
3. ### Authorize and make your first call
   ...
   <QuickstartGenericOauthSection connector="leadfeedermcp" toolName="leadfeedermcp_get_account_info" providerName="Leadfeeder MCP" />
