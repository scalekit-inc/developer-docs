...
3. ### Make your first call
   ...
   <QuickstartGenericApikeySection connector="statuspage" toolName="statuspage_pages_list" providerName="Statuspage" />
...
- **List pages, users, templates** — Get the list of Statuspage pages accessible to the authenticated API key
