...
description: 'Connect to LeadIQ to search and enrich B2B contacts and companies with verified emails, direct dials, and mobile numbers. Build prospect lists and power outreach workflows.'
sidebar:
  label: 'LeadIQ'
