...
import { SetupSupabaseSection } from '@components/templates'
...
3. ### Set up the connector
   ...
   Register your Supabase credentials with Scalekit so it handles the token lifecycle. You do this once per environment.

   <details>
   <summary>Dashboard setup steps</summary>

   <SetupSupabaseSection />
