...
- **List seniorities, functions subfunctions, industries** — List all valid seniority level values that can be used as filter inputs in search_people and export_contacts (current_position_seniority_level)
