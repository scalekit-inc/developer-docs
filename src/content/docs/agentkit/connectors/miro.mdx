...
description: 'Miro is a visual collaboration platform for teams. Manage boards, sticky notes, shapes, cards, frames, connectors, images, and tags using the Miro REST API.'
sidebar:
  label: 'Miro'
...
4. ### Authorize and make your first call
   ...
   <QuickstartGenericOauthSection connector="miro" toolName="miro_app_card_create" providerName="Miro" />
