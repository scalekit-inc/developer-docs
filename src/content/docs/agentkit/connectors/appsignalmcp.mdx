...
3. ### Authorize and make your first call
   ...
   <QuickstartGenericOauthSection connector="appsignalmcp" toolName="appsignalmcp_get_applications" providerName="AppSignal MCP" toolInputNode="{ context: 'YOUR_CONTEXT' }" toolInputPython='{"context":"YOUR_CONTEXT"}' />
