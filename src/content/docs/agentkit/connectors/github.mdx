...
import { SectionAfterSetupGithubCommonWorkflows 2 } from '@components/templates'
...
4. ### Authorize and make your first call
   ...
   <QuickstartGenericOauthSection connector="github" toolName="github_user_repos_list" providerName="Github" />
...
<SectionAfterSetupGithubCommonWorkflows 2 />
