...
3. ### Set up the connector
   ...
   HubSpot MCP uses a dedicated **MCP Auth App** — not a Legacy App or standard Public App. Create one in HubSpot's developer portal and register the credentials with Scalekit once per environment.
