...
Workspace roles control who can open the Scalekit dashboard. They do not control users inside your application.

| Role | Permissions |
| ---- | ----------- |
| **Admin** | Full dashboard access for the workspace, including billing and team management. |
...
A workspace can also use a role you define. See [Set up workspace roles](/how-to/set-up-workspace-roles/) and [Define custom dashboard roles](/how-to/define-custom-dashboard-roles/).
...
4. Select their role (Admin, Owner, Member, or a custom dashboard role)
5. Click **Send invite**
