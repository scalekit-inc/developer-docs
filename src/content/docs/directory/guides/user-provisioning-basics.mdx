...
description: 'The business case for implementing SCIM'
tags: [scim, provisioning, automation, users, groups, directory-sync, enterprise]
tableOfContents: false
browseCentral:
  label: "Automate user management with SCIM"
  filterType:
    - "tutorial"
  category:
    - "Manage users & orgs"
