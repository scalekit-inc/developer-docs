...
6. <CheckItem iconName="approve-check-circle"> **Review Admin Portal URL** </CheckItem>
    ...
    Customize the Admin Portal URL to match your domain (for example, `https://admin.hero-saas.app`) for a seamless brand experience. Also, remember to update `.env` file post CNAME configuration. Read [customizing the Admin Portal](/guides/admin-portal) on how to match your brand.
