...
1. ### User provisioning with Scalekit's directory API
    ...
    1. A Scalekit account [Get it now](/guides/setup-scalekit)
...
3. ### Realtime user provisioning with webhooks
    ...
    [setting up webhooks](/dev-kit/webhooks/directory-events) to explore testing webhooks with test endpoints.
    ...
    See [Webhook events](/dev-kit/webhooks/event-object/) for the list of all available event types.
