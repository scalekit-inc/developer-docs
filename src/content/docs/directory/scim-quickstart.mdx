...
import { LinkButton, Aside, Steps, Tabs, TabItem, Card } from '@astrojs/starlight/components';
...
<Card title="Generate SCIM Code with AI in Minutes" icon="seti:vite" style="background-color: white !important;">
...
5. ### Listing users in a directory
