...
next:
  ...
  link: "/directory/apis/directory-api/"
seeAlso:
...
1. ### Setting up the SDK
    Before you begin, ensure that your organization [has a directory set up in Scalekit](/guides/user-management/scim-provisioning/).
...
2. ### Configure your environment
    ...
    Never commit API credentials to version control. Use environment variables or a secret management system to keep them secure.
    </Aside>

3. ### Initialize the SDK and make your first API call
...
6. ### List groups in a directory
    ...
    Scalekit's Directory API provides a simple way to fetch user and group information on-demand. Refer to our [API reference](/directory/apis/directory-api/) and [code examples](/directory/code-examples/) to explore more capabilities.
...
3. ### Process webhook events
    ...
    Refer to our [webhook events documentation](/reference/webhooks/event-object/) for the complete list of available event types and payload structures.
