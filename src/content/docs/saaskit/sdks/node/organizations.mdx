...
// externalId: Your system's unique identifier for this organization
// logoUrl: Publicly accessible URL of the organization's logo
// slug: DNS-safe slug for the organization (e
  ...
  <CB.ClassBrowser name="Organizations" type="client" language="typescript" source="https://github.com/scalekit-inc/scalekit-sdk-node/blob/main/src/organization.ts">
    <CB.ClassMethod name="listOrganization" open={true}>
      ...
      <CB.ClassMethodOutput type="ListOrganizationsResponse">
        Response containing: - organizations: Array of organization objects - nextPageToken…
      </CB.ClassMethodOutput>

```typescript wrap showLineNumbers=false
// pageSize: Number of organizations to return per page (default: 10,
// max: 100)
  ...
  <CB.ClassBrowser name="Organizations" type="client" language="typescript" source="https://github.com/scalekit-inc/scalekit-sdk-node/blob/main/src/organization.ts">
    <CB.ClassMethod name="getOrganization" open={true}>
      ...
      <CB.ClassMethodOutput type="GetOrganizationResponse">
        Response containing: - organization: Complete organization object.
      </CB.ClassMethodOutput>
...
// displayName: Organization's display name - exter…
...
<div class="sdk-method-section">
  <CB.ClassBrowser name="Organizations" type="client" language="typescript" source="https://github.com/scalekit-inc/scalekit-sdk-node/blob/main/src/organization.ts">
    <CB.ClassMethod name="getOrganizationByExternalId" open={true}>
      ...
      <CB.ClassMethodOutput type="GetOrganizationResponse">
        Response containing: - organization: Complete organization object with all details (same…
      </CB.ClassMethodOutput>

```typescript wrap showLineNumbers=false
// containing: -
// organization: Complete organization object with all details (same struc…
  ...
  <CB.ClassBrowser name="Organizations" type="client" language="typescript" source="https://github.com/scalekit-inc/scalekit-sdk-node/blob/main/src/organization.ts">
    <CB.ClassMethod name="generatePortalLink" open={true}>
      ...
      <CB.ClassMethodOutput type="Link">
        Link object containing: - location: The complete portal URL to redirect the admin to -…
      </CB.ClassMethodOutput>
