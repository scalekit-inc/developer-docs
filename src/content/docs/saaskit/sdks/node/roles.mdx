  ...
  <CB.ClassBrowser name="Roles" type="client" language="typescript" source="https://github.com/scalekit-inc/scalekit-sdk-node/blob/main/src/role.ts">
    <CB.ClassMethod name="getRole" open={true}>
      ...
      <CB.ClassMethodInput name="roleName" type="string">
        Unique role identifier (alphanumeric with underscores, 1-64 chars)
      </CB.ClassMethodInput>
  ...
  <CB.ClassBrowser name="Roles" type="client" language="typescript" source="https://github.com/scalekit-inc/scalekit-sdk-node/blob/main/src/role.ts">
    <CB.ClassMethod name="updateDefaultRoles" open={true}>
      ...
      <CB.ClassMethodInput name="options" type="object" hint="defaultCreatorRole, defaultMemberRole">
        Update options defaultCreatorRole: Role assigned to users who create resources defaultMemberRole: Role assigned to new environment members
      </CB.ClassMethodInput>
