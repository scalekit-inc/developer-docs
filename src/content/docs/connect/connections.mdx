---
title: Connections
description: Learn how to configure and manage connections in Agent Connect to enable authentication and tool execution with third-party providers.
sidebar:
  order: 3
  label: "Connections"
tableOfContents:
...
Connections in Agent Connect are specific configurations that define how your application authenticates and interacts with third-party providers. Each connection contains the necessary credentials, settings, and parameters required to establish secure communication with a provider's API.

## What are connections?

Connections serve as the bridge between your Agent Connect setup and third-party providers. They contain:
...
Agent Connect supports various connection types based on different authentication methods:
...
<Steps>
1. **Navigate to connections** in your Agent Connect dashboard
...
Create connections programmatically using the Agent Connect API:
...
<Aside type="note">
Scopes determine what data and actions your application can access on behalf of users. Request only the minimum scopes necessary for your use case.
</Aside>
...
Next, learn how to create and manage [Connected accounts](/connect/connected-accounts) that use these connections to authenticate and execute tools for your users.