---
title: Whitelabeling
description: Learn how to create a fully whitelabeled experience with Agent Connect using your own branding and OAuth applications.
sidebar:
  order: 5
  label: "Whitelabeling"
tableOfContents:
...
Whitelabeling with Agent Connect allows you to create a seamless, branded experience for your users. When properly implemented, users see only your company's branding throughout the entire authentication and tool execution process.

## What is whitelabeling?

Whitelabeling in Agent Connect means:
...
4. **Add your applications** to Agent Connect connections
</Steps>
...
// Configure Agent Connect to use custom domains
...
Whitelabeling with Agent Connect creates a professional, branded experience that builds trust with your users and reinforces your company's identity throughout the entire integration process.