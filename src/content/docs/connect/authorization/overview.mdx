...
Agents that need to take actions in third party applications like gmail, calendar, slack, notion, hubspot etc need to do so in a secure, authorized manner. Scalekit's Agent Connect solution helps developers build agents to act on-behalf-of users by managing user's authentication and authorization for those tools.

## Supported Auth Methods

Agent Connect supports all the different types of authentication and authorization methods that are adopted by different applications so that you don't have to worry about handling and managing user authorization tokens.
...
<LinkCard href="/connect/authorization/bring-your-own-oauth" title="Bring your own Credentials"/>
