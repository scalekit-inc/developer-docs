...
1. ## Install the authstack plugin
   ...
   The CLI installs the authstack plugin for you. Then ask the agent to run the shipped skill `add-mcp-oauth`.

   Done: the command exits 0 and `add-mcp-oauth` is available.
