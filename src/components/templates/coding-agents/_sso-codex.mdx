...
2. ## Enable the SSO skill
   ...
   Load the shipped skill `implement-sso`. That skill includes the workflows, references, and prompts Codex uses to generate SAML and OIDC SSO code for your existing application.

   Done: `implement-sso` is available to Codex.
