...
2. ## Enable the SCIM skill
   ...
   Load the shipped skill `implement-scim`. That skill includes the workflows, references, and prompts Codex uses to generate SCIM provisioning and deprovisioning code for your application.

   Done: `implement-scim` is available to Codex.
