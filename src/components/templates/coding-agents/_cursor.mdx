...
2. ## Reload and select plugins
   ...
   Enable the Scalekit plugins you need. The shipped skills are `integrating-agentkit`, `implementing-saaskit`, `adding-mcp-oauth`, `implementing-modular-sso`, and `implementing-scim-provisioning`.

   Done: the plugin list shows the skill you need.
