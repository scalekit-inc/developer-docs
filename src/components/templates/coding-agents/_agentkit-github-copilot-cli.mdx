...
1. ## Install the authstack plugin (recommended)
   ...
   The CLI installs the authstack plugin for GitHub Copilot. Then ask the agent to run the shipped skill `integrating-agentkit`.
...
3. ## Generate authentication implementation
   ...
   copilot "Add AgentKit to my app. I need to connect my agent to GitHub with delegated auth."
   ```
