...
1. ## Install the authstack plugin
   ...
   Choose Codex when prompted. The CLI installs the authstack plugin. Then load the shipped skill `integrating-agentkit`.
...
3. ## Generate the authentication implementation
   ...
   Add AgentKit to my app. I need to connect my agent to GitHub with delegated auth.
   ```
