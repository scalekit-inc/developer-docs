...
<footer style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid var(--sl-color-gray-5); text-align: left; font-size: 0.875rem; color: var(--sl-color-gray-3);" class="fold-full-width">
