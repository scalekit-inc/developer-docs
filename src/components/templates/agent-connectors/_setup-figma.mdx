...
1. ### Create a Figma connection in Scalekit
   ...
   - In [Scalekit dashboard](https://app.scalekit.com), go to **Agent Auth** → **Create Connection**. Search for **Figma** and click **Create**.
...
4. ### Add credentials in Scalekit
   ...
   - In [Scalekit dashboard](https://app.scalekit.com), go to **Agent Auth** → **Connections** and open the Figma connection you created.
