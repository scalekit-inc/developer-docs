...
2. ### Authorize your Adzviser account
   ...
   <Aside type="note" title="Adzviser workspace required">
     The user must have an active Adzviser account with at least one workspace configured. Each workspace contains the ad platform accounts (Google Ads, Facebook Ads, etc.) whose data your agent can query.
   </Aside>
</Steps>
