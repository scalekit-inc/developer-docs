...
2. ### Create an OAuth app in Supabase
   ...
   - Give the app a **Name** (for example, `Agent Connect`).
     ...
     ![Supabase OAuth Apps page showing Published apps and Authorized apps tables](@/assets/docs/agent-connectors/supabase/oauth-apps-list.png)
...
4. ### Copy your Client ID and Client Secret
   ...
   - Under **Client secrets**, click **Generate new secret** and copy it immediately — Supabase only shows the full secret once.
     ...
     ![Supabase Update OAuth application panel showing the application ID, callback URLs, and client secrets](@/assets/docs/agent-connectors/supabase/oauth-app-detail.png)
