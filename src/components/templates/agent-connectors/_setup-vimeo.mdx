...
3. ### Create a connection in Scalekit
   ...
   - In <a href="https://app.scalekit.com" target="_blank" rel="noopener">Scalekit dashboard</a>, go to **Agent Auth** → **Create Connection**. Search for **Vimeo** and click **Create**.
...
5. ### Add credentials in Scalekit
   ...
   - In <a href="https://app.scalekit.com" target="_blank" rel="noopener">Scalekit dashboard</a>, go to **Agent Auth** → **Connections** and open the Vimeo connection you created.
