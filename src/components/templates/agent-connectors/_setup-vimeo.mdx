...
3. ### Create a connection in Scalekit
   ...
   - In <a href="https://app.scalekit.com" target="_blank" rel="noopener">Scalekit dashboard</a>, go to **AgentKit** > **Connections** > **Create Connection**. Search for **Vimeo** and click **Create**.
