...
2. ### Enable the Google People API
    ...
    - In [Google Cloud Console](https://console.cloud.google.com/projectselector2/home/dashboard?supportedpurview=project), go to **APIs & Services** → **Library**. Search for "Google People API" and click **Enable**.

      ![Google People API product page showing the Enable button and API Enabled status](@/assets/docs/agent-connectors/googlecontacts/enable-people-api.png)
