...
2. ### Create an OAuth integration in Gong
   ...
   - Click **Create Integration**.
     ...
     ![Gong Admin Center API page showing the Integrations tab with a Scalekit Integration client](@/assets/docs/agent-connectors/gongmcp/integrations-list.png)
...
3. ### Configure the integration's scopes and URLs
   ...
   - Click **Save**.
     ...
     ![Gong Integration URLs & endpoints tab showing the redirect URI and required links](@/assets/docs/agent-connectors/gongmcp/urls-endpoints.png)
