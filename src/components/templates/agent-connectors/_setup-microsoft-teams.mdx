...
1. ### Register an Azure app
    ...
    - In [Scalekit dashboard](https://app.scalekit.com), go to **Agent Auth** → **Create Connection**. Find **Teams** and click **Create**. Copy the redirect URI. It will look like `https://<SCALEKIT_ENVIRONMENT_URL>/sso/v1/oauth/<CONNECTION_ID>/callback`.
      ...
      ![Copy redirect URI from Scalekit dashboard](@/assets/docs/agent-connectors/microsoft_teams/use-own-credentials-redirect-uri.png)
    ...
    - Under **Redirect URI**, select **Web** and paste the redirect URI from step 1. Click **Register**.
      ...
      ![Register an application in Azure portal](@/assets/docs/agent-connectors/microsoft_teams/add-redirect-uri.png)
...
3. ### Add credentials in Scalekit
    ...
    - Enter your credentials:
      ...
      ![Add credentials in Scalekit dashboard](@/assets/docs/agent-connectors/microsoft_teams/add-credentials.png)
    - Click **Save**.
</Steps>
