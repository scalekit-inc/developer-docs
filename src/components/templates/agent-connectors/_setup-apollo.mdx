...
2. ### Register an OAuth application in Apollo
    ...
    - Under **Scopes**, select the permissions your agent needs:
      ...
      ![Register OAuth application in Apollo developer settings](@/assets/docs/agent-connectors/apollo/add-redirect-uri.png)

    - Click **Register application**.

3. ### Copy your client credentials

    After registering, Apollo shows the **Client ID** and **Client Secret** for your application. Copy both values — **the Client Secret is shown only once** and cannot be retrieved again after navigating away.
