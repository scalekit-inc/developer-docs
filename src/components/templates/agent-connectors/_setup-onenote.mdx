...
1. ### Create the OneNote connection in Scalekit
   ...
   - In [Scalekit dashboard](https://app.scalekit.com), go to **Agent Actions** → **Connections** and click **+ Create Connection**. Search for **OneNote** and click **Create**.
...
4. ### Add credentials in Scalekit
   ...
   - In [Scalekit dashboard](https://app.scalekit.com), go to **Agent Actions** → **Connections** and open the OneNote connection you created.
