...
1. ### Set up auth redirects
    ...
    - Find **Monday.com** from the list of providers and click **Create**.
      ...
      <Aside>
        Scalekit's credentials are used by default. Replace with yours for production.
      </Aside>

    - Copy the redirect URI. It looks like `https://<SCALEKIT_ENVIRONMENT_URL>/sso/v1/oauth/<CONNECTION_ID>/callback`.

      <img src={useOwnCredentialsImg.src} alt="Configure Monday.com Connection with redirect URI" width="500" />
