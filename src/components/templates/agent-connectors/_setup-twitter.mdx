...
1. ### Create a Twitter connection in Scalekit
   ...
   - In [Scalekit dashboard](https://app.scalekit.com), go to **Agent Auth** → **Create Connection**. Search for **Twitter** and click **Create**.
...
5. ### Add credentials in Scalekit
   ...
   - In [Scalekit dashboard](https://app.scalekit.com), go to **Agent Auth** → **Connections** and open the Twitter connection you created.
