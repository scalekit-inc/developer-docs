...
1. ### Create a connection in Scalekit and copy the redirect URI
   ...
   - Sign in to your [Scalekit dashboard](https://app.scalekit.com) and go to **Agent Auth** in the left sidebar.
...
3. ### Add credentials and scopes in Scalekit
   ...
   - Return to your [Scalekit dashboard](https://app.scalekit.com) → **Agent Auth** → **Connections** and open the Attio connection you created in step 1.
