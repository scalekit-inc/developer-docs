...
Connect to Databricks Workspace APIs on behalf of a user — Scalekit handles OAuth token management automatically.
...
<Tabs syncKey="tech-stack">
  <TabItem label="Node.js">
    ...
    console.log('🔗 Authorize Databricks:', link);
  ...
  <TabItem label="Python">
    ...
    connection_name = "databricksworkspace"  # get your connection name from connection configurations
    ...
    print("🔗 Authorize Databricks:", link_response.link)
