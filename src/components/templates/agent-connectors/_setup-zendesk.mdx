...
import enableTokenAccessImg from '@/assets/docs/agent-connectors/zendesk/enable-token-access.png'
import addConnectedAccountImg from '@/assets/docs/agent-connectors/zendesk/add-connected-account.png'
...
1. ### Generate an API token
    ...
    - Under **Settings**, enable **Token access**.
      ...
      <img src={enableTokenAccessImg.src} alt="Zendesk API configuration page with Allow API token access enabled" width="540" />
...
2. ### Create a connection
    ...
    In <a href="https://app.scalekit.com" target="_blank" rel="noopener">Scalekit dashboard</a>, go to **Agent Auth** → **Create Connection**. Find **Zendesk** and click **Create**.
...
3. ### Create a connected account
    ...
    - Click **Save**.
      ...
      <img src={addConnectedAccountImg.src} alt="Add connected account form for Zendesk in Scalekit dashboard" width="540" />
</Steps>
