{/* TODO: stub cloned from _setup-firecrawlmcp.mdx for Close MCP. Review and update connector-specific references (URLs, scopes, app-registration steps) before merging. */}
...
1. ### Get a Firecrawl API key
   ...
   {/* TODO: add screenshot — alt: "", original src: @/assets/docs/agent-connectors/closemcp/create-api-key.png */}
