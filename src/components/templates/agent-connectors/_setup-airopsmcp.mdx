...
1. ### Get your AirOps API key
   ...
   - Sign in to [AirOps](https://app.airops.com) and click the **Settings** gear icon in the bottom-left sidebar.
   - Go to the **Workspace** tab.
   - Under **API Key**, click **Copy** to copy your key. If you need to rotate the key, click **Regenerate**.

   ![AirOps workspace settings showing the API Key field with a Copy button and Regenerate option](@/assets/docs/agent-connectors/airopsmcp/create-api-key.png)
