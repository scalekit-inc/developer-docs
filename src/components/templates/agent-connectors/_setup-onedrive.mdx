...
1. ### Set up auth redirects
    ...
    - In [Scalekit dashboard](https://app.scalekit.com), go to **AgentKit** → **Create Connection**. Find **OneDrive** and click **Create**. Copy the redirect URI. It will look like `https://<SCALEKIT_ENVIRONMENT_URL>/sso/v1/oauth/<CONNECTION_ID>/callback`.
