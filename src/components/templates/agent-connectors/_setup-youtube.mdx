...
2. ### Create a connection in Scalekit
   ...
   - In <a href="https://app.scalekit.com" target="_blank" rel="noopener">Scalekit dashboard</a>, go to **AgentKit** → **Create Connection**.
...
4. ### Add credentials in Scalekit
   ...
   - In <a href="https://app.scalekit.com" target="_blank" rel="noopener">Scalekit dashboard</a>, go to **AgentKit** → **Connections** and open the YouTube connection you created.
