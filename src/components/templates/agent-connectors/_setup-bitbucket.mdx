...
3. ### Get the redirect URI from Scalekit
   ...
   - In <a href="https://app.scalekit.com" target="_blank" rel="noopener">Scalekit dashboard</a>, go to **Agent Auth** → **Create Connection**. Search for **Bitbucket** and click **Create**.
...
6. ### Add credentials in Scalekit
   ...
   - In <a href="https://app.scalekit.com" target="_blank" rel="noopener">Scalekit dashboard</a>, go to **Agent Auth** → **Connections** and open the Bitbucket connection you created.
