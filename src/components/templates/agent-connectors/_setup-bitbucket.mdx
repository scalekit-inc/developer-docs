...
3. ### Get the redirect URI from Scalekit
   ...
   - In <a href="https://app.scalekit.com" target="_blank" rel="noopener">Scalekit dashboard</a>, go to **AgentKit** > **Connections** > **Create Connection**. Search for **Bitbucket** and click **Create**.
