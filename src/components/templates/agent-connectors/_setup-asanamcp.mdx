...
2. ### Create an MCP app in Asana
   ...
   ![Asana developer console showing existing apps and the Create new app button](@/assets/docs/agent-connectors/asanamcp/my-apps.png)
   ...
   ![Create new app dialog with MCP app type selected](@/assets/docs/agent-connectors/asanamcp/create-app-mcp-type.png)
