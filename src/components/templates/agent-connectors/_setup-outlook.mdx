...
1. ### Create the Outlook connection in Scalekit
   ...
   - In [Scalekit dashboard](https://app.scalekit.com), go to **Agent Actions** → **Connections** and click **+ Create Connection**. Search for **Outlook** and click **Create**.
...
4. ### Add credentials in Scalekit
   ...
   - In [Scalekit dashboard](https://app.scalekit.com), go to **Agent Actions** → **Connections** and open the Outlook connection you created.
