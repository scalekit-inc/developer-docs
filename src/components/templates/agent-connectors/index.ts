...
export { default as SetupClosemcpSection } from './_setup-closemcp.mdx'
...
export { default as SectionAfterSetupClosemcpCommonWorkflows } from './_section-after-setup-closemcp-common-workflows.mdx'
