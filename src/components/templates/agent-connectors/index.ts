...
export { default as SetupClaymcpSection } from './_setup-claymcp.mdx'
...
export { default as SectionAfterSetupClaymcpCommonWorkflows } from './_section-after-setup-claymcp-common-workflows.mdx'
