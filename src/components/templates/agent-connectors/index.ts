...
export { default as SetupSentrymcpSection } from './_setup-sentrymcp.mdx'
...
export { default as SectionAfterSetupSentrymcpCommonWorkflows } from './_section-after-setup-sentrymcp-common-workflows.mdx'
