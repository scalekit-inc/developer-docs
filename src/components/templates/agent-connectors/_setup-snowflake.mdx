...
import useOwnCredentialsImg from '@/assets/docs/agent-connectors/snowflake/use-own-credentials-redirect-uri.png'
import addCredentialsImg from '@/assets/docs/agent-connectors/snowflake/add-credentials.png'
...
1. ### Set up auth redirects
    ...
    - Copy the redirect URI. It looks like `https://<SCALEKIT_ENVIRONMENT_URL>/sso/v1/oauth/<CONNECTION_ID>/callback`.
      ...
      <img src={useOwnCredentialsImg.src} alt="Configure Snowflake Connection with redirect URI" width="500" />
...
3. ### Add credentials in Scalekit
    ...
    - Enter your credentials:
      ...
      <img src={addCredentialsImg.src} alt="Adding credentials for Snowflake in Scalekit dashboard" width="540" />
    - Click **Save**.
</Steps>
