...
<Tabs syncKey="tech-stack">
  <TabItem value="node" label="Node.js">
    ```javascript title="Express.js" ins={4} collapse={6-9}
  ...
  <TabItem value="python" label="Python">
    ```python title="Flask" ins={6} collapse={8-11}
  ...
  <TabItem value="go" label="Go">
    ```go title="Gin" ins={4} collapse={7-14}
  ...
  <TabItem value="java" label="Java">
    ```java title="Spring" ins={8} collapse={1-4}
