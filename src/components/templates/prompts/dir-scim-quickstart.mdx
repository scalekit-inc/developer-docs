...
10. **Documentation Links** – For quick access:
    ...
    - [Webhook Event Reference](https://docs.scalekit.com/reference/webhooks/overview/)
    - [Webhook Setup Guide](https://docs.scalekit.com/directory/reference/directory-events)
