...
4. ## Verify domain ownership
   ...
   **Via API:**
   ...
   1. Enable the `domain_verification` feature for the organization (Dashboard org **Overview** → toggle **Domain Verification**, or via the API).
   ...
   See [Organization domains](/authenticate/manage-users-orgs/organization-domains/) for the full step-by-step guide and SDK code examples.
