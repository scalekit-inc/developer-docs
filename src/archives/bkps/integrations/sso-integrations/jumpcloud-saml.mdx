...
<figure>
  ![Click on Add New
  Application](@/assets/docs/guides/sso-integrations/jumpcloud-saml/2.png)
...
<figure>
  ...
  integration](/images/docs/guides/sso-integrations/jumpcloud-saml/2-5.gif)
...
<figure>
  ![Click on Configure
  application](@/assets/docs/guides/sso-integrations/jumpcloud-saml/3.png)
...
<figure>
  ...
  Metadata](@/assets/docs/guides/sso-integrations/jumpcloud-saml/4.png)
...
<figure>
  ...
  Portal](@/assets/docs/guides/sso-integrations/jumpcloud-saml/5.png)
...
<figure>
  ...
  Portal](@/assets/docs/guides/sso-integrations/jumpcloud-saml/6.png)
  <figcaption>
...
<figure>
  ...
  Portal](@/assets/docs/guides/sso-integrations/jumpcloud-saml/7.png)
  <figcaption>Copy ACS URL from SSO Configuration Portal</figcaption>
</figure>

<figure>
  ![Paste it under Default URL on JumpCloud Portal
  ](@/assets/docs/guides/sso-integrations/jumpcloud-saml/8.png)
...
<figure>
  ...
  Portal](@/assets/docs/guides/sso-integrations/jumpcloud-saml/9.png)
...
<figure>
  ...
  ](@/assets/docs/guides/sso-integrations/jumpcloud-saml/10.png)
  <figcaption>Attribute mapping from SSO Configuration Portal </figcaption>
</figure>

<figure>
  ![Attribute Mapping on JumpCloud
  Portal](/images/docs/guides/sso-integrations/jumpcloud-saml/10-5.gif)
...
<figure>
  ...
  application](@/assets/docs/guides/sso-integrations/jumpcloud-saml/11.png)
...
<figure>
  ...
  ](@/assets/docs/guides/sso-integrations/jumpcloud-saml/12.png)
...
<figure>
  ...
  Portal](@/assets/docs/guides/sso-integrations/jumpcloud-saml/13.png)
...
<figure>
  ![Enable SSO on
  JumpCloud](@/assets/docs/guides/sso-integrations/jumpcloud-saml/15.png)
