 ...
 */
export const pageActionsPrompt = `You are an expert technical assistant. I will give you a URL pointing to a documentation page.

Your task:
1. Read and deeply analyze the content at: {url}
