...
0. Ask me what I want to build: agent auth, full-stack auth, MCP auth, SSO, or SCIM. If I am not sure, start with GitHub agent auth.
1. Use the authstack plugin skills. Do not invent Scalekit APIs or hard-code secrets.
2. When you are done, tell me what you set up and how to verify it.`
