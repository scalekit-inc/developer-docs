    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          'authenticate/manage-users-orgs/organization-domains',
      ...
      },
      {
        ...
        items: [
          ...
          'authenticate/fsa/session-token-claims',
          {
        ...
        items: [
          ...
          { label: 'SDKs', link: '/agentkit/sdks/' },
          {
            ...
            items: [
              ...
              { label: 'Hermes', link: 'agentkit/hermes' },
            ],
          },
        ],
      },
...
export const sidebarToSecondaryNav: Record<string, SecondaryNavMapping> = {
  ...
  connect: {
    ...
    pathOverrides: {
      ...
      '/agentkit/hermes': 'agentkit-quickstart',
