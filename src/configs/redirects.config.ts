export const redirects = {
  ...
  '/scim/webhooks': '/directory/reference/directory-events/',
  ...
  '/scim/listen-directory-events': '/directory/reference/directory-events/',
  ...
  '/dev-kit/webhooks/event-object/': '/authenticate/implement-workflows/implement-webhooks/',
  '/reference/webhooks/event-object/': '/authenticate/implement-workflows/implement-webhooks/',
  '/reference/webhooks/overview/': '/authenticate/implement-workflows/implement-webhooks/',
  '/reference/webhooks/': '/apis/#webhook/organizationcreated',
  // Catalog MDX pages removed — event payloads live in OpenAPI / Scalar API reference
  '/reference/webhooks/user-events/': '/apis/#webhook/usersignup',
  '/reference/webhooks/organization-events/': '/apis/#webhook/organizationcreated',
  '/reference/webhooks/sso-events/': '/apis/#webhook/organizationssocreated',
  '/reference/webhooks/role-events/': '/apis/#webhook/rolecreated',
  '/reference/webhooks/permission-events/': '/apis/#webhook/permissioncreated',
  '/reference/webhooks/directory-events/': '/directory/reference/directory-events/',
  '/authenticate/implement-workflows/listen-to-webhooks/':
    '/authenticate/implement-workflows/implement-webhooks/',
  '/api/webhook-events': '/directory/reference/directory-events/',
  ...
  // =============================================================================
  // COOKBOOK REDIRECTS (per-product split)
  // =============================================================================
  // Cookbooks moved from a single /cookbooks/ blog to per-product instances.
  // /cookbooks/ itself remains as a hub page linking to both shelves.
