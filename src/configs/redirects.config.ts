export const redirects = {
  ...
  '/authenticate/m2m/jwks-and-token-validation/': '/cookbooks/m2m-jwks-and-oauth-scopes/',
  '/authenticate/m2m/scopes': '/cookbooks/m2m-jwks-and-oauth-scopes/',
  '/authenticate/m2m/scopes/': '/cookbooks/m2m-jwks-and-oauth-scopes/',
  '/cookbooks/m2m-jwks-token-verification': '/cookbooks/m2m-jwks-and-oauth-scopes/',
  '/cookbooks/m2m-jwks-token-verification/': '/cookbooks/m2m-jwks-and-oauth-scopes/',
  '/cookbooks/m2m-oauth-scopes': '/cookbooks/m2m-jwks-and-oauth-scopes/',
  '/cookbooks/m2m-oauth-scopes/': '/cookbooks/m2m-jwks-and-oauth-scopes/',
