export const redirects = {
  ...
  '/best-practices/manage-client-secrets':
    '/guides/client-credentials-practices/',
  ...
  '/integrations/social-connections/google/':
    '/guides/integrations/social-connections/google/',
  '/integrations/social-connections/microsoft/':
    '/guides/integrations/social-connections/microsoft/',
  '/integrations/social-connections/github/':
    '/guides/integrations/social-connections/github/',
  '/integrations/social-connections/gitlab/':
    '/guides/integrations/social-connections/gitlab/',
  '/integrations/social-connections/linkedin/':
    '/guides/integrations/social-connections/linkedin/',
