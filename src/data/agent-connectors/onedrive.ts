...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    params: [
      { name: 'drive_id', type: 'string', required: true, description: `The unique ID of the drive containing the item to copy. Obtain drive IDs from onedrive_list_drives or sharepoint_list_drives.` },
  ...
  },
  {
    ...
    params: [
      { name: 'drive_id', type: 'string', required: true, description: `The unique ID of the drive containing the item to share. Obtain drive IDs from onedrive_list_drives or sharepoint_list_drives.` },
  ...
  },
  {
    ...
    params: [
      { name: 'drive_id', type: 'string', required: true, description: `The unique ID of the drive containing the item to delete. Obtain drive IDs from onedrive_list_drives or sharepoint_list_drives.` },
  ...
  },
  {
    ...
    params: [
      { name: 'drive_id', type: 'string', required: true, description: `The unique ID of the drive containing the item. Obtain drive IDs from onedrive_list_drives or sharepoint_list_drives.` },
  ...
  },
  {
    ...
    params: [
      { name: 'drive_id', type: 'string', required: true, description: `The unique ID of the drive containing the file. Obtain drive IDs from onedrive_list_drives or sharepoint_list_drives.` },
  ...
  },
  {
    ...
    params: [
      { name: 'drive_id', type: 'string', required: true, description: `The unique ID of the drive containing the folder. Obtain drive IDs from onedrive_list_drives or sharepoint_list_drives.` },
  ...
  },
  {
    ...
    params: [
      { name: 'drive_id', type: 'string', required: true, description: `The unique ID of the drive to search within. Obtain drive IDs from onedrive_list_drives or sharepoint_list_drives.` },
      { name: 'query', type: 'string', required: true, description: `Search query string to find files or folders by name or content. Example: "budget 2024" searches for items containing that text.` },
      { name: '$select', type: 'string', required: false, description: `Comma-separated list of properties to return. Example: "id,name,size,webUrl" reduces response payload.` },
      { name: '$top', type: 'integer', required: false, description: `Maximum number of results to return. Accepts values 1–999.` },
    ],
