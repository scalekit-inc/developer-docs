...
export const tools: Tool[] = [
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `ID of the prospect list to add the contact to`,
      },
      {
        name: 'company',
        type: 'string',
        required: false,
        description: `Current company name of the prospect`,
      },
      {
        name: 'company_domain',
        type: 'string',
        required: false,
        description: `Website domain of the prospect's company`,
      },
      {
        name: 'company_industry',
        type: 'string',
        required: false,
        description: `Industry of the prospect's company`,
      },
      {
        name: 'linkedin_url',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Mobile phone number of the prospect`,
      },
      {
        name: 'notes',
        type: 'string',
        required: false,
        description: `Internal notes about this prospect`,
      },
      {
        name: 'seniority',
        type: 'string',
        required: false,
        description: `Seniority level of the prospect`,
      },
      { name: 'title', type: 'string', required: false, description: `Job title of the prospect` },
      {
        ...
        type: 'string',
        required: false,
        description: `Work email address of the prospect`,
      },
      {
        name: 'work_phone',
        type: 'string',
        required: false,
        description: `Work phone number of the prospect`,
      },
    ],
  },
  {
    ...
    params: [
      { name: 'name', type: 'string', required: true, description: `Name of the prospect list` },
      {
        ...
        type: 'string',
        required: false,
        description: `Optional description of the prospect list`,
      },
    ],
  },
  {
    ...
    params: [
      {
        name: 'company_excluded_filter',
        type: 'object',
        required: false,
        description: `Exclude contacts at companies matching these criteria`,
      },
      {
        name: 'company_filter',
        type: 'object',
        required: false,
        description: `Filter by company attributes including name, domain, industry, size, and location`,
      },
      {
        name: 'contact_excluded_filter',
        type: 'object',
        required: false,
        description: `Exclude contacts matching these criteria`,
      },
      {
        name: 'contact_filter',
        type: 'object',
        required: false,
        description: `Filter contacts by title, seniority, role, location, and more`,
      },
      {
        name: 'limit',
        type: 'integer',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `ID of the prospect list to retrieve`,
      },
      {
        name: 'prospects_cursor',
        type: 'string',
        required: false,
        description: `Pagination cursor from a previous response to get the next batch of prospects`,
      },
      {
        name: 'prospects_limit',
        type: 'integer',
        required: false,
        description: `Maximum number of prospects to return from the list (default 25)`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'integer',
        required: false,
        description: `Maximum number of lists to return per page`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'object',
        required: false,
        description: `Exclude companies matching these criteria`,
      },
      {
        name: 'company_filter',
        type: 'object',
        required: false,
        description: `Filter by company name, domain, industry, size, location, and more`,
      },
      {
        name: 'contact_excluded_filter',
        type: 'object',
      ...
      {
        name: 'limit_per_company',
        type: 'integer',
        required: false,
        description: `Maximum number of contacts to return per company (default 5)`,
      },
      {
        name: 'skip',
        type: 'integer',
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'name', type: 'string', required: false, description: `Company name to search for` },
      {
        ...
        type: 'boolean',
        required: false,
        description: `Enable strict matching — only return exact name or domain matches`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `Domain of the person's current company`,
      },
      {
        name: 'company_name',
        type: 'string',
        required: false,
        description: `Current company name of the person`,
      },
      {
        name: 'contains_work_contact_info',
        type: 'boolean',
        required: false,
        description: `Only return results that have at least one work email or work phone`,
      },
      {
        name: 'email',
        type: 'string',
        required: false,
        description: `Known email address of the person`,
      },
      {
        name: 'first_name',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The contact info value being reported (email address or phone number)`,
      },
      {
        name: 'company_domain',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Company name for additional context`,
      },
      {
        name: 'invalid_reason',
        type: 'string',
        required: false,
        description: `Specific bounce or invalidity reason code (for invalid emails)`,
      },
      {
        name: 'linkedin_url',
        type: 'string',
        required: false,
        description: `LinkedIn URL of the person the feedback is about`,
      },
      {
        name: 'person_id',
        type: 'string',
        required: false,
        description: `LeadIQ person ID associated with the contact info`,
      },
      {
        name: 'status',
        type: 'string',
        required: false,
        description: `Whether the contact info is correct or invalid`,
      },
      {
        name: 'title',
        type: 'string',
        required: false,
        description: `Job title of the person at the time the contact info was used`,
      },
      {
        name: 'type',
        type: 'string',
        required: false,
        description: `Type of contact information being reported`,
      },
    ],
  },
]
