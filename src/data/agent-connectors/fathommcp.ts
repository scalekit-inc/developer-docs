...
export const tools: Tool[] = [
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `Filter by recorder. Use the authenticated user's email for own recordings or 'anyone' for org-wide search.`,
      },
      {
        name: 'created_after',
        type: 'string',
        required: false,
        description: `ISO 8601 date string. Only search meetings created after this date.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `The meeting URL from list_meetings for timestamped deep links.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'integer',
        required: true,
        description: `The numeric Fathom call ID.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `A Fathom call URL or share link.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `ISO 8601 date string. Only return meetings created after this date.`,
      },
      {
        name: 'created_before',
        type: 'string',
        required: false,
        description: `ISO 8601 date string. Only return meetings created before this date.`,
      },
      {
        name: 'cursor',
        type: 'string',
      ...
      },
      {
        ...
        type: 'boolean',
        required: false,
        description: `Include action items in results.`,
      },
      {
        name: 'include_summary',
        type: 'boolean',
        required: false,
        description: `Include AI summary in results.`,
      },
      {
        name: 'max_pages',
        type: 'integer',
      ...
      },
      {
        ...
        type: 'array',
        required: false,
        description: `Filter by team names (use list_teams to get valid names).`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Search query. Multiple words use AND logic.`,
      },
      {
        name: 'recorded_by',
        type: 'string',
