    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Target URL to fetch or interact with.`,
      },
      {
        name: 'country',
        type: 'string',
        required: false,
        description: `Two-letter ISO 3166-1 alpha-2 country code for the proxy exit node (e.g. US, DE, FR).`,
      },
      {
        name: 'timeout',
        type: 'integer',
        required: false,
        description: `Server-side timeout in milliseconds. Use alongside rendering_wait for JS-heavy pages.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Name of the WebMCP tool to call (from list_webmcp_tools)`,
      },
      {
        name: 'input',
        type: 'string',
        required: false,
        description: `JSON-stringified parameters to pass to the tool. Omit for tools with no parameters.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Page content (HTML/text) from a scrape result. Use raw or clean_html format for best detection accuracy.`,
      },
      {
        name: 'url',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Pre-built AI extraction model to apply. Accepted values: article, event, food_recipe, hotel, product, job_posting, organization, and more.`,
      },
      {
        name: 'format',
        type: 'string',
        required: false,
        description: `Output format for the scraped content. Accepted values: markdown, text, clean_html, json, raw.`,
      },
      {
        name: 'format_options',
        type: 'array',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Proxy pool to route the request through. Accepted values: public_datacenter_pool, public_residential_pool.`,
      },
      {
        name: 'rendering_wait',
        type: 'integer',
        required: false,
        description: `Milliseconds to wait after JS rendering before returning the response.`,
      },
      {
        name: 'response_headers',
        type: 'object',
        required: false,
        description: `Response headers from the scrape result. Enables header-based antibot detection.`,
      },
      {
        name: 'status_code',
        type: 'integer',
        required: false,
        description: `HTTP status code from the scrape result (e.g. 403, 429, 503). Defaults to 200. Improves detection accuracy.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Element UID from take_snapshot. Used to target a specific element for interaction.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Active cloud browser session ID. Obtain from cloud_browser_open.`,
      },
      {
        name: 'user_close_request',
        type: 'string',
        required: true,
        description: `Verbatim quote of the user's close instruction (e.g. "close the session", "stop the browser"). Must contain at least one of: close, end, stop, terminate, dispose, shut down, kill, quit, exit, fermer, arrêter, terminer. Rejected if empty or meta-phrase.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `JavaScript expression to evaluate in the browser page.`,
      },
      {
        name: 'country',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `Where this URL came from. user_prompt = user named it; page_snapshot = found in last take_snapshot; webmcp_tool = returned by a WebMCP tool. Any other provenance means the URL was invented and the call will be rejected.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `CSS selector of an element to screenshot. If provided, only that element is captured.`,
      },
      {
        name: 'session_id',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Element UID to drag from. Obtain via take_snapshot.`,
      },
      {
        name: 'to_uid',
        type: 'string',
        required: true,
        description: `Element UID to drag to. Obtain via take_snapshot.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `Unused placeholder field required by the MCP protocol. Pass any string value.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Image format for the screenshot. Accepted values: jpg, png, webp, gif.`,
      },
      {
        name: 'js',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `CSS selector to wait for before returning the response. Use when the target content loads asynchronously.`,
      },
      {
        name: 'webhook',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'number',
        required: false,
        description: `Horizontal scroll pixels (optional)`,
      },
      {
        name: 'deltaY',
        type: 'number',
        required: false,
        description: `Vertical scroll pixels (optional, e.g. 500 to scroll down)`,
      },
      {
        name: 'uid',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Proof-of-work token for anti-bot bypass. Use scraping_instruction_enhanced to get guidance on the correct value.`,
      },
      {
        name: 'url',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Custom AI prompt for extracting specific data from the page. Avoid if the model can process the data directly.`,
      },
      {
        name: 'format',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `HTTP method for the request. Accepted values: GET, POST, PUT, PATCH, OPTIONS, HEAD.`,
      },
      {
        name: 'proxy_pool',
        type: 'string',
