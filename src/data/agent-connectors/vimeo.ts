...
export const tools: Tool[] = [
  {
    ...
    params: [
      ...
      { name: 'per_page', type: 'integer', required: false, description: `Number of categories per page` },
  ...
  },
  {
    ...
    params: [
      { name: 'channel_id', type: 'string', required: true, description: `Vimeo channel ID or slug` },
      { name: 'direction', type: 'string', required: false, description: `Sort direction` },
      { name: 'filter', type: 'string', required: false, description: `Filter videos by type` },
      { name: 'page', type: 'integer', required: false, description: `Page number of results` },
      { name: 'per_page', type: 'integer', required: false, description: `Number of videos per page` },
      { name: 'query', type: 'string', required: false, description: `Search query to filter channel videos` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'page', type: 'integer', required: false, description: `Page number of results` },
      { name: 'per_page', type: 'integer', required: false, description: `Number of channels per page` },
      { name: 'query', type: 'string', required: false, description: `Search query to filter channels by name` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'parent_folder_uri', type: 'string', required: false, description: `URI of the parent folder to nest this folder inside` },
    ],
  },
  {
    ...
    params: [
      { name: 'folder_id', type: 'string', required: true, description: `Folder (project) ID to add the video to` },
      { name: 'video_id', type: 'string', required: true, description: `Video ID to add to the folder` },
    ],
  },
  {
    ...
    params: [
      { name: 'folder_id', type: 'string', required: true, description: `Folder (project) ID to list videos from` },
      { name: 'direction', type: 'string', required: false, description: `Sort direction` },
      { name: 'filter', type: 'string', required: false, description: `Filter videos by type` },
      { name: 'page', type: 'integer', required: false, description: `Page number of results` },
      { name: 'per_page', type: 'integer', required: false, description: `Number of videos per page` },
      { name: 'query', type: 'string', required: false, description: `Search query to filter videos by name` },
      { name: 'sort', type: 'string', required: false, description: `Sort order for videos` },
    ],
  },
  {
    ...
    params: [
      { name: 'direction', type: 'string', required: false, description: `Sort direction` },
      { name: 'page', type: 'integer', required: false, description: `Page number of results` },
      { name: 'per_page', type: 'integer', required: false, description: `Number of folders per page` },
  ...
  },
  {
    ...
    params: [
      { name: 'direction', type: 'string', required: false, description: `Sort direction` },
      { name: 'filter', type: 'string', required: false, description: `Filter following list by type` },
      { name: 'page', type: 'integer', required: false, description: `Page number of results` },
      { name: 'per_page', type: 'integer', required: false, description: `Number of users per page` },
      { name: 'query', type: 'string', required: false, description: `Search query to filter following list by name` },
  ...
  },
  {
    ...
    params: [
      { name: 'direction', type: 'string', required: false, description: `Sort direction` },
      { name: 'filter', type: 'string', required: false, description: `Filter liked videos by type` },
      { name: 'page', type: 'integer', required: false, description: `Page number of results` },
      { name: 'per_page', type: 'integer', required: false, description: `Number of videos per page` },
  ...
  },
  {
    ...
    params: [
      { name: 'containing_uri', type: 'string', required: false, description: `Filter videos that contain a specific URI` },
      { name: 'direction', type: 'string', required: false, description: `Sort direction` },
      { name: 'filter', type: 'string', required: false, description: `Filter videos by type` },
      { name: 'page', type: 'integer', required: false, description: `Page number of results` },
      { name: 'per_page', type: 'integer', required: false, description: `Number of videos per page` },
      { name: 'query', type: 'string', required: false, description: `Search query to filter videos by title or description` },
      { name: 'sort', type: 'string', required: false, description: `Sort order for video results` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'brand_color', type: 'string', required: false, description: `Hex color code for showcase branding` },
      { name: 'description', type: 'string', required: false, description: `Description of the showcase` },
      { name: 'hide_nav', type: 'boolean', required: false, description: `Whether to hide Vimeo navigation in the showcase` },
      { name: 'hide_upcoming', type: 'boolean', required: false, description: `Whether to hide upcoming live events in the showcase` },
      { name: 'password', type: 'string', required: false, description: `Password for the showcase when privacy is set to 'password'` },
      { name: 'privacy', type: 'string', required: false, description: `Privacy setting for the showcase` },
      { name: 'review_mode', type: 'boolean', required: false, description: `Enable review mode for the showcase` },
      { name: 'sort', type: 'string', required: false, description: `Default sort for videos in the showcase` },
    ],
  },
  {
    ...
    params: [
      { name: 'album_id', type: 'string', required: true, description: `Showcase (album) ID to add the video to` },
      { name: 'video_id', type: 'string', required: true, description: `Video ID to add to the showcase` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'direction', type: 'string', required: false, description: `Sort direction` },
      { name: 'page', type: 'integer', required: false, description: `Page number of results` },
      { name: 'per_page', type: 'integer', required: false, description: `Number of showcases per page` },
      { name: 'query', type: 'string', required: false, description: `Search query to filter showcases by name` },
  ...
  },
  {
    ...
    params: [
      { name: 'follow_user_id', type: 'string', required: true, description: `Vimeo user ID to follow` },
    ],
  },
  {
    name: 'vimeo_user_get',
  ...
  },
  {
    ...
    params: [
      { name: 'user_id', type: 'string', required: true, description: `Vimeo user ID or username` },
      { name: 'direction', type: 'string', required: false, description: `Sort direction` },
      { name: 'filter', type: 'string', required: false, description: `Filter results by video type` },
      { name: 'page', type: 'integer', required: false, description: `Page number of results` },
      { name: 'per_page', type: 'integer', required: false, description: `Number of videos per page` },
      { name: 'query', type: 'string', required: false, description: `Search query to filter videos` },
      { name: 'sort', type: 'string', required: false, description: `Sort order for video results` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'video_id', type: 'string', required: true, description: `Vimeo video ID to comment on` },
    ],
  },
  {
    ...
    params: [
      { name: 'video_id', type: 'string', required: true, description: `Vimeo video ID to list comments from` },
      { name: 'direction', type: 'string', required: false, description: `Sort direction` },
      { name: 'page', type: 'integer', required: false, description: `Page number of results` },
      { name: 'per_page', type: 'integer', required: false, description: `Number of comments per page` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'content_rating', type: 'string', required: false, description: `Content rating of the video` },
      { name: 'description', type: 'string', required: false, description: `New description for the video` },
      { name: 'license', type: 'string', required: false, description: `Creative Commons license to apply` },
      { name: 'name', type: 'string', required: false, description: `New title for the video` },
      { name: 'password', type: 'string', required: false, description: `Password for the video when privacy view is set to 'password'` },
      { name: 'privacy_add', type: 'boolean', required: false, description: `Whether users can add the video to their showcases or channels` },
      { name: 'privacy_comments', type: 'string', required: false, description: `Who can comment on the video` },
      { name: 'privacy_download', type: 'boolean', required: false, description: `Whether users can download the video` },
      { name: 'privacy_embed', type: 'string', required: false, description: `Who can embed the video` },
      { name: 'privacy_view', type: 'string', required: false, description: `Who can view the video` },
    ],
  },
  {
    ...
    params: [
      { name: 'video_id', type: 'string', required: true, description: `Vimeo video ID` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'video_id', type: 'string', required: true, description: `Vimeo video ID to list tags from` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'direction', type: 'string', required: false, description: `Sort direction for results` },
      { name: 'filter', type: 'string', required: false, description: `Filter results by video type` },
      { name: 'page', type: 'integer', required: false, description: `Page number of results to return` },
      { name: 'per_page', type: 'integer', required: false, description: `Number of results to return per page` },
      { name: 'sort', type: 'string', required: false, description: `Sort order for search results` },
    ],
  },
  {
    ...
    params: [
      { name: 'video_id', type: 'string', required: true, description: `Vimeo video ID to add to Watch Later` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'page', type: 'integer', required: false, description: `Page number of results` },
      { name: 'per_page', type: 'integer', required: false, description: `Number of videos per page` },
      { name: 'sort', type: 'string', required: false, description: `Sort order for watch later videos` },
    ],
  },
  {
    ...
    params: [
      { name: 'event_types', type: 'array', required: true, description: `List of event types that will trigger this webhook` },
      { name: 'url', type: 'string', required: true, description: `HTTPS URL that Vimeo will send webhook POST requests to` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'page', type: 'integer', required: false, description: `Page number of results` },
      { name: 'per_page', type: 'integer', required: false, description: `Number of webhooks per page` },
    ],
  },
]
