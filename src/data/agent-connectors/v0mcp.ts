...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'message', type: 'string', required: true, description: `The initial message to start the chat with.` },
      { name: 'attachments', type: 'array', required: false, description: `Attachments to include with the initial message.` },
      { name: 'chatPrivacy', type: 'string', required: false, description: `Privacy level for the chat.` },
      { name: 'designSystemId', type: 'string', required: false, description: `The ID of a design system to apply to this chat.` },
      { name: 'modelConfiguration', type: 'object', required: false, description: `Model configuration for the chat.` },
      { name: 'projectId', type: 'string', required: false, description: `Associates the chat with a specific project.` },
      { name: 'responseMode', type: 'string', required: false, description: `Controls how the response is delivered.` },
      { name: 'system', type: 'string', required: false, description: `System-level context or background for the chat.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'chatId', type: 'string', required: true, description: `The ID of the chat to retrieve.` },
    ],
  },
  {
    name: 'v0mcp_getuser',
  ...
  },
  {
    ...
    params: [
      { name: 'chatId', type: 'string', required: true, description: `The ID of the chat to add the message to.` },
      { name: 'message', type: 'string', required: true, description: `The message content to send.` },
      { name: 'attachments', type: 'array', required: false, description: `Attachments to include with the message.` },
      { name: 'modelConfiguration', type: 'object', required: false, description: `Model configuration for processing the message.` },
    ],
  },
]
