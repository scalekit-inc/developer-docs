    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Name of the App to get the documentation for.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Name of the App from which Module should be retrieved.`,
      },
      {
        name: 'appVersion',
        type: 'integer',
        required: true,
        description: `Version of the App from which Module should be retrieved.`,
      },
      {
        name: 'moduleName',
        type: 'string',
      ...
      },
      {
        ...
        type: 'integer',
        required: true,
        description: `The ID of the Organization to get App Module for.`,
      },
      {
        name: 'format',
        type: 'string',
        required: false,
        description: `Format of the output allowing transformation before being returned.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Name of the App from which Modules should be listed.`,
      },
      {
        name: 'appVersion',
        type: 'integer',
        required: true,
        description: `Version of the App from which Modules should be listed.`,
      },
      {
        name: 'organizationId',
        type: 'integer',
        required: true,
        description: `The ID of the Organization to list App Modules for.`,
      },
      {
        name: 'usage',
        type: 'string',
        required: false,
        description: `Optionally applies usage filter to return only modules that are relevant for it.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The intention for which the recommended apps are requested. This should be a clear and concise description of the user's needs or goals.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Name of the Connection to retrieve metadata for.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The connection ID to get`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The team ID to list connections for`,
      },
      {
        name: 'scopes',
        type: 'object',
        required: false,
        description: `Scopes that are required on the requested connection types. Each connection type is a key in this object with an array of scopes as the value.`,
      },
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The numeric ID of the Make team where the connections/keys will be created once authorized.`,
      },
      {
        name: 'connections',
        type: 'array',
        required: false,
        description: `Array of OAuth or basic-auth connections to request. Each item needs at least a "type" (e.g. "google", "slack", "github").`,
      },
      {
        name: 'description',
        type: 'string',
      ...
      },
      {
        ...
        type: 'array',
        required: false,
        description: `Array of API keys to request. Each item needs at least a "type" (e.g. "apikeyauth", "basicauth").`,
      },
      {
        name: 'name',
        type: 'string',
        required: false,
        description: `Human-readable name for the credential request, displayed to the end-user who will authorize it.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The credential ID to decline`,
      },
      {
        name: 'reason',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The credential request ID to delete`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The numeric ID of an existing Make connection whose OAuth scopes need to be expanded.`,
      },
      {
        name: 'scopes',
        type: 'array',
        required: true,
        description: `One or more new OAuth scope strings to add to the connection. At least one scope must be new (not already granted).`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The credential request ID to get details for`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Name of tool, excluding the custom_apps_ prefix.  only connections_configure is available.`,
      },
  ...
  },
  {
    ...
    params: [
      { name: 'data', type: 'object', required: true, description: `Record data` },
      {
        ...
        type: 'number',
        required: true,
        description: `The data store ID to create the record in`,
      },
      {
        name: 'key',
        type: 'string',
        required: false,
        description: `Unique key for the record (optional)`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The data store ID to delete records from`,
      },
      {
        name: 'keys',
        type: 'array',
        required: true,
        description: `Array of record keys to delete`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The data store ID to list records from`,
      },
      {
        name: 'limit',
        type: 'number',
  ...
  },
  {
    ...
    params: [
      { name: 'data', type: 'object', required: true, description: `New record data` },
      {
        ...
        type: 'number',
        required: true,
        description: `The data store ID containing the record`,
      },
      {
        name: 'key',
        type: 'string',
        required: true,
        description: `Unique key of the record to replace`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `Unique key of the record to update`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `Maximum size in MB for the data store`,
      },
      { name: 'name', type: 'string', required: true, description: `Name of the data store` },
      {
        ...
        type: 'number',
        required: true,
        description: `ID of the team to create the data store in`,
      },
      {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The data store ID to delete`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The data store ID to retrieve`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The team ID to filter data stores by`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The data store ID to update`,
      },
      {
        name: 'datastructureId',
        type: 'number',
        required: false,
        description: `New data structure ID`,
      },
      {
        name: 'maxSizeMB',
        type: 'number',
        required: false,
        description: `New maximum size in MB for the data store`,
      },
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The data structure ID to delete`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The input data from which the specification should be generated. The content of this field should match the format specified in the 'type' field.`,
      },
      {
        name: 'type',
        type: 'string',
        required: false,
        description: `The format of the input data from which the specification should be generated.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The data structure ID to retrieve`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The team ID to list data structures for`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The data structure ID to update`,
      },
      {
        name: 'name',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'number',
        required: true,
        description: `The scenario ID the execution belongs to`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'object',
        required: true,
        description: `A blueprint of a Make Scenario.`,
      },
      {
        name: 'organizationId',
        type: 'integer',
        required: true,
        description: `The ID of the Organization in which context the extraction should operate.`,
      },
      {
        name: 'teamId',
        type: 'integer',
        required: true,
        description: `The ID of the Team in which context the extraction should operate.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Name of the App to which the module belongs.`,
      },
      {
        name: 'appVersion',
        type: 'integer',
        required: true,
        description: `Version of the App to which the module belongs.`,
      },
      {
        name: 'moduleName',
        type: 'string',
        required: true,
        description: `The name of the module to extract components from.`,
      },
      {
        name: 'organizationId',
        type: 'integer',
      ...
      },
      {
        ...
        type: 'boolean',
        required: false,
        description: `When enabled, the Tool will also include available options for each extracted component, which are especially useful when configuring a module with Scoped Connections.`,
      },
      {
        name: 'moduleIdOverride',
        type: 'integer',
        required: false,
        description: `When extracting the Components from Module, an artificial single-module Blueprint is created to run the extraction on. By default, the generated Module ID is #1. This parameter allows overriding the generated value.`,
      },
    ],
  },
  {
    ...
    params: [
      { name: 'name', type: 'string', required: true, description: `Name of the folder` },
      {
        ...
        type: 'number',
        required: true,
        description: `The team ID where the folder will be created`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The team ID to list folders for`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The type name of the hook (e.g. "slack-events", "gateway-webhook", "gateway-mailhook").`,
      },
      {
        name: 'format',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Name of the Hook to retrieve metadata for.`,
      },
    ],
  },
  {
    ...
    params: [
      { name: 'name', type: 'string', required: true, description: `The name of the webhook` },
      {
        ...
        type: 'number',
        required: true,
        description: `The team ID where the hook will be created`,
      },
      {
        name: 'typeName',
        type: 'string',
      ...
      },
      {
        ...
        type: 'object',
        required: false,
        description: `Additional data specific to the hook type`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'object',
        required: true,
        description: `New data configuration for the hook`,
      },
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Name of the Key to retrieve metadata for.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The team ID to list keys for`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'name', type: 'string', required: true, description: `Name of the organization` },
      {
        ...
        type: 'number',
        required: true,
        description: `The ID of the region the organization will be created in`,
      },
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Search public templates by name`,
      },
      {
        name: 'usedApps',
        type: 'array',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Name of the App from which the RPC should be executed.`,
      },
      {
        name: 'appVersion',
        type: 'integer',
        required: true,
        description: `Version of the App from which the RPC should be executed.`,
      },
      {
        name: 'data',
        type: 'object',
        required: true,
        description: `Object containing input values of the RPC.`,
      },
      {
        name: 'rpcName',
        type: 'string',
        required: true,
        description: `Name of the RPC to be executed.`,
      },
      {
        name: 'format',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Blueprint containing the scenario configuration`,
      },
      {
        name: 'scheduling',
        type: 'string',
        required: true,
        description: `Scheduling configuration for the scenario`,
      },
      {
        name: 'teamId',
        type: 'number',
        required: true,
        description: `ID of the team where the scenario will be created`,
      },
      {
        name: 'basedon',
        type: 'string',
        required: false,
        description: `ID of an existing template to base this one on`,
      },
      {
        name: 'confirmed',
        type: 'boolean',
      ...
      },
      {
        ...
        type: 'number',
        required: false,
        description: `ID of the folder where the scenario will be placed`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The scenario ID to deactivate`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The scenario ID to retrieve`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The scenario ID to get the interface for`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The team ID to filter scenarios by`,
      },
    ],
  },
  {
    ...
    params: [
      { name: 'scenarioId', type: 'number', required: true, description: `The scenario ID to run` },
      {
        ...
        type: 'string',
        required: false,
        description: `URL to call once the scenario execution finishes`,
      },
      {
        name: 'data',
        type: 'object',
      ...
      },
      {
        ...
        type: 'boolean',
        required: false,
        description: `Whether to run responsively`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'number',
        required: true,
        description: `The scenario ID to update the interface for`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The scenario ID to update`,
      },
      {
        name: 'blueprint',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'number',
        required: false,
        description: `Maximum operations limit for the team`,
      },
      {
        name: 'transferLimit',
        type: 'number',
        required: false,
        description: `Maximum data transfer limit for the team`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'number',
        required: true,
        description: `The organization ID to list teams for`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'array',
        required: true,
        description: `An array of input parameters that the Tool accepts.`,
      },
      {
        name: 'module',
        type: 'object',
        required: true,
        description: `Details of the module that the Tool will encapsulate.`,
      },
      { name: 'name', type: 'string', required: true, description: `The name of the Tool.` },
      {
        ...
        type: 'integer',
        required: true,
        description: `The ID of the Team under which the Tool will be created.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'integer',
        required: true,
        description: `The ID of the Tool to be retrieved.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'integer',
        required: true,
        description: `The ID of the Tool to be updated.`,
      },
      {
        name: 'description',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'object',
        required: true,
        description: `Module "epoch" configuration to be validated. This collection represents settings for trigger pointer (what epoch to watch).`,
      },
      {
        name: 'moduleName',
        type: 'string',
        required: true,
        description: `The name of the module to validate the configuration for.`,
      },
      {
        name: 'organizationId',
        type: 'integer',
        required: true,
        description: `The ID of the Organization in which context the Validation should operate.`,
      },
      {
        name: 'parameters',
        type: 'object',
        required: true,
        description: `Module "parameters" configuration. Since Epoch exists only on triggers, there are no dynamic parameters. This collection is not directly validated, but serves as context for RPC calls, which are based on the module configuration.`,
      },
      {
        name: 'teamId',
        type: 'integer',
        required: true,
        description: `The ID of the Team in which context the Validation should operate.`,
      },
      {
        name: 'strict',
        type: 'boolean',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `The type name of the hook to validate the configuration for (e.g. "slack-events", "gateway-webhook", "gateway-mailhook").`,
      },
      {
        name: 'values',
        type: 'object',
        required: true,
        description: `Hook configuration values to be validated against the form schema.`,
      },
      {
        name: 'strict',
        type: 'boolean',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'object',
        required: true,
        description: `Module "mapper" configuration to be validated. These are dynamic parameters.`,
      },
      {
        name: 'moduleName',
        type: 'string',
      ...
      },
      {
        ...
        type: 'object',
        required: true,
        description: `Module "parameters" configuration to be validated. These are static parameters.`,
      },
      {
        name: 'teamId',
        type: 'integer',
      ...
      },
      {
        ...
        type: 'object',
        required: false,
        description: `Dictionary of values to be stored as part of 'extra' entry in the field's restore object.`,
      },
      {
        name: 'schemas',
        type: 'boolean',
        required: false,
        description: `Enables generation of fully expanded Forman schemas with all dynamic nested fields resolved.`,
      },
      {
        name: 'states',
        type: 'boolean',
    ...
    params: [
      {
        ...
        type: 'object',
        required: true,
        description: `A scheduling configuration of a Make Scenario.`,
      },
    ],
  },
]
