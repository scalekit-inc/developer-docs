...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'file_content', type: 'string', required: true, description: `The actual file content (CSV or XLSX file bytes as a string) from the conversation context.` },
      { name: 'headers', type: 'object', required: true, description: `The headers map returned from bulk_upload_validate (as a JSON object with string keys and string values).` },
      { name: 'upload_url', type: 'string', required: true, description: `The signed upload URL returned from bulk_upload_validate.` },
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'content_type', type: 'string', required: false, description: `MIME type for the upload. e.g. text/csv for CSV files or application/vnd.openxmlformats-officedocument.spreadsheetml.sheet for XLSX.` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
    ],
  },
  {
    ...
    params: [
      { name: 'filename', type: 'string', required: true, description: `Logical filename for the bulk upload (for example, "contacts.csv" or "links.xlsx").` },
      { name: 'upload_type', type: 'string', required: true, description: `Type of bulk upload. Must be exactly one of: "link", "qr_code", or "coupled_link".` },
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'domain', type: 'string', required: false, description: `Optional short domain to use for created links. If omitted, backend defaults and validation apply.` },
      { name: 'group_guid', type: 'string', required: false, description: `Optional group GUID to associate with this bulk upload. If omitted, the default group may be used.` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
      { name: 'template_id', type: 'string', required: false, description: `QR code template ID. Required for qr_code and coupled_link uploads. Use 'QTDTmplWLogo' to include Bitly logo, 'QTDTmplNLogo' to exclude it.` },
    ],
  },
  {
    ...
    params: [
      { name: 'group_guid', type: 'string', required: true, description: `The GUID of the group to create the QR code in` },
      { name: 'long_url', type: 'string', required: true, description: `The destination URL for the QR code` },
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'archived', type: 'boolean', required: false, description: `Whether the QR code should be archived (default: false)` },
      { name: 'bitlink_id', type: 'string', required: false, description: `Existing short link ID to use as destination` },
      { name: 'render_customizations', type: 'object', required: false, description: `Visual customizations for the QR code as a JSON object. e.g. {"dot_pattern_color": "#EF8000", "dot_pattern_type": "rounded", "background_color": "#ffffff"}. Supports corner colors, gradient, and logo configuration.` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
  ...
  },
  {
    ...
    params: [
      { name: 'long_url', type: 'string', required: true, description: `The URL to be shortened. Must be a valid HTTP or HTTPS URL. Required if bitlink_id is not provided.` },
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'bitlink_id', type: 'string', required: false, description: `An existing Bitly link to add a custom back-half to. Use with keyword parameter. Required if long_url is not provided.` },
      { name: 'domain', type: 'string', required: false, description: `Custom short domain to use (e.g., 'bit.ly', 'custom-domain.com'). Uses group default if not specified.` },
      { name: 'group_guid', type: 'string', required: false, description: `GUID of the group to create the short link in. Uses user's default group if not specified.` },
      { name: 'keyword', type: 'string', required: false, description: `Custom back-half for the short link (e.g. 'summer-sale' creates 'bit.ly/summer-sale'). Must be unique. Omit for a random hash.` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
      { name: 'tags', type: 'array', required: false, description: `Array of strings to tag the short link for organization (e.g., ['campaign', 'social-media'])` },
      { name: 'title', type: 'string', required: false, description: `Custom title for the short link to help with organization and identification.` },
    ],
  },
  {
    ...
    params: [
      { name: 'group_guid', type: 'string', required: true, description: `The unique identifier of the group (workspace)` },
      { name: 'long_url', type: 'string', required: true, description: `URL to shorten. Required unless bitlink_id is provided (same rules as create_short_link).` },
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'archived', type: 'boolean', required: false, description: `Whether the QR code should be archived (default: false).` },
      { name: 'bitlink_id', type: 'string', required: false, description: `The complete short link in 'domain/hash' format (e.g., 'bit.ly/ABC123' or 'custom-domain.com/keyword')` },
      { name: 'domain', type: 'string', required: false, description: `Custom short domain (e.g. bit.ly).` },
      { name: 'keyword', type: 'string', required: false, description: `Custom back-half for the short link.` },
      { name: 'qr_title', type: 'string', required: false, description: `Title for the QR code; defaults to the link title when omitted.` },
      { name: 'render_customizations', type: 'object', required: false, description: `Visual customizations for the QR code as a JSON object. e.g. {"dot_pattern_color": "#EF8000", "dot_pattern_type": "rounded", "background_color": "#ffffff"}. Supports corner colors, gradient, and logo configuration.` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
  ...
  },
  {
    ...
    params: [
      { name: 'bitlink_id', type: 'string', required: true, description: `The complete short link in 'domain/hash' format (e.g., 'bit.ly/ABC123' or 'custom-domain.com/keyword')` },
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'custom_bitlink', type: 'string', required: true, description: `The short link in 'domain/hash' format (e.g., 'bit.ly/ABC123' or 'custom-domain.com/keyword')` },
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      ...
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
      { name: 'size', type: 'string', required: false, description: `Maximum number of results to return (default varies)` },
      { name: 'unit', type: 'string', required: false, description: `Time granularity for metrics data: 'minute', 'hour', 'day', 'week', or 'month'. Determines how metrics are grouped by time. default: day` },
      { name: 'unit_reference', type: 'string', required: false, description: `ISO 8601 end timestamp for the time range. The range covers the last 'units' periods ending on this date. e.g. 2024-01-31T00:00:00+0000` },
      { name: 'units', type: 'string', required: false, description: `Number of time periods to include (e.g., '7' with unit='day' returns 7 days of data). Defaults to 30 when not specified.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'group_guid', type: 'string', required: true, description: `The unique identifier of the group (workspace)` },
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'archived', type: 'string', required: false, description: `Filter by archived status: 'on' (archived only), 'off' (non-archived only), 'both' (all)` },
      { name: 'query', type: 'string', required: false, description: `Search term to filter QR codes by title or destination URL` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
      { name: 'search_after', type: 'string', required: false, description: `Pagination cursor for retrieving next page of results` },
      { name: 'size', type: 'string', required: false, description: `Number of QR codes to return (default: 50, max: 100)` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'archived', type: 'string', required: false, description: `Filter by archived status: 'on' (archived only), 'off' (non-archived only), 'both' (all)` },
      { name: 'created_after', type: 'string', required: false, description: `Filter links created after this timestamp (ISO 8601 format)` },
      { name: 'created_before', type: 'string', required: false, description: `Filter links created before this timestamp (ISO 8601 format)` },
      { name: 'query', type: 'string', required: false, description: `Search term to filter links by title, destination URL, or short URL` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
      { name: 'search_after', type: 'string', required: false, description: `Pagination cursor for retrieving next page of results` },
      { name: 'size', type: 'string', required: false, description: `Number of links to return (default: 50, max: 100)` },
    ],
  },
  {
    ...
    params: [
      { name: 'group_guid', type: 'string', required: true, description: `The unique identifier of the group (workspace)` },
      { name: 'sort', type: 'string', required: true, description: `Sort method for the results. Currently supported: 'clicks' (rank by click performance)` },
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
      { name: 'size', type: 'string', required: false, description: `Maximum number of results to return (default varies)` },
      { name: 'unit', type: 'string', required: false, description: `Time granularity for metrics data: 'minute', 'hour', 'day', 'week', or 'month'. Determines how metrics are grouped by time. default: day` },
  ...
  },
  {
    ...
    params: [
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'organization_guid', type: 'string', required: false, description: `Optional organization GUID to filter groups by specific organization. If provided, only groups belonging to this organization will be returned.` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'qrcode_id', type: 'string', required: true, description: `The unique identifier of the QR code` },
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
    ],
  },
  {
    ...
    params: [
      { name: 'qrcode_id', type: 'string', required: true, description: `The unique identifier of the QR code` },
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'format', type: 'string', required: false, description: `Image format: 'svg' or 'png' (default: svg)` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'qrcode_id', type: 'string', required: true, description: `The QR code ID to update` },
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'archived', type: 'boolean', required: false, description: `Whether the QR code should be archived` },
      { name: 'render_customizations', type: 'object', required: false, description: `Visual customizations for the QR code as a JSON object. e.g. {"dot_pattern_color": "#EF8000", "dot_pattern_type": "rounded", "background_color": "#ffffff"}. Supports corner colors, gradient, and logo configuration.` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
      { name: 'title', type: 'string', required: false, description: `The new title for the QR code` },
    ],
  },
  {
    ...
    params: [
      { name: 'bitlink_id', type: 'string', required: true, description: `The complete short link in 'domain/hash' format (e.g., 'bit.ly/ABC123' or 'custom-domain.com/keyword')` },
      { name: '_meta', type: 'object', required: false, description: `Optional metadata about this request. Include user_prompt, caller_agent (e.g. claude), intent_classification, conversation_id.` },
      { name: 'archived', type: 'boolean', required: false, description: `Set to true to archive the short link, false to unarchive it. Archived links are hidden from most views but still work.` },
      { name: 'long_url', type: 'string', required: false, description: `New destination URL to redirect the short link to. Use this to change where the short link points.` },
      { name: 'response_format', type: 'string', required: false, description: `'text' (default) or 'json'` },
      { name: 'tags', type: 'array', required: false, description: `Array of strings to replace the current tags. Pass empty array to remove all tags. Leave undefined to keep current tags.` },
      { name: 'title', type: 'string', required: false, description: `New title for the short link. Leave empty to keep current title unchanged.` },
    ],
  },
]
