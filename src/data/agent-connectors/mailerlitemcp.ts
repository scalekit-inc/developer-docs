...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'email', type: 'string', required: true, description: `The email address of the subscriber` },
      { name: 'fields', type: 'object', required: false, description: `Custom fields for the subscriber` },
      { name: 'groups', type: 'array', required: false, description: `Group IDs to add the subscriber to` },
      { name: 'name', type: 'string', required: false, description: `The name of the subscriber` },
      { name: 'resubscribe', type: 'boolean', required: false, description: `Whether to resubscribe a previously unsubscribed subscriber` },
      { name: 'status', type: 'string', required: false, description: `Subscriber status (default: active)` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'subscriber_id', type: 'string', required: true, description: `The ID or email of the subscriber` },
    ],
  },
  {
    ...
    params: [
      { name: 'requests', type: 'array', required: true, description: `Array of API requests to execute (max 50)` },
    ],
  },
  {
    ...
    params: [
      { name: 'steps', type: 'array', required: true, description: `Planned automation steps in order` },
      { name: 'trigger_type', type: 'string', required: true, description: `The trigger type for the automation` },
      { name: 'resource_name', type: 'string', required: false, description: `Optional resource name to search for (partial match)` },
      { name: 'resource_type', type: 'string', required: false, description: `Resource type to look up. Defaults based on trigger: group for subscriber_joins_group, form for form_completed, shop for abandoned_cart, segment for subscriber_joins_segment` },
    ],
  },
  {
    ...
    params: [
      { name: 'campaign_id', type: 'string', required: true, description: `The ID of the campaign to cancel` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'steps', type: 'array', required: true, description: `Steps in order (email or delay)` },
      { name: 'trigger_config', type: 'object', required: true, description: `Trigger configuration (group_ids for subscriber_joins_group, segment_id for subscriber_joins_segment, form_id for form_completed, shop_id for abandoned_cart)` },
  ...
  },
  {
    ...
    params: [
      { name: 'from', type: 'string', required: true, description: `The sender email address (must be verified on the MailerLite account)` },
      ...
      { name: 'content', type: 'string', required: false, description: `The HTML content of the email (optional - can be designed in dashboard)` },
  ...
  },
  {
    ...
    params: [
      { name: 'groups', type: 'array', required: true, description: `Group IDs to assign new subscribers to (required, at least one)` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'filter', type: 'object', required: false, description: `Filter rules object. Format: {"rules": [[{"operator": "text_field_contains", "args": ["field_id", "value"]}]]}. Inner arrays are AND groups, outer array is OR between groups. Omit to create a segment without filters (can be configured in dashboard).` },
    ],
  },
  {
    ...
    params: [
      { name: 'events', type: 'array', required: true, description: `Webhook events to subscribe to` },
      { name: 'url', type: 'string', required: true, description: `The URL to send webhook payloads to` },
      { name: 'batchable', type: 'boolean', required: false, description: `Required as true for campaign.open, campaign.click, and subscriber.deleted events` },
      { name: 'enabled', type: 'boolean', required: false, description: `Whether the webhook is enabled` },
  ...
  },
  {
    ...
    params: [
      { name: 'automation_id', type: 'string', required: true, description: `The ID of the automation to delete` },
    ],
  },
  {
    ...
    params: [
      { name: 'campaign_id', type: 'string', required: true, description: `The ID of the campaign to delete` },
    ],
  },
  {
    ...
    params: [
      { name: 'field_id', type: 'string', required: true, description: `The ID of the field to delete` },
    ],
  },
  {
    ...
    params: [
      { name: 'form_id', type: 'string', required: true, description: `The ID of the form to delete` },
    ],
  },
  {
    ...
    params: [
      { name: 'group_id', type: 'string', required: true, description: `The ID of the group to delete` },
    ],
  },
  {
    ...
    params: [
      { name: 'segment_id', type: 'string', required: true, description: `The ID of the segment to delete` },
    ],
  },
  {
    ...
    params: [
      { name: 'subscriber_id', type: 'string', required: true, description: `The ID or email of the subscriber to delete` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'user_intent', type: 'string', required: false, description: `The user's specific automation goal (e.g., welcome series, abandoned cart)` },
    ],
  },
  {
    ...
    params: [
      { name: 'automation_id', type: 'string', required: true, description: `ID of automation to test` },
      { name: 'test_email', type: 'string', required: true, description: `Email address for virtual test subscriber` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Identifier returned from the search tool (e.g., "campaign:123", "group:456")` },
    ],
  },
  {
    ...
    params: [
      { name: 'plain_text', type: 'string', required: true, description: `The plain text email body to validate` },
      { name: 'subject', type: 'string', required: true, description: `The email subject line to validate` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'automation_id', type: 'string', required: true, description: `The ID of the automation` },
      { name: 'status', type: 'string', required: true, description: `Filter by activity status` },
      { name: 'date_from', type: 'string', required: false, description: `Filter from date (Y-m-d). For completed/canceled/failed statuses` },
      { name: 'date_to', type: 'string', required: false, description: `Filter to date (Y-m-d). For completed/canceled/failed statuses` },
      { name: 'limit', type: 'integer', required: false, description: `Number of results per page (default 10)` },
      { name: 'page', type: 'integer', required: false, description: `Page number` },
      { name: 'scheduled_from', type: 'string', required: false, description: `Filter scheduled from date (Y-m-d). For active status` },
      { name: 'scheduled_to', type: 'string', required: false, description: `Filter scheduled to date (Y-m-d). For active status` },
      { name: 'search', type: 'string', required: false, description: `Search by subscriber email` },
    ],
  },
  {
    ...
    params: [
      { name: 'campaign_id', type: 'string', required: true, description: `The ID of the campaign` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'limit', type: 'string', required: false, description: `Number of results per page (10, 25, 50, or 100)` },
  ...
  },
  {
    ...
    params: [
      { name: 'campaign_id', type: 'string', required: true, description: `The ID of the campaign` },
      { name: 'limit', type: 'integer', required: false, description: `Number of results (allowed values: 10, 25, 50, 100)` },
      { name: 'page', type: 'integer', required: false, description: `Page number for pagination` },
      { name: 'search', type: 'string', required: false, description: `Search by subscriber email` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'context', type: 'string', required: false, description: `What the user needs to edit (e.g., "design email", "edit automation")` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'limit', type: 'integer', required: false, description: `Number of subscribers to return (1-100)` },
      { name: 'page', type: 'integer', required: false, description: `Page number for pagination` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'cursor', type: 'string', required: false, description: `Cursor for pagination` },
      { name: 'limit', type: 'integer', required: false, description: `Number of subscribers to return (1-100)` },
      { name: 'status', type: 'string', required: false, description: `Filter by subscriber status` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'group_id', type: 'string', required: true, description: `The ID of the group to import to` },
      { name: 'subscribers', type: 'array', required: true, description: `Array of subscribers to import` },
      { name: 'autoresponders', type: 'boolean', required: false, description: `Whether to trigger autoresponders` },
      { name: 'resubscribe', type: 'boolean', required: false, description: `Whether to resubscribe previously unsubscribed subscribers` },
    ],
  },
  {
    ...
    params: [
      { name: 'template_id', type: 'string', required: true, description: `ID of template to install` },
    ],
  },
  {
    ...
    params: [
      { name: 'enabled_only', type: 'boolean', required: false, description: `Only show enabled automations` },
      { name: 'limit', type: 'number', required: false, description: `Maximum number of automations to return` },
    ],
  },
  {
    ...
    params: [
      { name: 'cursor', type: 'string', required: false, description: `Cursor for pagination` },
      { name: 'limit', type: 'integer', required: false, description: `Number of campaigns to return (allowed values: 1, 10, 25, 50, 100)` },
  ...
  },
  {
    ...
    params: [
      { name: 'limit', type: 'number', required: false, description: `Maximum number of templates to return (default: 10)` },
      { name: 'search', type: 'string', required: false, description: `Search filter for template names` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'limit', type: 'integer', required: false, description: `Number of fields to return` },
      { name: 'page', type: 'integer', required: false, description: `Page number` },
      { name: 'sort', type: 'string', required: false, description: `Sort field` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'limit', type: 'integer', required: false, description: `Number of templates to return (default: 25)` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'limit', type: 'integer', required: false, description: `Number of forms to return (1-100)` },
  ...
  },
  {
    ...
    params: [
      { name: 'resource_type', type: 'string', required: true, description: `Type of resource to list (singular: group, form, shop, or segment)` },
      { name: 'name_filter', type: 'string', required: false, description: `Optional filter by name (partial match)` },
    ],
  },
  {
    ...
    params: [
      { name: 'limit', type: 'integer', required: false, description: `Number of segments to return (1-100)` },
      { name: 'page', type: 'integer', required: false, description: `Page number for pagination` },
    ],
  },
  {
    ...
    params: [
      { name: 'cursor', type: 'string', required: false, description: `Cursor for pagination` },
      { name: 'limit', type: 'integer', required: false, description: `Number of subscribers to return (1-100, default 25)` },
      { name: 'status', type: 'string', required: false, description: `Filter by subscriber status` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'campaign_id', type: 'string', required: true, description: `The ID of the campaign to schedule` },
      { name: 'delivery', type: 'string', required: true, description: `Delivery type: "instant" sends now, "scheduled" sends at a specific time, "timezone_based" sends per subscriber timezone, "smart_sending" uses AI-optimized send times` },
      { name: 'schedule', type: 'object', required: false, description: `Schedule details — required when delivery is "scheduled" or "timezone_based"` },
    ],
  },
  {
    ...
    params: [
      { name: 'query', type: 'string', required: true, description: `Text to search for across MailerLite resources` },
  ...
  },
  {
    ...
    params: [
      { name: 'resource_id', type: 'string', required: true, description: `The ID of the selected resource` },
      { name: 'resource_name', type: 'string', required: true, description: `The name of the selected resource` },
      { name: 'resource_type', type: 'string', required: true, description: `The type of the selected resource` },
    ],
  },
  {
    ...
    params: [
      { name: 'automation_id', type: 'string', required: true, description: `ID of automation to test` },
      { name: 'email', type: 'string', required: true, description: `Your email address to receive the test emails` },
    ],
  },
  {
    ...
    params: [
      { name: 'user_request', type: 'string', required: true, description: `What the user asked for` },
    ],
  },
  {
    ...
    params: [
      { name: 'subject_lines', type: 'array', required: true, description: `Array of subject line candidates to validate` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'automation_id', type: 'string', required: true, description: `Automation ID` },
      { name: 'step_index', type: 'number', required: true, description: `Delay step index (0-based, only counts delay steps)` },
      { name: 'unit', type: 'string', required: true, description: `Delay duration unit` },
      { name: 'value', type: 'number', required: true, description: `Delay duration value (must be positive)` },
    ],
  },
  {
    ...
    params: [
      { name: 'automation_id', type: 'string', required: true, description: `Automation ID` },
      { name: 'step_index', type: 'number', required: true, description: `Email step index (0-based, only counts email steps)` },
      { name: 'subject', type: 'string', required: true, description: `Email subject line` },
      { name: 'plain_text', type: 'string', required: false, description: `Plain text email content` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'field_id', type: 'string', required: true, description: `The ID of the field to update` },
  ...
  },
  {
    ...
    params: [
      { name: 'form_id', type: 'string', required: true, description: `The ID of the form to update` },
  ...
  },
  {
    ...
    params: [
      { name: 'group_id', type: 'string', required: true, description: `The ID of the group to update` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'segment_id', type: 'string', required: true, description: `The ID of the segment to update` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'name', type: 'string', required: false, description: `The new name for the subscriber` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'batchable', type: 'boolean', required: false, description: `Required as true for campaign.open, campaign.click, and subscriber.deleted events` },
      { name: 'enabled', type: 'boolean', required: false, description: `Whether the webhook is enabled` },
      { name: 'events', type: 'array', required: false, description: `Webhook events to subscribe to` },
      { name: 'name', type: 'string', required: false, description: `A name for the webhook` },
      { name: 'url', type: 'string', required: false, description: `The URL to send webhook payloads to` },
    ],
  },
]
