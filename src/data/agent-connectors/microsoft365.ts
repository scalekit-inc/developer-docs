...
export const tools: Tool[] = [
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The base name of the PowerPoint presentation to create, without the .pptx extension. The extension is appended automatically. Example: "Q4 Review" creates "Q4 Review.pptx".`,
      },
      {
        name: 'parent_id',
        type: 'string',
        required: true,
        description: `The OneDrive item ID of the parent folder where the presentation will be created. Use "root" to create the file at the top level of OneDrive. Obtain folder IDs from list or get drive item operations.`,
      },
      {
        name: 'conflict_behavior',
        type: 'string',
        required: false,
        description: `Behavior when a file with the same name already exists in the target folder. "fail" aborts and returns an error, "replace" overwrites the existing file, "rename" saves the new presentation with a different auto-generated name. Default: replace.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique OneDrive item ID of the PowerPoint presentation (.pptx) to export as PDF. Obtain item IDs from list drive items, search drive items, or get drive item operations. Example: "01BYE5RZ6QN3ZWBTUFOFD3GSPGOHDJD36K".`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team to add the member to.`,
      },
      {
        name: 'user_id',
        type: 'string',
        required: true,
        description: `The Azure AD object ID of the user to add to the team. This is the user's unique identifier in Microsoft Entra ID, not their email address.`,
      },
      {
        name: 'role',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the time-off request to approve. Obtain from the list time-off requests API.`,
      },
      {
        name: 'team_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team whose schedule contains the time-off request.`,
      },
      {
        name: 'message',
        type: 'string',
        required: false,
        description: `Optional message from the manager to include with the approval decision. Example: 'Approved, enjoy your vacation!'`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel to archive.`,
      },
      {
        name: 'team_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team that contains the channel to archive.`,
      },
      {
        name: 'set_spo_site_readonly',
        type: 'boolean',
        required: false,
        description: `If true, the SharePoint Online (SPO) site associated with the channel will also be set to read-only when the channel is archived. Defaults to false.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team to archive.`,
      },
      {
        name: 'should_set_spo_site_read_only_for_members',
        type: 'boolean',
        required: false,
        description: `If true, sets the SharePoint Online site associated with the team to read-only for members. Defaults to false.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The GUID of the application session whose presence override should be cleared. Must match the session ID passed to the setPresence call. Example: '22553876-f5ab-4529-bffb-cfe50aa89f87'.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The display name for the new cloned team.`,
      },
      {
        name: 'parts_to_clone',
        type: 'string',
        required: true,
        description: `Comma-separated list of team parts to clone. Valid parts: apps, tabs, settings, channels, members. Example: 'apps,tabs,settings,channels,members'.`,
      },
      {
        name: 'team_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team to clone.`,
      },
      {
        name: 'classification',
        type: 'string',
        required: false,
        description: `Classification label for the cloned team (organization-defined, e.g., 'Confidential', 'Internal'). Optional.`,
      },
      {
        name: 'description',
        type: 'string',
        required: false,
        description: `Optional description for the cloned team.`,
      },
      {
        name: 'mail_nickname',
        type: 'string',
        required: false,
        description: `The mail alias (nickname) for the new team's Microsoft 365 Group. Must be unique in the tenant and contain only alphanumeric characters and hyphens.`,
      },
      {
        name: 'visibility',
        type: 'string',
        required: false,
        description: `Visibility of the cloned team. Valid values: 'public' (anyone in org can join), 'private' (owner must invite). Defaults to 'private'.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The display name of the new channel. Must be unique within the team and cannot contain special characters like #, &, :, <, >, *, ?.`,
      },
      {
        name: 'team_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team in which to create the channel.`,
      },
      {
        name: 'description',
        type: 'string',
        required: false,
        description: `Optional description for the new channel (plain text, up to 1024 characters).`,
      },
      {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The end date and time of the meeting in ISO 8601 UTC format. Example: '2024-07-15T10:00:00Z'.`,
      },
      {
        name: 'start_date_time',
        type: 'string',
        required: true,
        description: `The start date and time of the meeting in ISO 8601 UTC format. Example: '2024-07-15T09:00:00Z'.`,
      },
      {
        name: 'subject',
        type: 'string',
        required: true,
        description: `The subject/title of the online meeting. Displayed to all participants in the meeting invite and join page.`,
      },
      {
        name: 'allowed_presenters',
        type: 'string',
        required: false,
        description: `Who can present in the meeting. 'everyone' allows all participants, 'organization' restricts to org members, 'roleIsPresenter' limits to assigned presenters, 'organizer' restricts to the meeting organizer only. Defaults to 'organization'.`,
      },
      {
        name: 'attendee_upns',
        type: 'array',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The end date and time of the shift in ISO 8601 UTC format. Example: '2024-07-15T17:00:00Z'.`,
      },
      {
        name: 'scheduling_group_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the scheduling group (team member group) to assign the shift to. Obtain from the scheduling groups API.`,
      },
      {
        name: 'start_date_time',
        type: 'string',
        required: true,
        description: `The start date and time of the shift in ISO 8601 UTC format. Example: '2024-07-15T09:00:00Z'.`,
      },
      {
        name: 'team_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team whose schedule to create the shift in.`,
      },
      {
        name: 'user_id',
        type: 'string',
        required: true,
        description: `The unique identifier (object ID) of the user to assign the shift to. Obtain from the Microsoft Entra user object or list users API.`,
      },
      {
        name: 'display_name',
        type: 'string',
        required: false,
        description: `Optional display name for the shift, shown on the schedule. Example: 'Morning Shift'.`,
      },
      {
        name: 'notes',
        type: 'string',
        required: false,
        description: `Optional notes or instructions for the shift, visible to the assigned user. Example: 'Please cover the front desk.'.`,
      },
      {
        name: 'theme',
        type: 'string',
        required: false,
        description: `Color theme for the shift block on the schedule view. Valid values: white, blue, green, purple, pink, yellow, gray, darkBlue, darkGreen, darkPurple, darkPink, darkYellow. Defaults to 'blue'.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        name: 'recipient_shift_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the shift belonging to the recipient (the employee whose shift the sender wants to take). Obtain from the list shifts API.`,
      },
      {
        name: 'recipient_user_id',
        type: 'string',
        required: true,
        description: `The Azure AD object ID of the employee being asked to swap their shift.`,
      },
      {
        name: 'sender_shift_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the shift belonging to the sender (the employee initiating the swap). Obtain from the list shifts API.`,
      },
      {
        name: 'sender_user_id',
        type: 'string',
        required: true,
        description: `The Azure AD object ID of the employee initiating the shift swap request.`,
      },
      {
        name: 'team_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team whose schedule the shift swap request belongs to.`,
      },
      {
        name: 'sender_message',
        type: 'string',
        required: false,
        description: `Optional message from the requesting employee explaining why they want to swap. Example: 'I have a doctor's appointment during my shift.'`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The display name of the new team. Must be unique within the tenant.`,
      },
      {
        name: 'description',
        type: 'string',
        required: false,
        description: `Optional description for the new team (plain text, up to 1024 characters).`,
      },
      {
        name: 'template',
        type: 'string',
        required: false,
        description: `The Teams template to use when creating the team. Valid values: 'standard', 'educationClass', 'educationStaff', 'educationProfessionalLearningCommunity', 'healthcareWard', 'healthcareTeam'. Defaults to 'standard'.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The end date and time of the time-off period in ISO 8601 UTC format. Example: '2024-08-02T17:00:00Z'.`,
      },
      {
        name: 'sender_user_id',
        type: 'string',
        required: true,
        description: `The Azure AD object ID of the employee submitting the time-off request. Obtain from the Microsoft Entra user object or list users API.`,
      },
      {
        name: 'start_date_time',
        type: 'string',
        required: true,
        description: `The start date and time of the time-off period in ISO 8601 UTC format. Example: '2024-07-29T00:00:00Z'.`,
      },
      {
        name: 'team_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team whose schedule the request belongs to.`,
      },
      {
        name: 'time_off_reason_id',
        type: 'string',
        required: true,
        description: `The ID of the time-off reason (e.g., vacation, sick leave) defined in the team schedule. Obtain from the team's timeOffReasons API.`,
      },
      {
        name: 'sender_message',
        type: 'string',
        required: false,
        description: `Optional message from the employee to the manager accompanying the time-off request. Example: 'Family vacation.'`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the time-off request to decline. Obtain from the list time-off requests API.`,
      },
      {
        name: 'team_id',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Optional message from the manager to include with the decline decision. Example: 'Insufficient coverage during that period.'`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel to delete. The General channel cannot be deleted.`,
      },
      {
        name: 'team_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team that contains the channel to delete.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel containing the message to delete.`,
      },
      {
        name: 'message_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the channel message to soft-delete.`,
      },
      {
        name: 'team_id',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the online meeting to delete. Obtain from the create meeting response or list meetings API.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the shift to delete. Obtain from the create shift response or list shifts API.`,
      },
      {
        name: 'team_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team whose schedule contains the shift to delete.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team (Group ID) to permanently delete.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel to retrieve.`,
      },
      {
        name: 'team_id',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel containing the message.`,
      },
      {
        name: 'message_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel message to retrieve.`,
      },
      {
        name: 'team_id',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams chat that contains the message.`,
      },
      {
        name: 'message_id',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel containing the message thread.`,
      },
      {
        name: 'message_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the parent channel message whose replies to list.`,
      },
      {
        name: 'team_id',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel to list messages from.`,
      },
      {
        name: 'team_id',
        type: 'string',
      ...
      },
      {
        ...
        type: 'integer',
        required: false,
        description: `Number of messages to skip for pagination. Use with $top to page through results.`,
      },
      {
        name: '$top',
        type: 'integer',
        required: false,
        description: `Number of channel messages to return per page (1–50, default: 20). Microsoft Graph caps this at 50 for channel messages.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel whose tabs to list.`,
      },
      {
        name: 'team_id',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `OData $expand expression to include related resources. Defaults to 'teamsApp' which includes the app details for each tab. Set to null to suppress expansion.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team whose channels to list.`,
      },
      {
        name: '$filter',
        type: 'string',
        required: false,
        description: `OData filter expression to narrow results. Example: "membershipType eq 'standard'" or "displayName eq 'General'".`,
      },
      {
        name: '$select',
        type: 'string',
        required: false,
        description: `Comma-separated list of channel properties to return. Example: 'id,displayName,membershipType,webUrl'. Reduces response payload size.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams chat to list messages from. Obtain from the list chats API or Teams URL.`,
      },
      {
        name: '$orderby',
        type: 'string',
        required: false,
        description: `OData orderby expression for sorting messages. Default is 'createdDateTime desc' (newest first). Example: 'createdDateTime asc' for oldest first.`,
      },
      {
        name: '$top',
        type: 'integer',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team whose schedule shift swap requests to list.`,
      },
      {
        name: '$filter',
        type: 'string',
        required: false,
        description: `OData filter expression to narrow shift swap request results. Example: "state eq 'pending'" to fetch only pending swap requests.`,
      },
      {
        name: '$top',
        type: 'integer',
        required: false,
        description: `Maximum number of shift swap requests to return. Use to limit the response size. Example: 25.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team whose schedule shifts to list.`,
      },
      {
        name: '$filter',
        type: 'string',
        required: false,
        description: `OData filter expression to narrow shift results. Example: "sharedShift/startDateTime ge 2024-07-01T00:00:00Z" to fetch shifts starting on or after July 1, 2024.`,
      },
      {
        name: '$top',
        type: 'integer',
        required: false,
        description: `Maximum number of shifts to return. Use to limit the response size. Example: 25.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team whose members to list.`,
      },
      {
        name: '$filter',
        type: 'string',
        required: false,
        description: `OData filter expression to narrow results. Example: "roles/any(r:r eq 'owner')" to list only owners.`,
      },
      {
        name: '$select',
        type: 'string',
        required: false,
        description: `Comma-separated list of member properties to return. Example: 'id,displayName,roles,email'. Reduces response payload size.`,
      },
      {
        name: '$top',
        type: 'integer',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Comma-separated list of team properties to return. Example: 'id,displayName,description,visibility'. Reduces response payload size.`,
      },
      {
        name: '$top',
        type: 'integer',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team whose schedule time-off requests to list.`,
      },
      {
        name: '$filter',
        type: 'string',
        required: false,
        description: `OData filter expression to narrow time-off request results. Example: "state eq 'pending'" to fetch only pending requests.`,
      },
      {
        name: '$top',
        type: 'integer',
        required: false,
        description: `Maximum number of time-off requests to return. Use to limit the response size. Example: 25.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel that contains the message to pin.`,
      },
      {
        name: 'message_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel message to pin.`,
      },
      {
        name: 'team_id',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel for which to provision an email address.`,
      },
      {
        name: 'team_id',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel from which to remove the provisioned email address.`,
      },
      {
        name: 'team_id',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The conversationMember ID of the membership to remove. This is the unique ID of the member's team membership, returned by the list team members or add member APIs — it is NOT the Azure AD user ID.`,
      },
      {
        name: 'team_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team from which to remove the member.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel containing the message to reply to.`,
      },
      {
        name: 'content',
        type: 'string',
        required: true,
        description: `The text or HTML content of the reply message.`,
      },
      {
        name: 'message_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the channel message to reply to.`,
      },
      {
        name: 'team_id',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `The importance of the reply message. Valid values: 'normal', 'high', 'urgent'.`,
      },
      {
        name: 'subject',
        type: 'string',
        required: false,
        description: `Optional subject line for the reply (appears as a headline above the body).`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams chat that contains the message to reply to.`,
      },
      {
        name: 'content',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams chat message to reply to.`,
      },
      {
        name: 'content_type',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The search query string to find matching Teams messages. Supports keyword search and KQL (Keyword Query Language). Example: 'project kickoff' or 'from:alice@example.com subject:budget'.`,
      },
      {
        name: 'from',
        type: 'integer',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel to send the message to.`,
      },
      {
        name: 'content',
        type: 'string',
        required: true,
        description: `The text or HTML content of the message to send.`,
      },
      {
        name: 'team_id',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `The format of the message content: 'text' for plain text or 'html' for HTML markup. Defaults to 'text'.`,
      },
      {
        name: 'importance',
        type: 'string',
        required: false,
        description: `The importance of the message. Valid values: 'normal', 'high', 'urgent'. Defaults to normal if omitted.`,
      },
      {
        name: 'subject',
        type: 'string',
        required: false,
        description: `Optional subject line for the channel message (appears as a headline above the body).`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams chat to send the message to. Obtain from the list chats API or Teams client URL.`,
      },
      {
        name: 'content',
        type: 'string',
        required: true,
        description: `The text or HTML content of the message to send to the chat.`,
      },
      {
        name: 'content_type',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The preferred activity of the user. Must be consistent with the chosen availability. Valid values: Available, Busy, InACall, InAConferenceCall, InAMeeting, Presenting, Away, DoNotDisturb, UrgentInterruptionsOnly, OffWork.`,
      },
      {
        name: 'availability',
        type: 'string',
        required: true,
        description: `The preferred presence state of the user at the user level (not session-scoped). Valid values: Available, Busy, DoNotDisturb, BeRightBack, Away, Offline.`,
      },
      {
        name: 'expiration_duration',
        type: 'string',
        required: false,
        description: `How long the preferred presence override should remain active, expressed as an ISO 8601 duration. Example: 'PT1H' for 1 hour, 'PT4H' for 4 hours. If omitted, the preference persists until explicitly cleared via clearUserPreferredPresence.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The current activity of the user. Must be consistent with the chosen availability. Valid values: Available, Busy, InACall, InAConferenceCall, InAMeeting, Presenting, Away, DoNotDisturb, UrgentInterruptionsOnly, OffWork.`,
      },
      {
        name: 'availability',
        type: 'string',
        required: true,
        description: `The base presence state of the user. Valid values: Available, Busy, DoNotDisturb, BeRightBack, Away, Offline.`,
      },
      {
        name: 'session_id',
        type: 'string',
        required: true,
        description: `A stable GUID identifying the calling application session. Use a consistent GUID per application so multiple calls from the same app update the same session. Example: '22553876-f5ab-4529-bffb-cfe50aa89f87'.`,
      },
      {
        name: 'expiration_duration',
        type: 'string',
        required: false,
        description: `How long the presence override should remain active, expressed as an ISO 8601 duration. Example: 'PT1H' for 1 hour, 'PT30M' for 30 minutes. If omitted, the presence persists until explicitly cleared.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel that contains the pinned message.`,
      },
      {
        name: 'message_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel message to unpin.`,
      },
      {
        name: 'team_id',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel to update.`,
      },
      {
        name: 'team_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team that contains the channel to update.`,
      },
      {
        name: 'description',
        type: 'string',
        required: false,
        description: `New description for the channel. Optional. At least one of display_name or description must be provided.`,
      },
      {
        name: 'display_name',
        type: 'string',
        required: false,
        description: `New display name for the channel. Cannot contain special characters like #, &, :, <, >, *, ?. At least one of display_name or description must be provided.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Teams channel containing the message to update.`,
      },
      {
        name: 'content',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the channel message to update.`,
      },
      {
        name: 'team_id',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the online meeting to update. Obtain from the ID field returned when creating or listing meetings.`,
      },
      {
        name: 'allowed_presenters',
        type: 'string',
        required: false,
        description: `Updated setting for who can present in the meeting. Valid values: 'everyone', 'organization', 'roleIsPresenter', 'organizer'.`,
      },
      {
        name: 'end_date_time',
        type: 'string',
        required: false,
        description: `Updated end date and time for the meeting in ISO 8601 UTC format. Example: '2024-07-15T11:00:00Z'. Leave blank to keep the existing end time.`,
      },
      {
        name: 'start_date_time',
        type: 'string',
        required: false,
        description: `Updated start date and time for the meeting in ISO 8601 UTC format. Example: '2024-07-15T10:00:00Z'. Leave blank to keep the existing start time.`,
      },
      {
        name: 'subject',
        type: 'string',
        required: false,
        description: `Updated subject/title for the online meeting. Leave blank to keep the existing subject.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the shift to update. Obtain from the create shift response or list shifts API.`,
      },
      {
        name: 'team_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team whose schedule contains the shift.`,
      },
      {
        name: 'display_name',
        type: 'string',
        required: false,
        description: `Updated display name for the shift shown on the schedule. Leave blank to keep the existing display name.`,
      },
      {
        name: 'end_date_time',
        type: 'string',
        required: false,
        description: `Updated end date and time for the shift in ISO 8601 UTC format. Example: '2024-07-15T18:00:00Z'. Leave blank to keep the existing end time.`,
      },
      {
        name: 'notes',
        type: 'string',
        required: false,
        description: `Updated notes for the shift visible to the assigned employee. Leave blank to keep the existing notes.`,
      },
      {
        name: 'scheduling_group_id',
        type: 'string',
        required: false,
        description: `Updated scheduling group ID for the shift. Leave blank to keep the existing scheduling group.`,
      },
      {
        name: 'start_date_time',
        type: 'string',
        required: false,
        description: `Updated start date and time for the shift in ISO 8601 UTC format. Example: '2024-07-15T10:00:00Z'. Leave blank to keep the existing start time.`,
      },
      {
        name: 'theme',
        type: 'string',
        required: false,
        description: `Updated color theme for the shift block on the schedule view. Valid values: white, blue, green, purple, pink, yellow, gray, darkBlue, darkGreen, darkPurple, darkPink, darkYellow.`,
      },
      {
        name: 'user_id',
        type: 'string',
        required: false,
        description: `Updated user ID (Azure AD object ID) to reassign the shift to. Leave blank to keep the existing assignment.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team to update.`,
      },
      {
        name: 'description',
        type: 'string',
        required: false,
        description: `New description for the team (plain text, up to 1024 characters).`,
      },
      {
        name: 'display_name',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Visibility of the team. Valid values: 'public' (anyone in org can join), 'private' (owner must invite). Note: changing from private to public is allowed; changing back may be restricted.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The conversationMember ID of the membership to update. This is the unique ID of the member's team membership returned by the list team members or add member APIs — it is NOT the Azure AD user ID.`,
      },
      {
        name: 'role',
        type: 'string',
        required: true,
        description: `The new role to assign to the team member. Valid values: 'member' (standard member) or 'owner' (team owner with admin privileges).`,
      },
      {
        name: 'team_id',
        type: 'string',
        required: true,
        description: `The unique identifier of the Microsoft Teams team containing the member to update.`,
      },
    ],
  },
  {
  ...
  {
    name: 'microsoft365_outlook_create_shared_calendar_event',
    description: `Create a calendar event on another user's calendar (shared or delegated access). Targets POST /users/{id}/events. Requires Calendars.ReadWrite application permission or delegated access granted by the target user.`,
    params: [
      {
        name: 'user_id',
        type: 'string',
        required: true,
        description: `User ID or userPrincipalName (email) of the target user whose calendar to write to (e.g., colleague@company.com).`,
      },
      { name: 'subject', type: 'string', required: true, description: `Event subject / title.` },
      {
        name: 'start_datetime',
        type: 'string',
        required: true,
        description: `Start date and time in ISO 8601 format (e.g., 2024-09-15T10:00:00).`,
      },
      {
        name: 'start_timezone',
        type: 'string',
        required: true,
        description: `IANA timezone for the start time (e.g., America/New_York).`,
      },
      {
        name: 'end_datetime',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `IANA timezone for the end time.`,
      },
      {
        name: 'body_content',
        type: 'string',
      ...
      },
      {
        ...
        type: 'boolean',
        required: false,
        description: `Whether to create a Teams online meeting.`,
      },
      {
        name: 'isAllDay',
        type: 'boolean',
  ...
  {
    name: 'microsoft365_outlook_update_shared_calendar_event',
    description: `Update an existing event on another user's calendar (shared or delegated access). Targets PATCH /users/{id}/events/{event_id}. Requires Calendars.ReadWrite application permission or delegated access granted by the target user.`,
    params: [
      {
        name: 'user_id',
        type: 'string',
        required: true,
        description: `User ID or userPrincipalName (email) of the target user whose calendar to update (e.g., colleague@company.com).`,
      },
      {
        name: 'event_id',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `IANA timezone for the updated start time.`,
      },
      {
        name: 'end_datetime',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `IANA timezone for the updated end time.`,
      },
      {
        name: 'body_content',
        type: 'string',
        required: false,
        description: `Updated event body/description text.`,
      },
      {
        name: 'body_contentType',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Updated event location display name.`,
      },
    ],
  },
  {
    name: 'microsoft365_outlook_get_shared_mailbox_message',
    description: `Get a single message from a shared mailbox by message ID. Targets GET /users/{id}/messages/{message_id}. Requires Mail.Read or Mail.ReadWrite permission on the shared mailbox.`,
    params: [
      {
        name: 'shared_mailbox_id',
        type: 'string',
        required: true,
        description: `Email address or user ID of the shared mailbox (e.g., support@company.com).`,
      },
      {
        name: 'message_id',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Comma-separated list of message properties to return (e.g., subject,from,receivedDateTime,body).`,
      },
    ],
  },
  {
    name: 'microsoft365_outlook_list_shared_contacts',
    description: `List contacts from another user's default contacts folder (a colleague's contacts). Targets GET /users/{id}/contacts. Requires Contacts.Read application permission or delegated access granted by the target user.`,
    params: [
      {
        name: 'user_id',
        type: 'string',
        required: true,
        description: `User ID or userPrincipalName (email) of the target user whose contacts to list (e.g., colleague@company.com).`,
      },
      {
        name: '$filter',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `OData orderby expression (e.g., "displayName asc").`,
      },
      {
        name: '$select',
        type: 'string',
        required: false,
        description: `Comma-separated contact properties to return (e.g., displayName,emailAddresses,mobilePhone).`,
      },
      {
        name: '$top',
        type: 'integer',
  ...
  {
    name: 'microsoft365_outlook_get_shared_contact',
    description: `Get a single contact from another user's contacts by contact ID. Targets GET /users/{id}/contacts/{contact_id}. Requires Contacts.Read application permission or delegated access granted by the target user.`,
    params: [
      {
        name: 'user_id',
        type: 'string',
        required: true,
        description: `User ID or userPrincipalName (email) of the target user whose contact to retrieve (e.g., colleague@company.com).`,
      },
      {
        name: 'contact_id',
        type: 'string',
  ...
  {
    name: 'microsoft365_outlook_list_shared_todo_lists',
    description: `List Microsoft To Do task lists belonging to another user (a colleague). Targets GET /users/{id}/todo/lists. Requires Tasks.Read application permission or delegated access granted by the target user.`,
    params: [
      {
        name: 'user_id',
        type: 'string',
        required: true,
        description: `User ID or userPrincipalName (email) of the target user whose To Do lists to retrieve (e.g., colleague@company.com).`,
      },
    ],
  },
  {
    name: 'microsoft365_outlook_list_shared_todo_tasks',
    description: `List tasks in a Microsoft To Do list belonging to another user (a colleague). Targets GET /users/{id}/todo/lists/{list_id}/tasks. Requires Tasks.Read application permission or delegated access granted by the target user.`,
    params: [
      {
        name: 'user_id',
        type: 'string',
        required: true,
        description: `User ID or userPrincipalName (email) of the target user whose tasks to list (e.g., colleague@company.com).`,
      },
      {
        name: 'list_id',
        type: 'string',
        required: true,
        description: `The ID of the To Do task list to retrieve tasks from.`,
      },
      {
        name: '$filter',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `OData orderby expression (e.g., "dueDateTime/dateTime asc").`,
      },
      {
        name: '$top',
        type: 'integer',
