...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'event_types', type: 'array', required: true, description: `List of event types to subscribe to, e.g. profile.updated, follows, spaces` },
      { name: 'user_id', type: 'string', required: true, description: `Twitter user ID to subscribe to activities for` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Authenticated user's Twitter ID — must match the authenticated user` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'max_results', type: 'integer', required: false, description: `Max results per page (1-1000)` },
      { name: 'pagination_token', type: 'string', required: false, description: `Pagination token for next page` },
      { name: 'user_fields', type: 'string', required: false, description: `Comma-separated user fields` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Authenticated user's Twitter ID` },
      { name: 'tweet_id', type: 'string', required: true, description: `ID of the Tweet to bookmark` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Authenticated user's Twitter ID` },
      { name: 'tweet_id', type: 'string', required: true, description: `ID of the bookmarked tweet to remove` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Authenticated user's Twitter ID` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'max_results', type: 'integer', required: false, description: `Max results per page (1-100)` },
      { name: 'pagination_token', type: 'string', required: false, description: `Pagination token for next page` },
      { name: 'tweet_fields', type: 'string', required: false, description: `Comma-separated tweet fields` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'resumable', type: 'boolean', required: false, description: `Whether the job should be resumable` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Compliance job ID` },
    ],
  },
  {
    ...
    params: [
      { name: 'type', type: 'string', required: true, description: `Type of compliance jobs to list` },
  ...
  },
  {
    ...
    params: [
      { name: 'participant_id', type: 'string', required: true, description: `User ID of the DM conversation participant` },
      { name: 'dm_event_fields', type: 'string', required: false, description: `Comma-separated DM event fields` },
      { name: 'event_types', type: 'string', required: false, description: `Filter by event types` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'max_results', type: 'integer', required: false, description: `Max results per page (1-100)` },
      { name: 'pagination_token', type: 'string', required: false, description: `Pagination token for next page` },
    ],
  },
  {
    ...
    params: [
      { name: 'dm_conversation_id', type: 'string', required: true, description: `DM conversation ID` },
      { name: 'dm_event_fields', type: 'string', required: false, description: `Comma-separated DM event fields` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'max_results', type: 'integer', required: false, description: `Max results per page (1-100)` },
      { name: 'pagination_token', type: 'string', required: false, description: `Pagination token for next page` },
  ...
  },
  {
    ...
    params: [
      { name: 'dm_conversation_id', type: 'string', required: true, description: `DM conversation ID to send the message to` },
      { name: 'media_id', type: 'string', required: false, description: `Pre-uploaded media ID to attach` },
  ...
  },
  {
    ...
    params: [
      { name: 'event_id', type: 'string', required: true, description: `ID of the DM event to delete` },
      { name: 'participant_id', type: 'string', required: true, description: `User ID of the DM conversation participant` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'participant_ids', type: 'array', required: true, description: `List of Twitter user IDs to include` },
      { name: 'message_media_ids', type: 'array', required: false, description: `Media IDs to attach to initial message` },
    ],
  },
  {
    ...
    params: [
      { name: 'participant_id', type: 'string', required: true, description: `Twitter user ID of the DM recipient` },
      { name: 'media_id', type: 'string', required: false, description: `Pre-uploaded media ID to attach` },
      { name: 'text', type: 'string', required: false, description: `Message text` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Twitter user ID to get followers for` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'max_results', type: 'integer', required: false, description: `Max results per page (1-1000)` },
      { name: 'pagination_token', type: 'string', required: false, description: `Pagination token for next page` },
      { name: 'user_fields', type: 'string', required: false, description: `Comma-separated user fields` },
  ...
  },
  {
    ...
    params: [
      { name: 'query', type: 'string', required: true, description: `Search query using X search syntax` },
      { name: 'end_time', type: 'string', required: false, description: `ISO 8601 end time` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'max_results', type: 'integer', required: false, description: `Max results per page (10-500)` },
      ...
      { name: 'start_time', type: 'string', required: false, description: `ISO 8601 start time e.g. 2021-01-01T00:00:00Z` },
      { name: 'tweet_fields', type: 'string', required: false, description: `Comma-separated tweet fields` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'end_time', type: 'string', required: false, description: `ISO 8601 end time` },
      { name: 'granularity', type: 'string', required: false, description: `Aggregation granularity` },
      { name: 'next_token', type: 'string', required: false, description: `Next page token` },
      { name: 'since_id', type: 'string', required: false, description: `Minimum tweet ID` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'private', type: 'boolean', required: false, description: `Whether the list should be private` },
    ],
  },
  {
    ...
    params: [
      { name: 'list_id', type: 'string', required: true, description: `ID of the Twitter List to delete` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Twitter List ID` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'list_fields', type: 'string', required: false, description: `Comma-separated list fields` },
      { name: 'user_fields', type: 'string', required: false, description: `Comma-separated user fields` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Twitter List ID` },
      { name: 'user_id', type: 'string', required: true, description: `ID of the user to remove from the list` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Authenticated user's Twitter ID` },
      { name: 'list_id', type: 'string', required: true, description: `ID of the list to unfollow` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'private', type: 'boolean', required: false, description: `Set to true to make private, false for public` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'media_type', type: 'string', required: true, description: `MIME type, e.g. image/jpeg or image/png` },
      { name: 'media_category', type: 'string', required: false, description: `Media category for use context` },
    ],
  },
  {
    ...
    params: [
      { name: 'media_data', type: 'string', required: true, description: `Base64-encoded chunk data` },
      { name: 'media_id', type: 'string', required: true, description: `Media ID from the INIT step` },
      { name: 'segment_index', type: 'integer', required: true, description: `Zero-based index of the chunk segment` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'media_type', type: 'string', required: true, description: `MIME type, e.g. image/jpeg` },
      { name: 'media_category', type: 'string', required: false, description: `Media category for use context` },
    ],
  },
  {
    ...
    params: [
      { name: 'media_type', type: 'string', required: true, description: `MIME type, e.g. video/mp4 or image/gif` },
      { name: 'total_bytes', type: 'integer', required: true, description: `Total size of the media file in bytes` },
      { name: 'additional_owners', type: 'string', required: false, description: `Comma-separated user IDs to also own the media` },
      { name: 'media_category', type: 'string', required: false, description: `Media category for use context` },
    ],
  },
  {
    ...
    params: [
      { name: 'media_data', type: 'string', required: true, description: `Base64-encoded media file data` },
      { name: 'media_type', type: 'string', required: true, description: `MIME type, e.g. video/mp4 or image/gif` },
      { name: 'total_bytes', type: 'integer', required: true, description: `Total size of the file in bytes` },
      { name: 'additional_owners', type: 'string', required: false, description: `Comma-separated user IDs to also own the media` },
      { name: 'media_category', type: 'string', required: false, description: `Media category for use context` },
    ],
  },
  {
    ...
    params: [
      { name: 'media_id', type: 'string', required: true, description: `Media ID from the upload INIT step` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'tweet_ids', type: 'string', required: true, description: `Comma-separated list of Tweet IDs` },
    ],
  },
  {
    ...
    params: [
      { name: 'geo_place_id', type: 'string', required: false, description: `Place ID for geo tag` },
      { name: 'media_media_ids', type: 'array', required: false, description: `Media IDs to attach` },
      { name: 'poll_duration_minutes', type: 'integer', required: false, description: `Duration of poll in minutes` },
      { name: 'poll_options', type: 'array', required: false, description: `Up to 4 poll options` },
      { name: 'quote_tweet_id', type: 'string', required: false, description: `ID of the tweet to quote` },
      { name: 'reply_in_reply_to_tweet_id', type: 'string', required: false, description: `ID of the tweet to reply to` },
  ...
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Tweet ID` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'media_fields', type: 'string', required: false, description: `Comma-separated media fields` },
      { name: 'tweet_fields', type: 'string', required: false, description: `Comma-separated tweet fields` },
      { name: 'user_fields', type: 'string', required: false, description: `Comma-separated user fields` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Authenticated user's Twitter ID` },
      { name: 'tweet_id', type: 'string', required: true, description: `ID of the Tweet to retweet` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Authenticated user's Twitter ID` },
      { name: 'tweet_id', type: 'string', required: true, description: `ID of the Tweet to unlike` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Authenticated user's Twitter ID` },
      { name: 'source_tweet_id', type: 'string', required: true, description: `ID of the Tweet to unretweet` },
    ],
  },
  {
    ...
    params: [
      { name: 'ids', type: 'string', required: true, description: `Comma-separated list of Tweet IDs (up to 100)` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'media_fields', type: 'string', required: false, description: `Comma-separated media fields` },
      { name: 'tweet_fields', type: 'string', required: false, description: `Comma-separated tweet fields` },
      { name: 'user_fields', type: 'string', required: false, description: `Comma-separated user fields` },
  ...
  },
  {
    ...
    params: [
      { name: 'query', type: 'string', required: true, description: `Search query using X search syntax, e.g. from:username -is:retweet` },
      { name: 'end_time', type: 'string', required: false, description: `ISO 8601 end time` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'max_results', type: 'integer', required: false, description: `Max results per page (10-100)` },
      { name: 'media_fields', type: 'string', required: false, description: `Comma-separated media fields` },
      { name: 'next_token', type: 'string', required: false, description: `Next page token` },
      { name: 'since_id', type: 'string', required: false, description: `Minimum tweet ID` },
      { name: 'start_time', type: 'string', required: false, description: `ISO 8601 start time` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'tweet_id', type: 'string', required: true, description: `ID of the reply tweet to hide or unhide` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'space_fields', type: 'string', required: false, description: `Comma-separated space fields` },
      { name: 'user_fields', type: 'string', required: false, description: `Comma-separated user fields` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'user_ids', type: 'string', required: true, description: `Comma-separated list of user IDs to get spaces for` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'space_fields', type: 'string', required: false, description: `Comma-separated space fields` },
      { name: 'user_fields', type: 'string', required: false, description: `Comma-separated user fields` },
    ],
  },
  {
    ...
    params: [
      { name: 'ids', type: 'string', required: true, description: `Comma-separated list of Space IDs` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'space_fields', type: 'string', required: false, description: `Comma-separated space fields` },
      { name: 'user_fields', type: 'string', required: false, description: `Comma-separated user fields` },
    ],
  },
  {
    ...
    params: [
      { name: 'query', type: 'string', required: true, description: `Text to search for in Space titles` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'max_results', type: 'integer', required: false, description: `Max results per page (1-100)` },
      { name: 'space_fields', type: 'string', required: false, description: `Comma-separated space fields` },
  ...
  },
  {
    ...
    params: [
      { name: 'backfill_minutes', type: 'integer', required: false, description: `Minutes of backfill to stream on reconnect (0-5)` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'tweet_fields', type: 'string', required: false, description: `Comma-separated tweet fields` },
    ],
  },
  {
    ...
    params: [
      { name: 'days', type: 'integer', required: false, description: `Number of days to retrieve usage data for, default 7` },
      { name: 'usage_fields', type: 'string', required: false, description: `Comma-separated usage fields to include` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Authenticated user's Twitter ID` },
      { name: 'target_user_id', type: 'string', required: true, description: `ID of the user to follow` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Twitter user ID` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'max_results', type: 'integer', required: false, description: `Max results per page (5-100)` },
      { name: 'pagination_token', type: 'string', required: false, description: `Pagination token for next page` },
      { name: 'tweet_fields', type: 'string', required: false, description: `Comma-separated tweet fields` },
      { name: 'user_fields', type: 'string', required: false, description: `Comma-separated user fields` },
    ],
  ...
  },
  {
    ...
    params: [
      { name: 'username', type: 'string', required: true, description: `Twitter username without the @ symbol, e.g. elonmusk` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'tweet_fields', type: 'string', required: false, description: `Comma-separated tweet fields` },
      { name: 'user_fields', type: 'string', required: false, description: `Comma-separated user fields` },
    ],
  },
  {
    ...
    params: [
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'tweet_fields', type: 'string', required: false, description: `Comma-separated tweet fields` },
      { name: 'user_fields', type: 'string', required: false, description: `Comma-separated user fields to return, e.g. created_at,description,public_metrics` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Authenticated user's Twitter ID` },
      { name: 'target_user_id', type: 'string', required: true, description: `ID of the user to mute` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Authenticated user's own numeric Twitter ID — must be your own ID` },
      { name: 'exclude', type: 'string', required: false, description: `Comma-separated types to exclude: retweets,replies` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'max_results', type: 'integer', required: false, description: `Max results per page (1-100)` },
      { name: 'pagination_token', type: 'string', required: false, description: `Pagination token for next page` },
      { name: 'tweet_fields', type: 'string', required: false, description: `Comma-separated tweet fields` },
  ...
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Authenticated user's Twitter ID` },
      { name: 'target_user_id', type: 'string', required: true, description: `ID of the user to unfollow` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `Authenticated user's Twitter ID` },
      { name: 'target_user_id', type: 'string', required: true, description: `ID of the user to unmute` },
    ],
  },
  {
    ...
    params: [
      { name: 'ids', type: 'string', required: true, description: `Comma-separated list of Twitter user IDs (up to 100)` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'tweet_fields', type: 'string', required: false, description: `Comma-separated tweet fields` },
      { name: 'user_fields', type: 'string', required: false, description: `Comma-separated user fields` },
    ],
  },
  {
    ...
    params: [
      { name: 'usernames', type: 'string', required: true, description: `Comma-separated list of Twitter usernames without @ symbols (up to 100)` },
      { name: 'expansions', type: 'string', required: false, description: `Comma-separated expansions` },
      { name: 'tweet_fields', type: 'string', required: false, description: `Comma-separated tweet fields` },
      { name: 'user_fields', type: 'string', required: false, description: `Comma-separated user fields` },
    ],
