...
export const tools: Tool[] = [
  {
    ...
    description: `Send up to 500 marketing emails in a single bulk API call through the Email Marketing stream.`,
    params: [
      {
        name: 'emails_json',
        type: 'string',
        required: true,
        description: `A JSON array string containing up to 500 email objects. Each object must include from, to, subject, and at least one of text or html.`,
      },
    ],
  },
  {
    name: 'mailtrap_batch_send_email',
    description: `Send up to 500 transactional emails in a single API call. Each email in the batch can have different recipients, subjects, and bodies.`,
    params: [
      {
        name: 'emails_json',
        type: 'string',
        required: true,
        description: `JSON array of email objects to send in this batch. Each object follows the same structure as the Send Email endpoint: from, to, subject, text, html, etc.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'name', type: 'string', required: true, description: `Name for the new API token.` },
      {
        ...
        type: 'string',
        required: false,
        description: `Optional JSON array string of permission objects to attach to the token at creation time.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Sending domain this suppression applies to.`,
      },
      {
        name: 'email',
        type: 'string',
  ...
  },
  {
    ...
    description: `Send a marketing or newsletter email through the Mailtrap bulk (Email Marketing) stream.`,
    params: [
      {
        name: 'from_email',
        type: 'string',
        required: true,
        description: `Sender email address. Must be a verified domain in your Mailtrap account.`,
      },
      { name: 'to_email', type: 'string', required: true, description: `Recipient email address.` },
      {
        name: 'category',
        type: 'string',
        required: false,
        description: `Category label for tracking and filtering bulk emails.`,
      },
      {
        name: 'from_name',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `HTML body of the bulk email.`,
      },
      {
        name: 'subject',
        type: 'string',
        required: false,
        description: `Subject line of the bulk email.`,
      },
      {
        name: 'text',
        type: 'string',
        required: false,
        description: `Plain text body of the bulk email.`,
      },
      {
        name: 'to_name',
        type: 'string',
  ...
  },
  {
    ...
    description: `Send a transactional email via Mailtrap. Supports plain text, HTML, and template-based sending with attachments.`,
    params: [
      {
        name: 'from_email',
        type: 'string',
      ...
      { name: 'bcc', type: 'string', required: false, description: `BCC recipient email address.` },
      {
        name: 'category',
        type: 'string',
        required: false,
        description: `Category label for tracking and filtering sent emails.`,
      },
      { name: 'cc', type: 'string', required: false, description: `CC recipient email address.` },
      {
        name: 'from_name',
        type: 'string',
        required: false,
      ...
      { name: 'html', type: 'string', required: false, description: `HTML body of the email.` },
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `UUID of a Mailtrap email template to use for this message.`,
      },
      {
        name: 'template_variables',
        type: 'string',
        required: false,
        description: `JSON object string of variables to inject into the template.`,
      },
      {
        name: 'text',
        type: 'string',
