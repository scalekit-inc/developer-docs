...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'entity_id', type: 'integer', required: true, description: `ID of the person or organization to add to the list` },
      { name: 'list_id', type: 'integer', required: true, description: `ID of the Affinity list to add the entity to` },
    ],
  },
  {
    ...
    params: [
      { name: 'content', type: 'string', required: true, description: `Plain text content of the note` },
      { name: 'opportunity_ids', type: 'array', required: false, description: `List of opportunity IDs to attach this note to` },
      { name: 'organization_ids', type: 'array', required: false, description: `List of organization IDs to attach this note to` },
      { name: 'person_ids', type: 'array', required: false, description: `List of person IDs to attach this note to` },
    ],
  },
  {
    ...
    params: [
      { name: 'list_id', type: 'integer', required: true, description: `ID of the Affinity list to add this opportunity to` },
      { name: 'name', type: 'string', required: true, description: `Name of the opportunity or deal` },
      { name: 'organization_ids', type: 'array', required: false, description: `List of Affinity organization IDs to associate with this opportunity` },
      { name: 'person_ids', type: 'array', required: false, description: `List of Affinity person IDs to associate with this opportunity` },
    ],
  },
  {
    ...
    params: [
      { name: 'opportunity_id', type: 'integer', required: true, description: `Unique numeric ID of the opportunity to retrieve` },
    ],
  },
  {
    ...
    params: [
      { name: 'organization_id', type: 'integer', required: true, description: `Unique numeric ID of the organization to retrieve` },
      { name: 'with_interaction_dates', type: 'boolean', required: false, description: `Include first and last interaction dates in the response` },
    ],
  },
  {
    ...
    params: [
      { name: 'person_id', type: 'integer', required: true, description: `Unique numeric ID of the person to retrieve` },
      { name: 'with_interaction_dates', type: 'boolean', required: false, description: `Include first and last interaction dates in the response` },
    ],
  },
  {
    ...
    params: [
      { name: 'external_id', type: 'integer', required: true, description: `Affinity person ID of the external contact to evaluate relationship strength against` },
      { name: 'internal_id', type: 'integer', required: false, description: `Affinity person ID of the internal team member (optional — omit to get scores for all team members)` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'opportunity_id', type: 'integer', required: false, description: `Filter notes by opportunity ID` },
      { name: 'organization_id', type: 'integer', required: false, description: `Filter notes by organization ID` },
      { name: 'page_size', type: 'integer', required: false, description: `Number of results to return per page (max 500)` },
      { name: 'page_token', type: 'string', required: false, description: `Pagination token from a previous response to fetch the next page` },
  ...
  },
  {
    ...
    params: [
      { name: 'list_id', type: 'integer', required: false, description: `Filter opportunities belonging to a specific Affinity list ID` },
      { name: 'page_size', type: 'integer', required: false, description: `Number of results to return per page (max 500)` },
      { name: 'page_token', type: 'string', required: false, description: `Pagination token from a previous response to fetch the next page` },
    ],
  },
  {
    ...
    params: [
      { name: 'page_size', type: 'integer', required: false, description: `Number of results to return per page (max 500)` },
      { name: 'page_token', type: 'string', required: false, description: `Pagination token from a previous response to fetch the next page` },
      { name: 'term', type: 'string', required: false, description: `Search term to filter organizations by name or domain` },
      { name: 'with_interaction_dates', type: 'boolean', required: false, description: `Include first and last interaction dates in the response` },
    ],
  },
  {
    ...
    params: [
      { name: 'page_size', type: 'integer', required: false, description: `Number of results to return per page (max 500)` },
      { name: 'page_token', type: 'string', required: false, description: `Pagination token from a previous response to fetch the next page` },
      { name: 'term', type: 'string', required: false, description: `Search term to filter persons by name or email address` },
      { name: 'with_interaction_dates', type: 'boolean', required: false, description: `Include first and last interaction dates in the response` },
    ],
  },
  {
    ...
    params: [
      { name: 'opportunity_id', type: 'integer', required: true, description: `Unique numeric ID of the opportunity to update` },
      { name: 'name', type: 'string', required: false, description: `Updated name for the opportunity` },
      { name: 'organization_ids', type: 'array', required: false, description: `Updated list of Affinity organization IDs associated with this opportunity` },
      { name: 'person_ids', type: 'array', required: false, description: `Updated list of Affinity person IDs associated with this opportunity` },
    ],
  },
]
