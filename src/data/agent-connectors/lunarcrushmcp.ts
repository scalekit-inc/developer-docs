    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `Optional alternate API key to use for this request.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Social network to filter by.`,
      },
      {
        name: 'screenName',
        type: 'string',
        required: true,
        description: `Screen name or unique ID of the social media account.`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Start date for the date range (YYYY-MM-DD). Use with to_date instead of interval.`,
      },
      {
        name: 'interval',
        type: 'string',
        required: false,
        description: `Time window for the data. Defaults to 1w (hourly). Use 1m or longer for daily data.`,
      },
      {
        name: 'limit',
        type: 'number',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `End date for the date range (YYYY-MM-DD). Leave blank to get posts up to now.`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'array',
        required: false,
        description: `One or more metrics to include. Leave blank to return all metrics.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `URL-friendly path to the LunarCrush context (e.g. /topic/bitcoin or /creator/x/elonmusk).`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Keyword or phrase to search. Use lowercase a-z, 0-9, #, $, _ and spaces only.`,
      },
      {
        name: 'from_date',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `Filter topics by category. Leave blank for all categories.`,
      },
      {
        name: 'limit',
        type: 'number',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Search query or phrase to find matching topics, creators, or assets.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Topic slug (lowercase a-z, 0-9, #, $, _ and spaces). Example: bitcoin.`,
      },
    ],
  },
  {
