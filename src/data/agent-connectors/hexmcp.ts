...
export const tools: Tool[] = [
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `The message to add to continue the thread`,
      },
    ],
  },
  {
    ...
    params: [{ name: 'prompt', type: 'string', required: true, description: `No description.` }],
  },
  {
    name: 'hexmcp_get_me',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The search query to find relevant projects. This should be a non-empty string without wildcards.`,
      },
    ],
  },
]
