...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'application_id', type: 'string', required: true, description: `The ID of the application to retrieve entitlements for.` },
      { name: 'exclude_deleted', type: 'boolean', required: false, description: `Whether to exclude deleted entitlements.` },
      { name: 'exclude_ended', type: 'boolean', required: false, description: `Whether to exclude ended entitlements.` },
      { name: 'limit', type: 'integer', required: false, description: `Maximum number of entitlements to return (1–100).` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'template_code', type: 'string', required: true, description: `The unique code of the guild template.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'guild_id', type: 'string', required: true, description: `The ID of the Discord guild (server) to retrieve the widget image for.` },
  ...
  },
  {
    ...
    params: [
      { name: 'invite_code', type: 'string', required: true, description: `The unique invite code to look up.` },
      { name: 'with_counts', type: 'boolean', required: false, description: `Whether to include approximate member and presence counts.` },
      { name: 'with_expiration', type: 'boolean', required: false, description: `Whether to include the expiration date of the invite.` },
    ],
  },
  {
    ...
    params: [
      { name: 'guild_id', type: 'string', required: true, description: `The ID of the guild to retrieve the current user's member object from.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'after', type: 'string', required: false, description: `Get guilds after this guild ID (for pagination).` },
      { name: 'before', type: 'string', required: false, description: `Get guilds before this guild ID (for pagination).` },
      { name: 'limit', type: 'integer', required: false, description: `Maximum number of guilds to return (1–200, default 200).` },
      { name: 'with_counts', type: 'boolean', required: false, description: `Whether to include approximate member and presence counts for each guild.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'invite_code', type: 'string', required: true, description: `The unique invite code to resolve.` },
      { name: 'guild_scheduled_event_id', type: 'string', required: false, description: `Guild scheduled event ID to include event details in the response.` },
      { name: 'with_counts', type: 'boolean', required: false, description: `Whether to include approximate member and presence counts.` },
      { name: 'with_expiration', type: 'boolean', required: false, description: `Whether to include the expiration date of the invite.` },
    ],
  },
