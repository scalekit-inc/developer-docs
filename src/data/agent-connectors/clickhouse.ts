...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'clickPipeId', type: 'string', required: true, description: `ID of the requested ClickPipe` },
      { name: 'organizationId', type: 'string', required: true, description: `ID of the organization that owns the service` },
      { name: 'serviceId', type: 'string', required: true, description: `ID of the service that owns the ClickPipe` },
    ],
  },
  {
    ...
    params: [
      { name: 'organizationId', type: 'string', required: true, description: `The unique identifier of the organization` },
      { name: 'from_date', type: 'string', required: false, description: `Start date for the report, e.g. 2024-12-19 (YYYY-MM-DD)` },
      { name: 'to_date', type: 'string', required: false, description: `End date (inclusive) for the report, e.g. 2024-12-20 (YYYY-MM-DD). Cannot be more than 30 days after from_date.` },
    ],
  },
  {
    ...
    params: [
      { name: 'organizationId', type: 'string', required: true, description: `ID of the organization to retrieve` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'organizationId', type: 'string', required: true, description: `ID of the organization` },
      { name: 'serviceId', type: 'string', required: true, description: `ID of the service to retrieve` },
    ],
  },
  {
    ...
    params: [
      { name: 'organizationId', type: 'string', required: true, description: `ID of the organization whose services are to be listed` },
    ],
  },
  {
    ...
    params: [
      { name: 'organizationId', type: 'string', required: true, description: `ID of the organization` },
      { name: 'serviceId', type: 'string', required: true, description: `ID of the service to list ClickPipes for` },
    ],
  },
  {
    ...
    params: [
      { name: 'serviceId', type: 'string', required: true, description: `No description.` },
    ],
  },
  {
    ...
    params: [
      { name: 'organizationId', type: 'string', required: true, description: `ID of the organization` },
      { name: 'serviceId', type: 'string', required: true, description: `ID of the service to list backups for` },
    ],
  },
  {
    ...
    params: [
      { name: 'database', type: 'string', required: true, description: `Name of the database to list tables from` },
      { name: 'serviceId', type: 'string', required: true, description: `The unique identifier of the ClickHouse service` },
      { name: 'like', type: 'string', required: false, description: `Optional SQL LIKE pattern to filter tables by name (e.g., "events_%")` },
      { name: 'notLike', type: 'string', required: false, description: `Optional SQL LIKE pattern to exclude tables by name` },
    ],
  },
  {
    ...
    params: [
      { name: 'query', type: 'string', required: true, description: `A valid ClickHouse SELECT query. Only read-only SELECT statements are permitted. e.g. SELECT * FROM my_table LIMIT 10` },
      { name: 'serviceId', type: 'string', required: true, description: `The unique identifier of the ClickHouse service` },
      { name: 'timeoutSeconds', type: 'integer', required: false, description: `Query timeout in seconds. Default: 300 (5 min), max: 3600 (1 hour). Use lower values for simple queries.` },
    ],
  },
]
