...
export const tools: Tool[] = [
  {
    name: 'dartai_add_task_attachment_from_url',
    description: `Attach a file from a provided URL to a task.`,
    params: [
      { name: 'taskDuid', type: 'string', required: true, description: `The ID of the task.` },
      {
        name: 'url',
        type: 'string',
        required: true,
  ...
  {
    name: 'dartai_add_task_time_tracking',
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `When the time tracking started.`,
      },
    ],
  },
  {
    name: 'dartai_create_agent',
  ...
  {
    name: 'dartai_get_dartboard',
    description: `Retrieve an existing dartboard.`,
    params: [
      { name: 'duid', type: 'string', required: true, description: `The ID of the dartboard.` },
      {
        name: 'conversation_id',
        type: 'string',
        required: false,
  ...
  {
    name: 'dartai_get_folder',
    description: `Retrieve an existing folder by its ID.`,
    params: [
      { name: 'duid', type: 'string', required: true, description: `The ID of the folder.` },
      {
        name: 'conversation_id',
        type: 'string',
        required: false,
  ...
  {
    name: 'dartai_get_view',
    description: `Retrieve an existing view by its ID.`,
    params: [
      { name: 'duid', type: 'string', required: true, description: `The ID of the view.` },
      {
        name: 'conversation_id',
        type: 'string',
        required: false,
  ...
  {
    name: 'dartai_list_help_center_articles',
  ...
  {
    name: 'dartai_move_task',
    description: `Move a task to a specific position within results.`,
    params: [
      { name: 'duid', type: 'string', required: true, description: `The ID of the task to move.` },
      {
        name: 'conversation_id',
        type: 'string',
        required: false,
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `The target dartboard ID.`,
      },
      { name: 'order', type: 'number', required: false, description: `The order/position value.` },
      {
        name: 'reason_for_invocation',
        type: 'string',
        required: false,
  ...
  {
    name: 'dartai_report_issue',
    description: `Create a concise markdown issue report for Dart Support.`,
    params: [
      {
        name: 'description',
        type: 'string',
  ...
  {
    name: 'dartai_retrieve_skill_by_title',
  ...
  {
    name: 'dartai_update_doc',
    description: `Update certain properties of an existing doc.`,
    params: [
      { name: 'duid', type: 'string', required: true, description: `The ID of the doc to update.` },
      {
        name: 'conversation_id',
        type: 'string',
        required: false,
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Updated dartboard ID to move the doc to.`,
      },
      {
        name: 'item_title',
        type: 'string',
        required: false,
        description: `Updated title for the doc.`,
      },
      {
        name: 'reason_for_invocation',
        type: 'string',
  ...
  {
    name: 'dartai_update_task_description',
