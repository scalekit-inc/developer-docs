...
export const tools: Tool[] = [
  {
    ...
    params: [
      ...
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'target_hash', type: 'string', required: true, description: `The commit hash to create the branch from.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'kind', type: 'string', required: true, description: `Restriction type: require_tasks_to_be_completed, require_approvals_to_merge, require_default_reviewer_approvals_to_merge, require_no_changes_requested, require_commits_behind, require_passing_builds_to_merge, reset_pullrequest_approvals_on_change, push, restrict_merges, force, delete, enforce_merge_checks.` },
      { name: 'pattern', type: 'string', required: true, description: `Branch name or glob pattern to restrict, e.g. 'main' or 'release/*'.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'groups', type: 'string', required: false, description: `List of group slugs to exempt from the restriction.` },
      { name: 'users', type: 'string', required: false, description: `List of user account IDs to exempt from the restriction.` },
      { name: 'value', type: 'string', required: false, description: `Numeric value for count-based restrictions (e.g. required approvals).` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `The numeric ID of the branch restriction.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `The numeric ID of the branch restriction.` },
      { name: 'kind', type: 'string', required: true, description: `Restriction type (see Create Branch Restriction for valid values).` },
      { name: 'pattern', type: 'string', required: true, description: `Branch name or glob pattern.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'value', type: 'string', required: false, description: `Numeric value for count-based restrictions.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'q', type: 'string', required: false, description: `Query to filter branches, e.g. name~"feature".` },
      { name: 'sort', type: 'string', required: false, description: `Sort field, e.g. -target.date for newest first.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'development_branch', type: 'string', required: false, description: `Name of the development branch.` },
      { name: 'production_branch', type: 'string', required: false, description: `Name of the production branch.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'commit', type: 'string', required: true, description: `The commit hash.` },
      { name: 'key', type: 'string', required: true, description: `Unique identifier for the build (e.g. CI pipeline name).` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'state', type: 'string', required: true, description: `Build state: SUCCESSFUL, FAILED, INPROGRESS, STOPPED.` },
      { name: 'url', type: 'string', required: true, description: `URL linking to the build result.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'description', type: 'string', required: false, description: `Description of the build result.` },
  ...
  },
  {
    ...
    params: [
      { name: 'commit', type: 'string', required: true, description: `The commit hash.` },
      { name: 'key', type: 'string', required: true, description: `Unique identifier for the build.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'commit', type: 'string', required: true, description: `The commit hash.` },
      { name: 'content', type: 'string', required: true, description: `The comment text (Markdown supported).` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'comment_id', type: 'string', required: true, description: `The numeric ID of the comment.` },
      { name: 'commit', type: 'string', required: true, description: `The commit hash.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  ...
  },
  {
    ...
    params: [
      { name: 'comment_id', type: 'string', required: true, description: `The numeric ID of the comment.` },
      { name: 'commit', type: 'string', required: true, description: `The commit hash.` },
      { name: 'content', type: 'string', required: true, description: `Updated comment text (Markdown supported).` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'branch', type: 'string', required: false, description: `Branch or tag name to list commits for.` },
    ],
  },
  {
    ...
    params: [
      { name: 'component_id', type: 'string', required: true, description: `The numeric ID of the component.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'username', type: 'string', required: true, description: `The user's account ID or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'label', type: 'string', required: true, description: `A human-readable label for the deploy key.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'key_id', type: 'integer', required: true, description: `The integer ID of the deploy key to delete.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'deployment_uuid', type: 'string', required: true, description: `The UUID of the deployment.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'environment_uuid', type: 'string', required: true, description: `The UUID of the environment.` },
      ...
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'secured', type: 'string', required: false, description: `Whether the variable is secret (masked in logs).` },
    ],
  },
  {
    ...
    params: [
      { name: 'environment_uuid', type: 'string', required: true, description: `The UUID of the environment.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'variable_uuid', type: 'string', required: true, description: `The UUID of the variable.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'variable_uuid', type: 'string', required: true, description: `The UUID of the variable.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'secured', type: 'string', required: false, description: `Whether the variable is secret.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'spec', type: 'string', required: true, description: `Diff spec in the form of 'hash1..hash2' or 'branch1..branch2'.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'path', type: 'string', required: false, description: `Limit diff to a specific file path.` },
    ],
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'spec', type: 'string', required: true, description: `Revision spec e.g. 'main..feature' or commit SHA.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'filename', type: 'string', required: true, description: `The filename of the download artifact.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'environment_type', type: 'string', required: true, description: `Type: Test, Staging, or Production.` },
  ...
  },
  {
    ...
    params: [
      { name: 'commit', type: 'string', required: true, description: `The commit hash or branch name.` },
      { name: 'path', type: 'string', required: true, description: `Path to the file in the repository.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'content', type: 'string', required: true, description: `The comment text (Markdown supported).` },
      { name: 'issue_id', type: 'integer', required: true, description: `The issue ID to comment on.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'comment_id', type: 'string', required: true, description: `The numeric ID of the comment.` },
      { name: 'content', type: 'string', required: true, description: `Updated comment text (Markdown).` },
      { name: 'issue_id', type: 'string', required: true, description: `The numeric issue ID.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'assignee_account_id', type: 'string', required: false, description: `Account ID of the assignee.` },
      { name: 'content', type: 'string', required: false, description: `Description/body of the issue (Markdown supported).` },
      { name: 'kind', type: 'string', required: false, description: `Issue kind: bug, enhancement, proposal, or task.` },
      { name: 'priority', type: 'string', required: false, description: `Priority: trivial, minor, major, critical, or blocker.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'content', type: 'string', required: false, description: `New content/body for the issue.` },
      { name: 'kind', type: 'string', required: false, description: `Issue kind: bug, enhancement, proposal, or task.` },
      { name: 'priority', type: 'string', required: false, description: `Priority: trivial, minor, major, critical, or blocker.` },
      { name: 'status', type: 'string', required: false, description: `Issue status: new, open, resolved, on hold, invalid, duplicate, or wontfix.` },
  ...
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'q', type: 'string', required: false, description: `Filter query, e.g. status="open" AND priority="major".` },
      { name: 'sort', type: 'string', required: false, description: `Sort field, e.g. -updated_on.` },
    ],
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'revspec', type: 'string', required: true, description: `Two commits separated by '..', e.g. 'abc123..def456'.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'milestone_id', type: 'string', required: true, description: `The numeric ID of the milestone.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'branch', type: 'string', required: true, description: `Branch to run the pipeline on.` },
      { name: 'cron_expression', type: 'string', required: true, description: `Cron schedule expression (e.g. '0 0 * * *' for daily midnight).` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'enabled', type: 'string', required: false, description: `Whether the schedule is active.` },
    ],
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'schedule_uuid', type: 'string', required: true, description: `The UUID of the schedule.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'schedule_uuid', type: 'string', required: true, description: `The UUID of the schedule.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'cron_expression', type: 'string', required: false, description: `Updated cron expression.` },
      { name: 'enabled', type: 'string', required: false, description: `Whether the schedule is active.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'pipeline_uuid', type: 'string', required: true, description: `The UUID of the pipeline.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'step_uuid', type: 'string', required: true, description: `The UUID of the pipeline step.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'pipeline_uuid', type: 'string', required: true, description: `The UUID of the pipeline to stop.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'branch', type: 'string', required: false, description: `Branch name to run the pipeline on.` },
      { name: 'commit_hash', type: 'string', required: false, description: `Specific commit hash to run the pipeline on.` },
      { name: 'pipeline_name', type: 'string', required: false, description: `Custom pipeline name defined in bitbucket-pipelines.yml.` },
      { name: 'variables', type: 'string', required: false, description: `JSON array of pipeline variables, e.g. [{"key":"ENV","value":"prod"}].` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'secured', type: 'boolean', required: false, description: `If true, the variable value is masked in logs.` },
    ],
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'variable_uuid', type: 'string', required: true, description: `The UUID of the pipeline variable to delete.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'variable_uuid', type: 'string', required: true, description: `The UUID of the pipeline variable to update.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'secured', type: 'boolean', required: false, description: `If true, the variable value is masked in logs.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'sort', type: 'string', required: false, description: `Sort field, e.g. -created_on for newest first.` },
    ],
  },
  {
    ...
    params: [
      { name: 'pull_request_id', type: 'string', required: true, description: `The numeric pull request ID.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'pull_request_id', type: 'integer', required: true, description: `The pull request ID to approve.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'content', type: 'string', required: true, description: `The comment text (Markdown supported).` },
      { name: 'pull_request_id', type: 'integer', required: true, description: `The pull request ID.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'comment_id', type: 'integer', required: true, description: `The comment ID to delete.` },
      { name: 'pull_request_id', type: 'integer', required: true, description: `The pull request ID.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'close_source_branch', type: 'boolean', required: false, description: `Whether to close the source branch after merge.` },
      { name: 'description', type: 'string', required: false, description: `Description of the pull request.` },
      { name: 'destination_branch', type: 'string', required: false, description: `Destination branch to merge into.` },
      { name: 'reviewers', type: 'string', required: false, description: `JSON array of reviewer account UUIDs, e.g. [{"uuid":"{account-uuid}"}].` },
    ],
  },
  {
    ...
    params: [
      { name: 'pull_request_id', type: 'integer', required: true, description: `The pull request ID to decline.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'dest_commit', type: 'string', required: true, description: `Destination commit hash from the pull request (destination.commit.hash).` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'source_commit', type: 'string', required: true, description: `Source commit hash from the pull request (source.commit.hash).` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'pull_request_id', type: 'string', required: false, description: `The numeric pull request ID.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'pull_request_id', type: 'integer', required: true, description: `The pull request ID to merge.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'close_source_branch', type: 'boolean', required: false, description: `Whether to close the source branch after merge.` },
      { name: 'merge_strategy', type: 'string', required: false, description: `Merge strategy: merge_commit, squash, or fast_forward.` },
      { name: 'message', type: 'string', required: false, description: `Custom commit message for the merge commit.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'pending', type: 'string', required: false, description: `Whether the task is pending (true) or resolved (false).` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'task_id', type: 'string', required: true, description: `The numeric task ID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'content', type: 'string', required: false, description: `Updated task description.` },
      { name: 'pending', type: 'string', required: false, description: `Set to false to resolve the task, true to reopen.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'pull_request_id', type: 'integer', required: true, description: `The pull request ID to unapprove.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'pull_request_id', type: 'integer', required: true, description: `The pull request ID to update.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'description', type: 'string', required: false, description: `New description for the pull request.` },
      { name: 'destination_branch', type: 'string', required: false, description: `New destination branch.` },
      { name: 'title', type: 'string', required: false, description: `New title for the pull request.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'sort', type: 'string', required: false, description: `Sort field for pull requests.` },
      { name: 'state', type: 'string', required: false, description: `Filter by state: OPEN, MERGED, DECLINED, SUPERSEDED.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'q', type: 'string', required: false, description: `Query to filter repositories, e.g. name~"my-repo".` },
      { name: 'sort', type: 'string', required: false, description: `Sort field, e.g. -updated_on for newest first.` },
    ],
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The slug for the new repository.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'description', type: 'string', required: false, description: `A description for the repository.` },
      { name: 'has_issues', type: 'boolean', required: false, description: `Enable the issue tracker for this repository.` },
      { name: 'has_wiki', type: 'boolean', required: false, description: `Enable the wiki for this repository.` },
      { name: 'is_private', type: 'boolean', required: false, description: `Whether the repository is private. Default is true.` },
      { name: 'project_key', type: 'string', required: false, description: `Key of the project to associate the repository with.` },
      { name: 'scm', type: 'string', required: false, description: `Source control type: git or hg. Default is git.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug to fork.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug of the source repository.` },
      { name: 'is_private', type: 'boolean', required: false, description: `Whether the fork should be private.` },
      { name: 'name', type: 'string', required: false, description: `Name for the forked repository. Defaults to the source name.` },
      { name: 'workspace_destination', type: 'string', required: false, description: `Workspace to fork into. Defaults to the authenticated user's workspace.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'group_slug', type: 'string', required: true, description: `The group slug.` },
      { name: 'permission', type: 'string', required: true, description: `Permission level: read, write, or admin.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'description', type: 'string', required: false, description: `New description for the repository.` },
      { name: 'has_issues', type: 'boolean', required: false, description: `Enable or disable the issue tracker.` },
      { name: 'has_wiki', type: 'boolean', required: false, description: `Enable or disable the wiki.` },
      { name: 'is_private', type: 'boolean', required: false, description: `Whether the repository should be private.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'commit', type: 'string', required: true, description: `Branch name, tag, or commit hash.` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'path', type: 'string', required: false, description: `Path to the file or directory within the repository.` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'target_hash', type: 'string', required: true, description: `The commit hash to tag.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'message', type: 'string', required: false, description: `Optional message for an annotated tag.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'version_id', type: 'string', required: true, description: `The numeric ID of the version.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'events', type: 'string', required: true, description: `JSON array of event types to subscribe to, e.g. ["repo:push","pullrequest:created"].` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'url', type: 'string', required: true, description: `The URL to receive webhook payloads.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'active', type: 'boolean', required: false, description: `Whether the webhook is active.` },
      { name: 'description', type: 'string', required: false, description: `A human-readable description of the webhook.` },
      { name: 'secret', type: 'string', required: false, description: `Secret string used to compute the HMAC signature of webhook payloads.` },
    ],
  },
  {
    ...
    params: [
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'uid', type: 'string', required: true, description: `The UID of the webhook to delete.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'events', type: 'string', required: true, description: `JSON array of event types to subscribe to, e.g. ["repo:push","pullrequest:created"].` },
      { name: 'repo_slug', type: 'string', required: true, description: `The repository slug or UUID.` },
      { name: 'uid', type: 'string', required: true, description: `The UID of the webhook to update.` },
      { name: 'url', type: 'string', required: true, description: `The new URL to receive webhook payloads.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'active', type: 'boolean', required: false, description: `Whether the webhook is active.` },
      { name: 'description', type: 'string', required: false, description: `A human-readable description of the webhook.` },
    ],
  ...
  },
  {
    ...
    params: [
      { name: 'key', type: 'string', required: true, description: `Unique key for the project (uppercase letters/numbers).` },
      ...
      { name: 'is_private', type: 'string', required: false, description: `Whether the project is private.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'project_key', type: 'string', required: true, description: `The project key (e.g. PROJ).` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'key', type: 'string', required: true, description: `The project key to set in the request body. To keep the existing key, pass the same value as project_key. To rename the key, pass the new key here.` },
      { name: 'name', type: 'string', required: true, description: `Updated name of the project.` },
      { name: 'project_key', type: 'string', required: true, description: `The current project key used in the URL path to identify which project to update (e.g. PROJ).` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
  ...
  },
  {
    ...
    params: [
      { name: 'search_query', type: 'string', required: true, description: `Code search query string.` },
      { name: 'workspace', type: 'string', required: true, description: `The workspace slug or UUID.` },
      { name: 'page', type: 'integer', required: false, description: `Page number for pagination.` },
      { name: 'pagelen', type: 'integer', required: false, description: `Number of results per page (max 100).` },
    ],
  },
]
