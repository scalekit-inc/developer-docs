    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Status color indicating project health. Valid values: 'green' (on track), 'yellow' (at risk), 'red' (off track), 'blue' (on hold), 'complete'.`,
      },
      {
        name: 'parent',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `Array of tasks to create. Each element defines one task. Up to 50 tasks may be created per call.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Name or keyword to search for the project or portfolio to get a status overview for. Example: 'Q4 Launch'`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `Array of task update objects. Each element must include a 'task' field (the task GID) plus whichever fields to update.`,
      },
    ],
  },
]
