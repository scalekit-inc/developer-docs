...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'account_id', type: 'string', required: true, description: `Account UUID from list_accounts. Obtain by calling List Accounts first.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'account_id', type: 'string', required: true, description: `Account UUID from list_accounts. Obtain by calling List Accounts first.` },
      { name: 'signal_slug', type: 'string', required: true, description: `Data element slug for the company signal. Obtain from List Tracked Signals.` },
    ],
  },
  {
    ...
    params: [
      { name: 'account_id', type: 'string', required: true, description: `Account UUID from list_accounts. Obtain by calling List Accounts first.` },
      { name: 'name', type: 'string', required: false, description: `Person's full name as shown in List People. Merges all persona rows for that person. Mutually exclusive with persona.` },
      { name: 'person_id', type: 'string', required: false, description: `Deprecated alias for persona slug. Use persona or name instead.` },
      { name: 'persona', type: 'string', required: false, description: `Persona slug (e.g. chief-nursing-officer). Obtain from List Personas or List People.` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'query', type: 'string', required: false, description: `Case-insensitive substring to filter account names.` },
      { name: 'status', type: 'string', required: false, description: `Lifecycle status filter. Accepted values: active, paused, all.` },
    ],
  },
  {
    ...
    params: [
      { name: 'account_id', type: 'string', required: true, description: `Account UUID from list_accounts. Obtain by calling List Accounts first.` },
      { name: 'change_type', type: 'string', required: false, description: `Filter people by their latest change type. Accepted values: new, departed, role_change, any.` },
      { name: 'limit', type: 'integer', required: false, description: `Maximum number of items to return.` },
      { name: 'persona', type: 'string', required: false, description: `Persona slug (e.g. chief-nursing-officer). Obtain from List Personas or List People.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'account_id', type: 'string', required: true, description: `Account UUID from list_accounts. Obtain by calling List Accounts first.` },
      { name: 'limit', type: 'integer', required: false, description: `Maximum number of items to return.` },
      { name: 'since', type: 'string', required: false, description: `Reserved for future time filtering. Currently unused.` },
    ],
  },
  {
