    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The ID of the note to append blocks to.`,
      },
      {
        name: 'sliteml',
        type: 'string',
        required: true,
        description: `sliteml content blocks to insert. Block IDs are auto-generated and returned in changedContent.`,
      },
      {
        name: 'afterBlockId',
        type: 'string',
        required: false,
        description: `Block ID to insert after; read from trailing {#blockId} markers in a get-note response.`,
      },
      {
        name: 'beforeBlockId',
        type: 'string',
        required: false,
        description: `Block ID to insert before; read from trailing {#blockId} markers in a get-note response.`,
      },
      {
        name: 'returnFullDocument',
        type: 'boolean',
        required: false,
        description: `If true, include the full updated document in the response. Defaults to false.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Optional icon color. Paired with iconShape.`,
      },
      {
        name: 'iconShape',
        type: 'string',
        required: false,
        description: `Optional icon shape. Use an icon key like 'rocket' or 'book' (no colons).`,
      },
      {
        name: 'type',
        type: 'string',
        required: false,
        description: `Channel visibility. "public" (default) is open to all org members, "private" is restricted to invited members.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `Column definitions for the collection. The Title column is always included automatically.`,
      },
      {
        name: 'title',
        type: 'string',
        required: true,
        description: `The title of the collection to create.`,
      },
      {
        name: 'parentNoteId',
        type: 'string',
        required: false,
        description: `Optional ID of the parent note. If not specified, the collection will be created in your personal channel.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Plain-text content of the first comment.`,
      },
      {
        name: 'noteId',
        type: 'string',
        required: true,
        description: `The ID of the note to open the thread on.`,
      },
      {
        name: 'blockId',
        type: 'string',
        required: false,
        description: `Optional: when anchoring inline, the ID of the block to edit. Same as \`modify-block\`.`,
      },
      {
        name: 'highlight',
        type: 'string',
        required: false,
        description: `Optional quoted snippet shown alongside the thread in the sidebar.`,
      },
      {
        name: 'sliteml',
        type: 'string',
        required: false,
        description: `For inline anchoring, the updated block sliteml containing a <comment> tag with the thread ID.`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Doc layout: 'regular' (default centered) or 'wide' (expanded).`,
      },
      {
        name: 'fields',
        type: 'object',
        required: false,
        description: `Field values for collection records, keyed by column ID. Only applies when parentNoteId is a collection.`,
      },
      {
        name: 'iconColor',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Optional ID of the parent note. If not specified, the note will be created in your personal channel.`,
      },
      {
        name: 'sliteml',
        type: 'string',
        required: false,
        description: `Optional sliteml content for the note body. Do not duplicate the title as a heading.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The ID of the note the thread belongs to.`,
      },
      {
        name: 'threadId',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Pass the nextCursor from a previous partial response to continue reading the document.`,
      },
      {
        name: 'endBlockId',
        type: 'string',
        required: false,
        description: `Return only blocks up to and including this one (inclusive). Combine with startBlockId for a slice.`,
      },
      {
        name: 'format',
        type: 'string',
        required: false,
        description: `Content format to return: 'sliteml' (default, with block IDs) or 'md' (plain Markdown).`,
      },
      {
        name: 'fullContent',
        type: 'boolean',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Return only blocks from this block onward (inclusive). Combine with endBlockId for a slice.`,
      },
    ],
  },
  {
    ...
    params: [
      { name: 'noteId', type: 'string', required: true, description: `The ID of the parent note.` },
      {
        ...
        type: 'string',
        required: false,
        description: `Cursor to use to continue fetching the note children (for pagination when there are more than 50 children).`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The ID of the note to list threads on.`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'array',
        required: false,
        description: `Optional user or user group IDs to filter notes by owner.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'array',
        required: false,
        description: `Optional filter to return notes in special review states.`,
      },
      {
        name: 'sinceDaysAgo',
        type: 'number',
        required: false,
        description: `Optional time window for popularity.`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'number',
        required: false,
        description: `Optional time window for public notes.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `ID of the block to replace; read from {#blockId} markers in a get-note response.`,
      },
      {
        name: 'noteId',
        type: 'string',
        required: true,
        description: `The ID of the note containing the block.`,
      },
      {
        name: 'sliteml',
        type: 'string',
        required: true,
        description: `Replacement sliteml content for the block. Do not include the block ID in the content.`,
      },
      {
        name: 'returnFullDocument',
        type: 'boolean',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `ID of the last block in the range to replace (inclusive); must follow startBlockId in document order.`,
      },
      {
        name: 'noteId',
        type: 'string',
        required: true,
        description: `The ID of the note containing the blocks.`,
      },
      {
        name: 'sliteml',
        type: 'string',
        required: true,
        description: `Replacement sliteml content. Pass an empty string to delete the range.`,
      },
      {
        name: 'startBlockId',
        type: 'string',
        required: true,
        description: `ID of the first block in the range to replace (inclusive).`,
      },
      {
        name: 'returnFullDocument',
        type: 'boolean',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `The ID of the target parent note to move the note into.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `The block IDs to remove. Use get-note with format="sliteml" to see available block IDs.`,
      },
      {
        name: 'noteId',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The ID of the archived note to restore.`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Optional filter to only return notes edited after a specific date (ISO 8601 format).`,
      },
      {
        name: 'page',
        type: 'number',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Optional search query to filter groups by name.`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Optional search query to filter users by name, email, or username.`,
      },
    ],
  },
  {
    ...
    params: [
      { name: 'noteId', type: 'string', required: true, description: `The ID of the note.` },
      {
        ...
        type: 'string',
        required: false,
        description: `Optional message. Only applicable for "out_of_date" and "verification_requested" states.`,
      },
      {
        name: 'reviewState',
        type: 'string',
        required: false,
        description: `The new review state to set. Optional if only updating the review owner.`,
      },
      {
        name: 'reviewStateManagedBy',
        type: 'string',
        required: false,
        description: `Optional user ID to set as the review owner for this note.`,
      },
      {
        name: 'reviewStateManagedByUserGroup',
        type: 'string',
        required: false,
        description: `Optional user group ID to set as the review owner for this note. Mutually exclusive with reviewStateManagedBy.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Optional new icon color. Pass null to clear.`,
      },
      {
        name: 'iconShape',
        type: 'string',
        required: false,
        description: `Optional new icon shape. Pick an icon dictionary key (e.g. "book", "rocket") — no colons. Pass null to clear.`,
      },
      {
        name: 'name',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The ID of the collection note to update.`,
      },
      {
        name: 'columns',
        type: 'array',
        required: false,
        description: `New columns to add to the collection.`,
      },
      {
        name: 'removeColumns',
        type: 'array',
        required: false,
        description: `Column IDs to remove. Errors if any ID does not match an existing column.`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'object',
        required: false,
        description: `Field values for collection records, keyed by column ID. Only applies when the note is inside a collection.`,
      },
      {
        name: 'iconColor',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Optional new icon shape. Use an icon key like 'rocket' or '#collection_table' for collection views.`,
      },
      {
        name: 'sliteml',
        type: 'string',
        required: false,
        description: `Optional new sliteml content. Replaces the entire note body.`,
      },
      {
        name: 'title',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The ID of the note to verify.`,
      },
      {
        name: 'until',
        type: 'string',
        required: false,
        description: `Optional ISO 8601 date in the future when the verification should expire.`,
      },
    ],
  },
]
