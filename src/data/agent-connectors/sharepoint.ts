...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    params: [
      { name: 'site_id', type: 'string', required: true, description: `The unique ID of the SharePoint site whose drives to list. Obtain site IDs from sharepoint_get_site or sharepoint_list_sites.` },
