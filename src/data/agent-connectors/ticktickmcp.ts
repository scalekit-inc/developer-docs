...
export const tools: Tool[] = [
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `Text content of the comment (plain text, max 1024 characters).`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `End time of the focus session in ISO 8601 format, e.g. 2026-06-01T10:00:00+0000.`,
      },
      {
        name: 'start_time',
        type: 'string',
        required: true,
        description: `Start time of the focus session in ISO 8601 format, e.g. 2026-06-01T09:00:00+0000.`,
      },
      {
        name: 'type',
        type: 'integer',
        required: true,
        description: `Focus session type: 0 for Pomodoro, 1 for timer.`,
      },
      {
        name: 'habit_id',
        type: 'string',
        required: false,
        description: `Unique ID of the habit. Get it from list_habits.`,
      },
      {
        name: 'note',
        type: 'string',
        required: false,
        description: `Optional text note to attach to the focus session.`,
      },
      {
        name: 'task_id',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Hex color code for the project, e.g. #FF6B6B.`,
      },
      {
        name: 'group_id',
        type: 'string',
        required: false,
        description: `ID of the project group to place this project in.`,
      },
      {
        name: 'kind',
        type: 'string',
        required: false,
        description: `Project kind. Accepted values: TASK, NOTE.`,
      },
      {
        name: 'sort_order',
        type: 'integer',
        required: false,
        description: `Integer sort order for positioning the project in the list.`,
      },
      {
        name: 'view_mode',
        type: 'string',
        required: false,
        description: `Default view mode. Accepted values: list, kanban, timeline.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [{ name: 'tag', type: 'string', required: true, description: `No description.` }],
  },
  {
    name: 'ticktickmcp_create_task',
    description: `Create a new task in a TickTick project.`,
    params: [{ name: 'task', type: 'string', required: true, description: `No description.` }],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Unique ID of the focus session.`,
      },
      {
        name: 'type',
        type: 'integer',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Unique ID of the project group. Get it from list_project_groups.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [{ name: 'filter', type: 'string', required: true, description: `No description.` }],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `End of the time range in ISO 8601 format. Range must not exceed one month.`,
      },
      {
        name: 'type',
        type: 'integer',
    ...
    params: [
      {
        ...
        type: 'integer',
        required: true,
        description: `Start date as an integer date stamp, e.g. 20260101 for January 1 2026.`,
      },
      { name: 'habit_ids', type: 'array', required: true, description: `No description.` },
      {
        ...
        type: 'integer',
        required: true,
        description: `End date as an integer date stamp, e.g. 20260630 for June 30 2026.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [{ name: 'search', type: 'string', required: true, description: `No description.` }],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `Predefined time query. Accepted values: today, last24hour, last7day, tomorrow, nextWeek.`,
      },
    ],
  },
  {
    ...
    params: [{ name: 'moves', type: 'array', required: true, description: `No description.` }],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'column', type: 'string', required: true, description: `No description.` },
      {
        ...
        type: 'string',
        required: true,
        description: `Unique ID of the column. Get it from list_columns.`,
      },
      {
        name: 'project_id',
        type: 'string',
