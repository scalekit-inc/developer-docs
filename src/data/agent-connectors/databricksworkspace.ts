...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'cluster_id', type: 'string', required: true, description: `The unique identifier of the cluster.` },
    ],
  },
  {
    ...
    params: [
      { name: 'cluster_id', type: 'string', required: true, description: `The unique identifier of the cluster to start.` },
    ],
  },
  {
    ...
    params: [
      { name: 'cluster_id', type: 'string', required: true, description: `The unique identifier of the cluster to terminate.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'catalog', type: 'string', required: true, description: `The catalog containing the table.` },
      { name: 'schema', type: 'string', required: true, description: `The schema containing the table.` },
      { name: 'table', type: 'string', required: true, description: `The table to list columns for.` },
      { name: 'warehouse_id', type: 'string', required: true, description: `The ID of the SQL warehouse to run the query on.` },
    ],
  },
  {
    ...
    params: [
      { name: 'catalog', type: 'string', required: true, description: `The catalog to list schemas from.` },
      { name: 'warehouse_id', type: 'string', required: true, description: `The ID of the SQL warehouse to run the query on.` },
    ],
  },
  {
    ...
    params: [
      { name: 'catalog', type: 'string', required: true, description: `The catalog containing the schema.` },
      { name: 'schema', type: 'string', required: true, description: `The schema to list constraints from.` },
      { name: 'warehouse_id', type: 'string', required: true, description: `The ID of the SQL warehouse to run the query on.` },
    ],
  },
  {
    ...
    params: [
      { name: 'catalog', type: 'string', required: true, description: `The catalog to query INFORMATION_SCHEMA from.` },
      { name: 'schema', type: 'string', required: true, description: `The schema to list tables from.` },
      { name: 'warehouse_id', type: 'string', required: true, description: `The ID of the SQL warehouse to run the query on.` },
    ],
  },
  {
    ...
    params: [
      { name: 'job_id', type: 'integer', required: true, description: `The unique identifier of the job.` },
    ],
  },
  {
    ...
    params: [
      { name: 'job_id', type: 'integer', required: true, description: `The unique identifier of the job to run.` },
    ],
  },
  {
    ...
    params: [
      { name: 'job_id', type: 'integer', required: false, description: `Filter runs by a specific job ID. If omitted, returns runs for all jobs.` },
      { name: 'limit', type: 'integer', required: false, description: `The number of runs to return. Defaults to 20. Maximum is 1000.` },
      { name: 'offset', type: 'integer', required: false, description: `The offset of the first run to return.` },
    ],
  },
  {
    ...
    params: [
      { name: 'limit', type: 'integer', required: false, description: `The number of jobs to return. Defaults to 20. Maximum is 100.` },
      { name: 'offset', type: 'integer', required: false, description: `The offset of the first job to return.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'count', type: 'integer', required: false, description: `Maximum number of results to return per page.` },
      { name: 'filter', type: 'string', required: false, description: `SCIM filter expression to narrow results (e.g. userName eq "user@example.com").` },
      { name: 'startIndex', type: 'integer', required: false, description: `1-based index of the first result to return. Used for pagination.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'statement_id', type: 'string', required: true, description: `The ID of the SQL statement to cancel.` },
    ],
  },
  {
    ...
    params: [
      { name: 'statement', type: 'string', required: true, description: `The SQL statement to execute.` },
      { name: 'warehouse_id', type: 'string', required: true, description: `The ID of the SQL warehouse to execute the statement on.` },
      { name: 'catalog', type: 'string', required: false, description: `The catalog to use for the statement execution.` },
      { name: 'schema', type: 'string', required: false, description: `The schema to use for the statement execution.` },
    ],
  },
  {
    ...
    params: [
      { name: 'statement_id', type: 'string', required: true, description: `The ID of the SQL statement to retrieve.` },
    ],
  },
  {
    ...
    params: [
      { name: 'chunk_index', type: 'integer', required: true, description: `The index of the result chunk to fetch (0-based).` },
      { name: 'statement_id', type: 'string', required: true, description: `The ID of the SQL statement.` },
    ],
  },
  {
    ...
    params: [
      { name: 'warehouse_id', type: 'string', required: true, description: `The ID of the SQL warehouse to retrieve.` },
    ],
  },
  {
    ...
    params: [
      { name: 'warehouse_id', type: 'string', required: true, description: `The ID of the SQL warehouse to start.` },
    ],
  },
  {
    ...
    params: [
      { name: 'warehouse_id', type: 'string', required: true, description: `The ID of the SQL warehouse to stop.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'catalog_name', type: 'string', required: true, description: `The name of the catalog to list schemas from.` },
    ],
  },
  {
    ...
    params: [
      { name: 'catalog_name', type: 'string', required: true, description: `The name of the catalog containing the schema.` },
      { name: 'schema_name', type: 'string', required: true, description: `The name of the schema to list tables from.` },
    ],
  },
]
