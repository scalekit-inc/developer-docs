...
export const tools: Tool[] = [
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `The array of comments to add.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `The array of filters to add.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `Labels to apply to this item. Pass as a JSON array via the SDK, not as a string.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `The array of projects to add.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `Reminders array. Each must specify a type: relative, absolute, or location.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `The array of sections to add.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `The array of tasks to add (max 25).`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The ID of the task or project to fetch, prefixed with its type. Format: "task:{id}" or "project:{id}".`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'eventType', type: 'string', required: false, description: `Filter by event type.` },
      {
        ...
        type: 'string',
        required: false,
        description: `Filter by the user ID who initiated the event.`,
      },
      {
        name: 'limit',
        type: 'integer',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Filter by specific object ID (task, project, or comment).`,
      },
      {
        name: 'objectType',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `The ID of the task. Get it from find-tasks.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `The ID of the comment. Get it from find-comments.`,
      },
      {
        name: 'cursor',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Date field to filter by: "completion" (when completed) or "due" (due date).`,
      },
      {
        name: 'labels',
        type: 'array',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `How to match multiple labels: "or" returns tasks with any label, "and" requires all labels.`,
      },
      {
        name: 'limit',
        type: 'integer',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `The ID of the parent task or project.`,
      },
      {
        name: 'projectId',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Email or user ID of the responsible user.`,
      },
      {
        name: 'sectionId',
        type: 'string',
        required: false,
        description: `The ID of the section. Get it from find-sections.`,
      },
      {
        name: 'since',
        type: 'string',
        required: false,
        description: `Start date for filtering (YYYY-MM-DD). Defaults to 6 days before the end date.`,
      },
      {
        name: 'until',
        type: 'string',
        required: false,
        description: `End date for filtering (YYYY-MM-DD). Defaults to 6 days after the start date.`,
      },
      {
        name: 'workspaceId',
        type: 'string',
        required: false,
        description: `The ID of the workspace. Get it from list-workspaces.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Filter by name or email (partial, case-insensitive). Returns all users if omitted.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      {
        name: 'locationReminderId',
        type: 'string',
        required: false,
        description: `Get a specific location reminder by its ID.`,
      },
      {
        name: 'reminderId',
        type: 'string',
        required: false,
        description: `Get a specific time-based reminder (relative or absolute) by its ID.`,
      },
      {
        name: 'taskId',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `A Todoist filter string (e.g. "today | overdue") to scope the task query.`,
      },
      {
        name: 'filterIdOrName',
        type: 'string',
        required: false,
        description: `ID or name of a saved Todoist filter whose query will be applied. Cannot be combined with the filter parameter.`,
      },
      {
        name: 'labels',
        type: 'array',
      ...
      {
        name: 'responsibleUserFiltering',
        type: 'string',
        required: false,
        description: `Filter tasks when no responsibleUser is given. Accepted values: assigned, unassignedOrMe, all.`,
      },
      {
        name: 'searchText',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'integer',
        required: false,
        description: `Number of days to fetch starting from the start date. Defaults to 1.`,
      },
      {
        name: 'labels',
        type: 'array',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `How to handle overdue tasks. Accepted values: overdue-only, include-overdue, exclude-overdue.`,
      },
      {
        name: 'responsibleUser',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `The start date to get the tasks for. Format: YYYY-MM-DD or 'today'.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      {
        name: 'includeWeeklyCounts',
        type: 'boolean',
        required: false,
        description: `Include weekly rollup counts alongside daily counts.`,
      },
      {
        name: 'weeks',
        type: 'integer',
        required: false,
        description: `Number of weeks of activity data to retrieve (1-12, default 2).`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'boolean',
        required: false,
        description: `Include detailed health metrics and per-task data. May produce large output for big projects.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Workspace ID or name (exact or unique partial match, case-insensitive).`,
      },
      {
        name: 'projectIds',
        type: 'array',
        required: false,
        description: `Limit insights to specific project IDs.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'array',
        required: true,
        description: `The IDs of the tasks to operate on (max 50).`,
      },
      {
        name: 'dryRun',
        type: 'boolean',
        required: false,
        description: `If true, validates operations without executing them.`,
      },
      {
        name: 'fromAssigneeUser',
        type: 'string',
        required: false,
        description: `For reassign: the current assignee to reassign from. Accepts user ID, name, or email.`,
      },
      {
        name: 'responsibleUser',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Optional target folder ID within the workspace.`,
      },
      {
        name: 'visibility',
        type: 'string',
        required: false,
        description: `Optional access visibility for the project in the workspace (restricted, team, or public).`,
      },
      {
        name: 'workspaceId',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `Items to reorder, each with an id and at least one of: order or parentId.`,
      },
      {
        name: 'type',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `The tasks to reschedule with their new dates.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The search query string to find tasks and projects.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `Labels to update. Use labelType="personal" with an ID, or labelType="shared" with name+newName.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [{ name: 'tasks', type: 'array', required: true, description: `The tasks to update.` }],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `URL of the attachment to view. Get this from the fileUrl field in a comment's fileAttachment.`,
      },
    ],
  },
]
