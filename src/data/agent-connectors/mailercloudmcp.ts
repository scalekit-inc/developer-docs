...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'campaign_id', type: 'string', required: true, description: `The unique ID of the campaign.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
      { name: 'cost_per_email', type: 'number', required: false, description: `Optional cost per email sent, used to calculate ROI in reports.` },
    ],
  },
  {
    ...
    params: [
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
      { name: 'cost_per_email', type: 'number', required: false, description: `Optional cost per email sent, used to calculate ROI in reports.` },
      { name: 'count', type: 'integer', required: false, description: `Number of recent campaigns to analyze (default: 5).` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'contacts', type: 'string', required: true, description: `Array of contact objects,required` },
      { name: 'list_id', type: 'string', required: true, description: `The unique ID of the contact list.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'campaign_ids', type: 'string', required: true, description: `Array of campaign IDs to compare.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
      { name: 'cost_per_email', type: 'number', required: false, description: `Optional cost per email sent, used to calculate ROI in reports.` },
    ],
  },
  {
    ...
    params: [
      { name: 'list_ids', type: 'string', required: true, description: `List IDs to send to,required` },
      { name: 'name', type: 'string', required: true, description: `Display name for the campaign.` },
      { name: 'subject', type: 'string', required: true, description: `Subject line for the email.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
      { name: 'email_preheader', type: 'string', required: false, description: `Short preview text shown after the subject line in email clients (max 150 characters).` },
      { name: 'exclude_list_ids', type: 'string', required: false, description: `List IDs to exclude from send` },
      { name: 'exclude_segments', type: 'string', required: false, description: `Segment IDs to exclude from send` },
      { name: 'exclude_tag_ids', type: 'string', required: false, description: `Tag IDs to exclude from send` },
      { name: 'frequency_cap', type: 'string', required: false, description: `Limit how often a contact receives campaigns (e.g. daily, weekly).` },
      { name: 'html', type: 'string', required: false, description: `HTML content for the email body.` },
      { name: 'is_publish', type: 'string', required: false, description: `Set to 'true' to publish immediately; 'false' saves as a draft.` },
      { name: 'plain_text', type: 'string', required: false, description: `Plain text fallback content for email clients that do not support HTML.` },
      { name: 'reply_email', type: 'string', required: false, description: `Reply-to email address. Defaults to sender email if omitted.` },
      { name: 'reply_id', type: 'string', required: false, description: `ID of a pre-configured reply-to email address (alternative to reply_email).` },
      { name: 'scheduled_at', type: 'string', required: false, description: `Datetime to send the campaign, in YYYY-MM-DD HH:MM:SS format.` },
      { name: 'segments', type: 'string', required: false, description: `Segment IDs` },
      { name: 'sender_email', type: 'string', required: false, description: `Email address of the sender. Auto-resolved if your account has only one verified sender.` },
      { name: 'sender_id', type: 'string', required: false, description: `Array of pre-configured sender IDs. Alternative to sender_name/sender_email.` },
      { name: 'sender_name', type: 'string', required: false, description: `Display name for the sender. Auto-resolved if your account has only one verified sender.` },
      { name: 'tag_ids', type: 'string', required: false, description: `Tag IDs to apply to campaign` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'company_name', type: 'string', required: false, description: `Contact's company or organization name.` },
      { name: 'country', type: 'string', required: false, description: `Contact's country code (e.g. US, GB).` },
      { name: 'custom_fields', type: 'object', required: false, description: `Custom field values` },
      { name: 'department', type: 'string', required: false, description: `Contact's department within their organization.` },
      ...
      { name: 'phone', type: 'string', required: false, description: `Contact's phone number in E.164 format.` },
  ...
  },
  {
    ...
    params: [
      { name: 'list_type', type: 'integer', required: true, description: `Type of list: 1 for regular, 2 for single opt-in, 3 for double opt-in.` },
      { name: 'name', type: 'string', required: true, description: `Display name for the campaign.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'html', type: 'string', required: true, description: `HTML content for the email body.` },
      { name: 'name', type: 'string', required: true, description: `Display name for the campaign.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
      { name: 'category_id', type: 'string', required: false, description: `ID of the template category to assign this template to.` },
      { name: 'plain_text', type: 'string', required: false, description: `Plain text fallback content for email clients that do not support HTML.` },
    ],
  },
  {
    ...
    params: [
      { name: 'events', type: 'string', required: true, description: `Events to subscribe to,required` },
      { name: 'name', type: 'string', required: true, description: `Display name for the campaign.` },
      { name: 'url', type: 'string', required: true, description: `HTTPS URL to receive webhook event payloads.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
    ],
  },
  {
    ...
    params: [
      { name: 'contact_id', type: 'string', required: true, description: `The unique ID of the contact.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'webhook_id', type: 'string', required: true, description: `The unique ID of the webhook.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'automation_id', type: 'string', required: true, description: `The unique ID of the automation workflow.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
      { name: 'node_type', type: 'string', required: false, description: `Filter automation steps by node type (e.g. email, sms).` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'page', type: 'integer', required: false, description: `Page number for paginated results (starts at 1).` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'date_from', type: 'string', required: true, description: `Start date for inbox tracking data in YYYY-MM-DD format.` },
      { name: 'date_to', type: 'string', required: true, description: `End date for inbox tracking data in YYYY-MM-DD format.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
      { name: 'campaign_id', type: 'string', required: false, description: `The unique ID of the campaign.` },
      { name: 'domain', type: 'string', required: false, description: `Filter inbox tracking data by specific email domain (e.g. gmail.com).` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'template_id', type: 'string', required: true, description: `The unique ID of the template.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'limit', type: 'integer', required: false, description: `Maximum number of results to return per page.` },
      { name: 'page', type: 'integer', required: false, description: `Page number for paginated results (starts at 1).` },
      { name: 'search', type: 'string', required: false, description: `Search query to filter segments by name or keyword.` },
      { name: 'sort_field', type: 'string', required: false, description: `Field to sort results by (e.g. created_at, name).` },
      { name: 'sort_order', type: 'string', required: false, description: `Sort direction: asc for ascending, desc for descending.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'campaign_id', type: 'string', required: true, description: `The unique ID of the campaign.` },
      { name: 'recipients', type: 'string', required: true, description: `Test email recipients,required` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
    ],
  },
  {
    ...
    params: [
      { name: 'from', type: 'string', required: true, description: `Sender email address for the transactional email.` },
      { name: 'subject', type: 'string', required: true, description: `Subject line for the email.` },
      { name: 'to', type: 'string', required: true, description: `To recipients (array of name and email),required` },
      { name: 'amp_html', type: 'string', required: false, description: `AMP HTML content. Use API version 2.0 when sending AMP content.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
      { name: 'attachments', type: 'string', required: false, description: `Attachments (array of name and url)` },
      ...
      { name: 'from_name', type: 'string', required: false, description: `Sender display name for the transactional email.` },
      { name: 'html', type: 'string', required: false, description: `HTML content for the email body.` },
      { name: 'reply_to', type: 'string', required: false, description: `Reply-to addresses` },
      { name: 'text', type: 'string', required: false, description: `Plain text fallback for the transactional email.` },
      { name: 'version', type: 'string', required: false, description: `API version: 1.0 for HTML-only emails, 2.0 for AMP content.` },
    ],
  },
  {
    ...
    params: [
      { name: 'active', type: 'boolean', required: true, description: `Set to true to enable the webhook, false to disable it.` },
      { name: 'webhook_id', type: 'string', required: true, description: `The unique ID of the webhook.` },
      { name: 'api_key', type: 'string', required: false, description: `Your MailerCloud API key for authentication.` },
    ],
  },
