...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'campaignMessageId', type: 'string', required: true, description: `The ID of the email campaign message to assign the template to.` },
      { name: 'emailTemplateId', type: 'string', required: true, description: `The ID of the email template to assign to the campaign message.` },
  ...
  },
  {
    ...
    params: [
      { name: 'html', type: 'string', required: true, description: `
...
` },
      ...
      { name: 'hasEditableRegions', type: 'boolean', required: false, description: `Whether the template HTML contains editable regions. Should be false unless they explicitly request an editable/drag-and-drop/hybrid template.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'channel', type: 'string', required: true, description: `Channel for this translation` },
      { name: 'fallbackLocale', type: 'string', required: true, description: `Fallback locale (e.g. 'en')` },
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'relationshipId', type: 'string', required: true, description: `ID of the related resource` },
      { name: 'relationshipType', type: 'string', required: true, description: `Type of related resource` },
      { name: 'sourceLocale', type: 'string', required: true, description: `Source locale (e.g. 'en')` },
      { name: 'targetLocales', type: 'array', required: true, description: `Target locales (e.g. ['fr', 'es']). Pass as a JSON array of values.` },
    ],
  },
  {
    ...
    params: [
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'translationId', type: 'string', required: true, description: `The ID of the translation to delete` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'conversionMetricId', type: 'string', required: true, description: `ID of the metric to be used for conversion statistics. You can get available metrics IDs using the get_metrics tool and just requesting the 'name' field. Do not use any additional filters on the get_metrics tool. If a specific metric is not requested, use the ID of the metric named 'Placed Order'. If it doesn't exist, use any metric.` },
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'statistics', type: 'array', required: true, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "bounce_rate", "bounced", "bounced_or_failed", "bounced_or_failed_rate", "click_rate", "click_to_open_rate", "clicks", "clicks_unique", "conversion_rate", "conversion_uniques", "conversions", "delivered", "delivery_rate", "failed", "failed_rate", "open_rate", "opens", "opens_unique", "recipients", "spam_complaint_rate", "spam_complaints", "unsubscribe_rate", "unsubscribe_uniques", "unsubscribes". Example: ["bounce_rate", "bounced", "bounced_or_failed"]` },
      { name: 'detailFilters', type: 'array', required: false, description: `Array of detail filter objects for breakdown rows. Each object must have fieldName (e.g. "tags", "audiences.included.name"), operator, and value. Example: [{"fieldName": "tags", "operator": "equals", "value": "promo"}]` },
      { name: 'filters', type: 'array', required: false, description: `Array of filter objects. Each object must have fieldName (e.g. "send_channel", "campaign_id"), operator (e.g. "equals", "contains-any"), and value. Example: [{"fieldName": "send_channel", "operator": "equals", "value": "email"}]` },
      { name: 'groupBy', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "campaign_id", "campaign_message_id", "campaign_message_name", "group", "group_name", "send_channel", "tag_id", "tag_name", "text_message_format", "variation", "variation_name". Example: ["campaign_id", "campaign_message_id", "campaign_message_name"]` },
      { name: 'groupByAudience', type: 'boolean', required: false, description: `If true, also return an aggregation of stats grouped by audience (list/segment) and send channel, combining data across campaigns.` },
      { name: 'timeframe', type: 'string', required: false, description: `The timeframe to query for data within. The max length a timeframe can be is 1 year. If unspecified, use 1 year.` },
      { name: 'valueStatistics', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "average_order_value", "conversion_value", "revenue_per_recipient". Example: ["average_order_value", "conversion_value", "revenue_per_recipient"]` },
    ],
  },
  {
    ...
    params: [
      { name: 'channel', type: 'string', required: true, description: `Which types of campaigns to return. To get all types of campaigns, call this tool for each channel.` },
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      ...
      { name: 'filters', type: 'array', required: false, description: `Array of filter objects. Each object must have fieldName (e.g. "status", "name", "archived"), operator (e.g. "equals", "contains", "any"), and value. Example: [{"fieldName": "status", "operator": "equals", "value": "Draft"}]` },
      { name: 'pageCursor', type: 'string', required: false, description: `Only used for pagination. If links.next is null then you've reached the last page of results. Otherwise, pass links.next to this parameter to get the next page.` },
    ],
  },
  {
    ...
    params: [
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'catalogVariantFields', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "external_id", "title", "description", "sku", "inventory_policy", "inventory_quantity", "price", "url", "image_full_url", "image_thumbnail_url", "images", "custom_metadata", "published", "created", "updated". Example: ["external_id", "title", "description"]` },
      { name: 'fields', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "external_id", "title", "description", "price", "url", "image_full_url", "image_thumbnail_url", "images", "custom_metadata", "published", "created", "updated". Example: ["external_id", "title", "description"]` },
      { name: 'filter', type: 'array', required: false, description: `Array of filter objects. Each object must have fieldName (e.g. "title", "ids", "published"), operator (e.g. "contains", "any", "equals"), and value. Example: [{"fieldName": "title", "operator": "contains", "value": "shirt"}]` },
      { name: 'pageCursor', type: 'string', required: false, description: `Only used for pagination. If links.next is null then you've reached the last page of results. Otherwise, pass links.next to this parameter to get the next page.` },
  ...
  },
  {
    ...
    params: [
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'templateId', type: 'string', required: true, description: `The ID of the template return` },
    ],
  },
  {
    ...
    params: [
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'fields', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "timestamp", "event_properties", "datetime", "uuid". Example: ["timestamp", "event_properties", "datetime"]` },
      { name: 'filter', type: 'array', required: false, description: `Array of filter objects. Each object must have fieldName (e.g. "metric_id", "profile_id", "datetime"), operator (e.g. "equals", "greater-than"), and value. Example: [{"fieldName": "metric_id", "operator": "equals", "value": "abc123"}]` },
      { name: 'metricFields', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "name", "created", "updated", "integration". Example: ["name", "created", "updated"]` },
      { name: 'pageCursor', type: 'string', required: false, description: `Only used for pagination. If links.next is null then you've reached the last page of results. Otherwise, pass links.next to this parameter to get the next page.` },
      { name: 'pageSize', type: 'integer', required: false, description: `Number of results to return per page (1-1000). Default is 10. Keep small (10-50) when processing results in context. Use larger values only when paginating to export or aggregate data outside of context.` },
      { name: 'profileFields', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "email", "phone_number", "external_id", "first_name", "last_name", "organization", "locale", "title", "image", "created", "updated", "last_event_date", "location", "location.address1", "location.address2", "location.city", "location.country", "location.latitude", "location.longitude", "location.region", "location.zip", "location.timezone", "location.ip", "properties". Example: ["email", "phone_number", "external_id"]` },
      { name: 'sort', type: 'string', required: false, description: `What to sort by.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'statistics', type: 'array', required: true, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "bounce_rate", "bounced", "bounced_or_failed", "bounced_or_failed_rate", "click_rate", "click_to_open_rate", "clicks", "clicks_unique", "conversion_rate", "conversion_uniques", "conversions", "delivered", "delivery_rate", "failed", "failed_rate", "open_rate", "opens", "opens_unique", "recipients", "spam_complaint_rate", "spam_complaints", "unsubscribe_rate", "unsubscribe_uniques", "unsubscribes". Example: ["bounce_rate", "bounced", "bounced_or_failed"]` },
      { name: 'detailFilters', type: 'array', required: false, description: `Array of detail filter objects. Each object must have fieldName ("name"), operator ("contains-any"), and value (array). Example: [{"fieldName": "name", "operator": "contains-any", "value": ["welcome"]}]` },
      { name: 'filters', type: 'array', required: false, description: `Array of filter objects. Each object must have fieldName (e.g. "send_channel", "flow_id"), operator (e.g. "equals", "contains-any"), and value. Example: [{"fieldName": "send_channel", "operator": "equals", "value": "email"}]` },
      { name: 'groupBy', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "flow_id", "flow_name", "flow_message_id", "flow_message_name", "send_channel", "tag_id", "tag_name", "text_message_format", "variation", "variation_name". Example: ["flow_id", "flow_name", "flow_message_id"]` },
      { name: 'timeframe', type: 'string', required: false, description: `The timeframe to query for data within. The max length a timeframe can be is 1 year. If unspecified, use 1 year.` },
      { name: 'valueStatistics', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "average_order_value", "conversion_value", "revenue_per_recipient". Example: ["average_order_value", "conversion_value", "revenue_per_recipient"]` },
    ],
  },
  {
    ...
    params: [
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'fields', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "name", "status", "archived", "created", "updated", "trigger_type". Example: ["name", "status", "archived"]` },
      { name: 'filters', type: 'array', required: false, description: `Array of filter objects to narrow results. Each object must have fieldName (e.g. "status", "name", "trigger_type"), operator (e.g. "equals", "contains", "any"), and value. Example: [{"fieldName": "status", "operator": "equals", "value": "live"}]` },
      { name: 'pageCursor', type: 'string', required: false, description: `Only used for pagination. If links.next is null then you've reached the last page of results. Otherwise, pass links.next to this parameter to get the next page.` },
      { name: 'pageSize', type: 'integer', required: false, description: `Number of results to return per page (1-100)` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `No description.` },
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'includeProfileCount', type: 'boolean', required: false, description: `Whether to include the number of profiles. Only set to true if this is requested.` },
    ],
  },
  {
    ...
    params: [
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'fields', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "name", "created", "updated", "opt_in_process". Example: ["name", "created", "updated"]` },
      { name: 'filter', type: 'array', required: false, description: `Array of filter objects. Each object must have fieldName (e.g. "name", "id"), operator (e.g. "equals", "any"), and value. Example: [{"fieldName": "name", "operator": "equals", "value": "My List"}]` },
      { name: 'pageCursor', type: 'string', required: false, description: `Only used for pagination. If links.next is null then you've reached the last page of results. Otherwise, pass links.next to this parameter to get the next page.` },
      { name: 'sort', type: 'string', required: false, description: `What to sort by.` },
    ],
  },
  {
    ...
    params: [
      { name: 'metricId', type: 'string', required: true, description: `The ID of the metric to return` },
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
    ],
  },
  {
    ...
    params: [
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'fields', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "name", "created", "updated", "integration". Example: ["name", "created", "updated"]` },
      { name: 'filter', type: 'array', required: false, description: `Array of filter objects. Each object must have fieldName (e.g. "integration.name", "integration.category"), operator ("equals"), and value. Example: [{"fieldName": "integration.name", "operator": "equals", "value": "Shopify"}]` },
      { name: 'pageCursor', type: 'string', required: false, description: `Only used for pagination. If links.next is null then you've reached the last page of results. Otherwise, pass links.next to this parameter to get the next page.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'fields', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "email", "phone_number", "external_id", "first_name", "last_name", "organization", "locale", "title", "image", "created", "updated", "last_event_date", "location", "location.address1", "location.address2", "location.city", "location.country", "location.latitude", "location.longitude", "location.region", "location.zip", "location.timezone", "location.ip", "properties". Example: ["email", "phone_number", "external_id"]` },
      { name: 'filters', type: 'array', required: false, description: `Array of filter objects. Each object must have fieldName (e.g. "email", "id", "phone_number"), operator (e.g. "equals", "any"), and value. Example: [{"fieldName": "email", "operator": "equals", "value": "user@example.com"}]` },
      { name: 'pageCursor', type: 'string', required: false, description: `Only used for pagination. If links.next is null then you've reached the last page of results. Otherwise, pass links.next to this parameter to get the next page.` },
      { name: 'pageSize', type: 'integer', required: false, description: `Number of results to return per page (1-100)` },
      { name: 'sort', type: 'string', required: false, description: `What to sort by.` },
    ],
  ...
  },
  {
    ...
    params: [
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'fields', type: 'array', required: false, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "name", "definition", "definition.condition_groups", "created", "updated", "is_active", "is_processing", "is_starred". Example: ["name", "definition", "definition.condition_groups"]` },
      { name: 'filters', type: 'array', required: false, description: `Array of filter objects. Each object must have fieldName (e.g. "name", "id", "is_active"), operator (e.g. "equals", "any"), and value. Example: [{"fieldName": "name", "operator": "equals", "value": "Active Users"}]` },
      { name: 'pageCursor', type: 'string', required: false, description: `Only used for pagination. If links.next is null then you've reached the last page of results. Otherwise, pass links.next to this parameter to get the next page.` },
      { name: 'sort', type: 'string', required: false, description: `What to sort by.` },
    ],
  },
  {
    ...
    params: [
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'translationId', type: 'string', required: true, description: `The ID of the translation` },
      { name: 'include', type: 'string', required: false, description: `Related resource to include in the response` },
      { name: 'includeValues', type: 'boolean', required: false, description: `Include translation values (source text and translations per locale)` },
    ],
  },
  {
    ...
    params: [
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'filter', type: 'string', required: false, description: `Filter string, e.g. equals(channel,"email") or equals(resource_type,"campaign-variation")` },
      { name: 'pageCursor', type: 'string', required: false, description: `Cursor for pagination (from previous response)` },
      { name: 'pageSize', type: 'number', required: false, description: `Page size (1-100, default 20)` },
    ],
  },
  {
...
- Custom metric aggregations not available in standard reports`,
    params: [
      { name: 'endDate', type: 'string', required: true, description: `End of the date range (exclusive) in ISO 8601 format without timezone offset, e.g. '2024-12-31T23:59:59'. Do not include a 'Z' suffix or timezone offset; use the timezone parameter instead. The date range must not exceed 1 year.` },
      { name: 'measurements', type: 'array', required: true, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "count", "sum_value", "unique". Example: ["count", "sum_value", "unique"]` },
      { name: 'metricId', type: 'string', required: true, description: `The ID of the metric to aggregate. Use the get_metrics tool to find available metric IDs. Common metrics include 'Placed Order', 'Opened Email', 'Clicked Email', etc.` },
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'startDate', type: 'string', required: true, description: `Start of the date range (inclusive) in ISO 8601 format without timezone offset, e.g. '2024-01-01T00:00:00'. Do not include a 'Z' suffix or timezone offset; use the timezone parameter instead. The date range must not exceed 1 year.` },
      { name: 'additionalFilter', type: 'string', required: false, description: `Optional structured filter to narrow results by a single dimension. Only one additional filter is supported by the API.` },
      ...
      { name: 'interval', type: 'string', required: false, description: `Time interval for grouping results: 'hour', 'day' (default), 'week', or 'month'` },
      { name: 'pageCursor', type: 'string', required: false, description: `Only used for pagination. If links.next is null then you've reached the last page of results. Otherwise, pass links.next to this parameter to get the next page.` },
      { name: 'pageSize', type: 'integer', required: false, description: `Number of rows per page. Must be between 500 and 10,000 (default 500).` },
      { name: 'sort', type: 'string', required: false, description: `Sort results by a grouping dimension. Prefix with '-' for descending order (e.g., '-$attributed_flow'). The sort value must also be included in the 'groupBy' parameter. Only dimension-based sorting is supported.` },
      { name: 'timezone', type: 'string', required: false, description: `Timezone for processing the query (e.g., 'America/New_York', 'US/Eastern'). Defaults to UTC.` },
    ],
  },
  {
    ...
    params: [
      { name: 'channels', type: 'array', required: true, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "email", "sms". Example: ["email", "sms"]` },
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'emailAddress', type: 'string', required: false, description: `The email address of the profile to subscribe. Required if email channel is included.` },
      { name: 'listId', type: 'string', required: false, description: `The ID of the list to subscribe the profile to if provided.` },
      { name: 'phoneNumber', type: 'string', required: false, description: `The phone number of the profile to subscribe. Required if sms channel is included.` },
      { name: 'profileId', type: 'string', required: false, description: `The ID of the profile to subscribe if the profile already exists and has an ID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'channels', type: 'array', required: true, description: `Array of strings to include in the response. Pass as a JSON array. Accepted values: "email", "sms". Example: ["email", "sms"]` },
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'emailAddress', type: 'string', required: false, description: `The email address of the profile to unsubscribe. Required if email channel is included.` },
      { name: 'listId', type: 'string', required: false, description: `The ID of the list to unsubscribe the profile to if provided.` },
      { name: 'phoneNumber', type: 'string', required: false, description: `The phone number of the profile to unsubscribe. Required if sms channel is included.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'translationId', type: 'string', required: true, description: `The ID of the translation to update` },
      { name: 'fallbackLocale', type: 'string', required: false, description: `Updated fallback locale` },
      { name: 'sourceLocale', type: 'string', required: false, description: `Updated source locale` },
      { name: 'targetLocales', type: 'array', required: false, description: `Updated target locales. Pass as a JSON array of values.` },
      { name: 'values', type: 'array', required: false, description: `Translation values to import. Pass as a JSON array of values.` },
    ],
  },
  {
    ...
    params: [
      { name: 'imageURL', type: 'string', required: true, description: `The URL of the image to upload` },
      { name: 'model', type: 'string', required: true, description: `The name of the LLM currently using the tool.` },
      { name: 'name', type: 'string', required: false, description: `A name for the image. Defaults to the filename if omitted.` },
    ],
  },
]
