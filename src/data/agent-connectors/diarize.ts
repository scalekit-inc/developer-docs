...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'url', type: 'string', required: true, description: `The URL of the audio or video content to transcribe (e.g. YouTube, X, Instagram, TikTok link)` },
      { name: 'language', type: 'string', required: false, description: `Language code for transcription (e.g. 'en', 'es', 'fr'). Defaults to auto-detection if not provided.` },
      { name: 'num_speakers', type: 'integer', required: false, description: `Expected number of speakers in the audio. Helps improve diarization accuracy.` },
  ...
  },
  {
    ...
    params: [
      { name: 'job_id', type: 'string', required: true, description: `The unique ID of the completed transcription job` },
      { name: 'format', type: 'string', required: false, description: `Output format for the transcript. Supported formats: 'json', 'txt', 'srt', 'vtt'.` },
      { name: 'schema_version', type: 'string', required: false, description: `Optional schema version to use for tool execution` },
      { name: 'tool_version', type: 'string', required: false, description: `Optional tool version to use for execution` },
    ],
  },
  {
    ...
    params: [
      { name: 'job_id', type: 'string', required: true, description: `The unique ID of the transcription job to check` },
      { name: 'schema_version', type: 'string', required: false, description: `Optional schema version to use for tool execution` },
      { name: 'tool_version', type: 'string', required: false, description: `Optional tool version to use for execution` },
    ],
  },
