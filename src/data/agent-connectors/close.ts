...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: '_fields', type: 'string', required: false, description: `Comma-separated list of fields to return.` },
      { name: '_limit', type: 'integer', required: false, description: `Maximum number of results to return.` },
      { name: '_order_by', type: 'string', required: false, description: `Sort field. Default: date_created.` },
      { name: '_skip', type: 'integer', required: false, description: `Number of results to skip (offset).` },
      { name: '_type', type: 'string', required: false, description: `Activity type: Note, Call, Email, Sms, etc.` },
  ...
  },
  {
    ...
    params: [
      { name: 'lead_id', type: 'string', required: true, description: `ID of the lead for this call.` },
      { name: 'status', type: 'string', required: true, description: `Call outcome: completed, no_answer, wrong_number, left_voicemail, etc.` },
      { name: 'contact_id', type: 'string', required: false, description: `ID of the contact called.` },
      { name: 'direction', type: 'string', required: false, description: `Call direction: inbound or outbound.` },
      { name: 'duration', type: 'integer', required: false, description: `Call duration in seconds.` },
      ...
      { name: 'recording_url', type: 'string', required: false, description: `HTTPS URL of the call recording.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'duration', type: 'integer', required: false, description: `Updated call duration in seconds.` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'object_id', type: 'string', required: true, description: `ID of the object to comment on.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: '_limit', type: 'integer', required: false, description: `Maximum number of results to return.` },
      { name: '_skip', type: 'integer', required: false, description: `Number of results to skip (offset).` },
      { name: 'object_id', type: 'string', required: false, description: `ID of the object to fetch comments for.` },
      { name: 'thread_id', type: 'string', required: false, description: `ID of the comment thread.` },
    ],
  },
  {
    ...
    params: [
      { name: 'lead_id', type: 'string', required: true, description: `ID of the lead to associate this contact with.` },
      { name: 'emails', type: 'string', required: false, description: `JSON array of email objects, e.g. [{"email": "jane@acme.com", "type": "office"}].` },
      { name: 'name', type: 'string', required: false, description: `Full name of the contact.` },
      { name: 'phones', type: 'string', required: false, description: `JSON array of phone objects, e.g. [{"phone": "+1234567890", "type": "office"}].` },
  ...
  },
  {
    ...
    params: [
      { name: 'contact_id', type: 'string', required: true, description: `ID of the contact to delete.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'emails', type: 'string', required: false, description: `JSON array of email objects.` },
      { name: 'name', type: 'string', required: false, description: `New full name.` },
      { name: 'phones', type: 'string', required: false, description: `JSON array of phone objects.` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: '_limit', type: 'integer', required: false, description: `Maximum number of results to return.` },
      { name: '_skip', type: 'integer', required: false, description: `Number of results to skip (offset).` },
      { name: 'lead_id', type: 'string', required: false, description: `Filter contacts by lead ID.` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'type', type: 'string', required: true, description: `Field type: text, number, date, url, choices, etc.` },
    ],
  },
  {
    ...
    params: [
      { name: 'custom_field_id', type: 'string', required: true, description: `ID of the custom field to delete.` },
    ],
  },
  {
    ...
    params: [
      { name: 'custom_field_id', type: 'string', required: true, description: `ID of the custom field.` },
    ],
  },
  {
    ...
    params: [
      { name: 'custom_field_id', type: 'string', required: true, description: `ID of the custom field to update.` },
      { name: 'name', type: 'string', required: false, description: `New name for the custom field.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'lead_id', type: 'string', required: true, description: `ID of the lead for this email.` },
      { name: 'status', type: 'string', required: true, description: `Email status: inbox, draft, scheduled, outbox, sent.` },
      ...
      { name: 'contact_id', type: 'string', required: false, description: `ID of the contact this email is for.` },
      ...
      { name: 'to', type: 'string', required: false, description: `JSON array of recipient emails, e.g. [{"email": "jane@acme.com"}].` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'email_id', type: 'string', required: true, description: `ID of the email activity.` },
    ],
  },
  {
    ...
    params: [
      { name: 'email_id', type: 'string', required: true, description: `ID of the email to update.` },
      ...
      { name: 'status', type: 'string', required: false, description: `New email status: draft, scheduled, outbox, sent.` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'description', type: 'string', required: false, description: `Description or notes about the lead.` },
  ...
  },
  {
    ...
    params: [
      { name: 'lead_id', type: 'string', required: true, description: `ID of the lead to retrieve.` },
      { name: '_fields', type: 'string', required: false, description: `Comma-separated list of fields to return.` },
    ],
  },
  {
    ...
    params: [
      { name: 'destination', type: 'string', required: true, description: `ID of the lead to merge into (will be kept).` },
      { name: 'source', type: 'string', required: true, description: `ID of the lead to merge from (will be deleted).` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: '_fields', type: 'string', required: false, description: `Comma-separated list of fields to return.` },
      { name: '_limit', type: 'integer', required: false, description: `Maximum number of results to return.` },
      { name: '_order_by', type: 'string', required: false, description: `Field to sort by. Prefix with - for descending.` },
      { name: '_skip', type: 'integer', required: false, description: `Number of results to skip (offset).` },
      { name: 'query', type: 'string', required: false, description: `Full-text search query to filter leads.` },
    ],
  },
  {
    name: 'close_me_get',
  ...
  },
  {
    ...
    params: [
      { name: 'lead_id', type: 'string', required: true, description: `ID of the lead to attach this note to.` },
      { name: 'note', type: 'string', required: true, description: `Note body text (plain text).` },
      { name: 'contact_id', type: 'string', required: false, description: `ID of the contact this note relates to.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: '_skip', type: 'integer', required: false, description: `Number of results to skip (offset).` },
      { name: 'lead_id', type: 'string', required: false, description: `Filter by lead ID.` },
      { name: 'status_id', type: 'string', required: false, description: `Filter by opportunity status ID.` },
      { name: 'status_type', type: 'string', required: false, description: `Filter by status type: active, won, or lost.` },
      { name: 'user_id', type: 'string', required: false, description: `Filter by assigned user ID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'lead_id', type: 'string', required: true, description: `ID of the lead for this opportunity.` },
      { name: 'status_id', type: 'string', required: true, description: `ID of the opportunity status.` },
      { name: 'confidence', type: 'integer', required: false, description: `Win probability percentage (0-100).` },
      { name: 'date_won', type: 'string', required: false, description: `Date won (YYYY-MM-DD), set when status is won.` },
      { name: 'expected_date', type: 'string', required: false, description: `Expected close date (YYYY-MM-DD).` },
      { name: 'note', type: 'string', required: false, description: `Note about this opportunity.` },
      { name: 'value', type: 'integer', required: false, description: `Monetary value of the opportunity in cents.` },
      { name: 'value_currency', type: 'string', required: false, description: `Currency code, e.g. USD.` },
      { name: 'value_period', type: 'string', required: false, description: `Billing period: one_time, monthly, or annual.` },
    ],
  },
  {
    ...
    params: [
      { name: 'opportunity_id', type: 'string', required: true, description: `ID of the opportunity to delete.` },
    ],
  },
  {
    ...
    params: [
      { name: 'opportunity_id', type: 'string', required: true, description: `ID of the opportunity.` },
      { name: '_fields', type: 'string', required: false, description: `Comma-separated list of fields to return.` },
    ],
  },
  {
    ...
    params: [
      { name: 'opportunity_id', type: 'string', required: true, description: `ID of the opportunity to update.` },
      { name: 'confidence', type: 'integer', required: false, description: `Win probability (0-100).` },
      ...
      { name: 'value', type: 'integer', required: false, description: `Updated monetary value in cents.` },
      { name: 'value_currency', type: 'string', required: false, description: `Currency code, e.g. USD.` },
      { name: 'value_period', type: 'string', required: false, description: `Billing period: one_time, monthly, or annual.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'pipeline_id', type: 'string', required: true, description: `ID of the pipeline to delete.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'pipeline_id', type: 'string', required: true, description: `ID of the pipeline to update.` },
  ...
  },
  {
    ...
    params: [
      { name: 'contact_id', type: 'string', required: true, description: `ID of the contact to enroll.` },
      { name: 'sequence_id', type: 'string', required: true, description: `ID of the sequence to enroll in.` },
      { name: 'sender_account_id', type: 'string', required: false, description: `ID of the sender email account.` },
    ],
  },
  {
    ...
    params: [
      { name: 'subscription_id', type: 'string', required: true, description: `ID of the subscription.` },
    ],
  },
  {
    ...
    params: [
      { name: 'subscription_id', type: 'string', required: true, description: `ID of the subscription to update.` },
      { name: 'pause', type: 'boolean', required: false, description: `Set to true to pause the subscription, false to resume.` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'contact_id', type: 'string', required: false, description: `Filter by contact ID.` },
      { name: 'lead_id', type: 'string', required: false, description: `Filter by lead ID.` },
      { name: 'sequence_id', type: 'string', required: false, description: `Filter by sequence ID.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'lead_id', type: 'string', required: true, description: `ID of the lead for this SMS.` },
      { name: 'status', type: 'string', required: true, description: `SMS status: inbox, draft, scheduled, outbox, sent.` },
      { name: 'contact_id', type: 'string', required: false, description: `ID of the contact for this SMS.` },
      { name: 'local_phone', type: 'string', required: false, description: `Your local phone number to send from.` },
      { name: 'remote_phone', type: 'string', required: false, description: `Recipient phone number.` },
      { name: 'text', type: 'string', required: false, description: `Body text of the SMS message.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'lead_id', type: 'string', required: true, description: `ID of the lead to associate this task with.` },
      { name: '_type', type: 'string', required: false, description: `Task type, default is lead.` },
      { name: 'assigned_to', type: 'string', required: false, description: `User ID to assign the task to.` },
      { name: 'date', type: 'string', required: false, description: `Task due date (YYYY-MM-DD or ISO 8601).` },
      { name: 'is_complete', type: 'boolean', required: false, description: `Whether the task is already complete.` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'assigned_to', type: 'string', required: false, description: `New assigned user ID.` },
      { name: 'date', type: 'string', required: false, description: `New due date (YYYY-MM-DD).` },
      { name: 'is_complete', type: 'boolean', required: false, description: `Mark task as complete or incomplete.` },
  ...
  },
  {
    ...
    params: [
      { name: '_fields', type: 'string', required: false, description: `Comma-separated list of fields to return.` },
      { name: '_limit', type: 'integer', required: false, description: `Maximum number of results to return.` },
      { name: '_order_by', type: 'string', required: false, description: `Sort field. Prefix with - for descending.` },
      { name: '_skip', type: 'integer', required: false, description: `Number of results to skip (offset).` },
      { name: '_type', type: 'string', required: false, description: `Task type: lead, incoming_email, email, automated_email, outgoing_call.` },
      { name: 'assigned_to', type: 'string', required: false, description: `Filter by assigned user ID.` },
      { name: 'is_complete', type: 'boolean', required: false, description: `Filter by completion: true or false.` },
      { name: 'lead_id', type: 'string', required: false, description: `Filter by lead ID.` },
      { name: 'view', type: 'string', required: false, description: `Predefined view: inbox, future, or archive.` },
    ],
  },
  {
    name: 'close_user_get',
  ...
  },
  {
    ...
    params: [
      { name: 'events', type: 'string', required: true, description: `JSON array of event objects to subscribe to, e.g. [{"object_type":"lead","action":"created"}].` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'events', type: 'string', required: false, description: `New JSON array of event objects.` },
