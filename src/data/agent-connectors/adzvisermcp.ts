...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    params: [
      { name: 'workspace_name', type: 'string', required: false, description: `Optional workspace name to retrieve custom conversions for the Facebook Ads account in that workspace. If not provided, only standard metrics and breakdowns are returned.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'adzviser_request', type: 'object', required: false, description: `Optional structured request body specifying platforms, metrics, breakdowns, date ranges, and filters for the report.` },
    ],
  },
]
