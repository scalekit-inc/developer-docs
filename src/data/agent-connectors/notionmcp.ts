  ...
  },
  {
    ...
    params: [
      ...
      { name: 'name', type: 'string', required: true, description: `The name of the view.` },
      {
        ...
        type: 'string',
        required: true,
        description: `The view type. Accepted values: table, board, calendar, gallery, list, timeline.`,
      },
      {
        name: 'configure',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'boolean',
        required: false,
        description: `Set to true to include discussion threads in the response.`,
      },
      {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'boolean',
        required: false,
        description: `Set to true to return all comment blocks, not just the first.`,
      },
      {
        name: 'include_resolved',
        type: 'boolean',
        required: false,
        description: `Set to true to include resolved discussions in the response.`,
      },
    ],
  },
  {
...
Alternatively, the query can be a substring or keyword to find users by matching against their name or email address. For example: "john" or "john@example.com"`,
      ...
      {
        name: 'content_search_mode',
        type: 'string',
        required: false,
        description: `How to search within page content. Accepted values: keyword, semantic.`,
      },
      {
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `The search mode. Accepted values: semantic, keyword.`,
      },
      {
        name: 'teamspace_id',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'boolean',
        required: false,
        description: `Set to true to move the data source to the trash.`,
      },
      {
        name: 'is_inline',
        type: 'boolean',
        required: false,
        description: `Set to true to make the database display inline within a page.`,
      },
      {
        name: 'statements',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The update operation to perform. Accepted values: update_properties, update_content, replace_content, insert_content, apply_template, update_verification.`,
      },
      {
        name: 'page_id',
        type: 'string',
      ...
      },
      {
        ...
        type: 'boolean',
        required: false,
        description: `Set to true to confirm deletion of child pages or databases when replacing content.`,
      },
      {
        name: 'content',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `The verification state to set. Accepted values: verified, unverified.`,
      },
    ],
  },
  {
