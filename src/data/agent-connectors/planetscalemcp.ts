  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'array',
        required: false,
        description: `Request specific metric fields from the API (e.g. ['query', 'count', 'rowsRead', 'rowsAffected', 'rowsReadPerReturned', 'egressBytes', 'indexes', 'maxShardQueries']). Ignored when fingerprint is provided.`,
      },
      {
        name: 'fingerprint',
        type: 'string',
