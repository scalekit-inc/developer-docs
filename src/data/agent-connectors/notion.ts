...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'block_id', type: 'string', required: true, description: `The ID of the block to delete` },
    ],
  },
  {
    ...
    params: [
      { name: 'block_id', type: 'string', required: true, description: `The ID of the block to update` },
      { name: 'text', type: 'string', required: true, description: `New text content for the block` },
      { name: 'type', type: 'string', required: true, description: `The block type (must match the existing block type)` },
      { name: 'language', type: 'string', required: false, description: `Programming language for code blocks` },
    ],
  },
  {
    ...
    params: [
      { name: 'comment', type: 'object', required: true, description: `Comment object containing a rich_text array. Example: {"rich_text":[{"type":"text","text":{"content":"Hello"}}]}` },
      { name: 'discussion_id', type: 'string', required: false, description: `Existing discussion thread ID to reply to.` },
      { name: 'notion_version', type: 'string', required: false, description: `Optional override for the Notion-Version header (e.g., 2022-06-28).` },
      { name: 'parent', type: 'object', required: false, description: `Parent object for a new top-level comment. Shape: {"page_id":"<uuid>"}.` },
      { name: 'schema_version', type: 'string', required: false, description: `Internal override for schema version.` },
      { name: 'tool_version', type: 'string', required: false, description: `Internal override for tool implementation version.` },
    ],
  },
  {
    ...
    params: [
      { name: 'comment_id', type: 'string', required: true, description: `The identifier of the comment to retrieve (hyphenated UUID). Obtain it from Create-Comment responses or from a prior List-Comments call.` },
      { name: 'notion_version', type: 'string', required: false, description: `Optional Notion-Version header override (e.g., 2022-06-28).` },
      { name: 'schema_version', type: 'string', required: false, description: `Internal override for schema version.` },
      { name: 'tool_version', type: 'string', required: false, description: `Internal override for tool implementation version.` },
    ],
  },
  {
    ...
    params: [
      { name: 'block_id', type: 'string', required: true, description: `Target Notion block (or page) ID to fetch comments for. Use a hyphenated UUID.` },
      { name: 'notion_version', type: 'string', required: false, description: `Optional Notion-Version header override (e.g., 2022-06-28).` },
      { name: 'page_size', type: 'integer', required: false, description: `Maximum number of comments to return (1–100).` },
      { name: 'schema_version', type: 'string', required: false, description: `Internal override for schema version.` },
      { name: 'start_cursor', type: 'string', required: false, description: `Cursor to fetch the next page of results.` },
      { name: 'tool_version', type: 'string', required: false, description: `Internal override for tool implementation version.` },
    ],
  },
  {
    ...
    params: [
      { name: 'page_size', type: 'integer', required: false, description: `Max number of results to return (1–100)` },
      ...
      { name: 'start_cursor', type: 'string', required: false, description: `Cursor for pagination; pass the previous response's next_cursor` },
  ...
  },
  {
    ...
    params: [
      { name: 'database_id', type: 'string', required: true, description: `The target database ID in UUID format with hyphens.` },
    ],
  },
  {
    ...
    params: [
      { name: 'data_source_id', type: 'string', required: true, description: `The ID of the data source to insert a row into. Retrieve from notion_database_fetch response under data_sources[].id.` },
      { name: 'properties', type: 'object', required: true, description: `Object mapping column names (or property ids) to property values. Example: {"title": {"title": [{"text": {"content": "Task A"}}]}, "Status": {"select": {"name": "Todo"}}}` },
      { name: 'child_blocks', type: 'array', required: false, description: `Optional array of Notion blocks to append as page content.` },
      { name: 'cover', type: 'object', required: false, description: `Optional page cover object. Example: {"type":"external","external":{"url":"https://example.com/cover.jpg"}}` },
      { name: 'icon', type: 'object', required: false, description: `Optional page icon object. Example: {"type":"emoji","emoji":"📝"}` },
    ],
  },
  {
    ...
    params: [
      { name: 'data_source_id', type: 'string', required: true, description: `The ID of the data source to query. Retrieve from notion_database_fetch response under data_sources[].id.` },
      { name: 'filter', type: 'object', required: false, description: `Notion filter object to narrow results. Example: {"property": "Status", "select": {"equals": "Done"}}. Supports compound filters with 'and'/'or' arrays.` },
      { name: 'page_size', type: 'integer', required: false, description: `Maximum number of rows to return (1-100).` },
      { name: 'sorts', type: 'array', required: false, description: `Order the results. Each item must include either property or timestamp, plus direction.` },
      { name: 'start_cursor', type: 'string', required: false, description: `Cursor to fetch the next page of results.` },
    ],
  },
  {
    ...
    params: [
      { name: 'parent', type: 'object', required: true, description: `Parent object specifying the page under which the database is created. Example: {"page_id": "2561ab6c-418b-8072-beec-c4779fa811cf"}` },
      { name: 'properties', type: 'object', required: true, description: `Database schema object defining properties (columns). Example: {"Name": {"title": {}}, "Status": {"select": {"options": [{"name": "Todo"}, {"name": "Doing"}, {"name": "Done"}]}}}` },
      { name: 'title', type: 'array', required: true, description: `Database title as a Notion rich_text array.` },
      { name: 'schema_version', type: 'string', required: false, description: `Internal override for schema version.` },
      { name: 'tool_version', type: 'string', required: false, description: `Internal override for tool implementation version.` },
    ],
  },
...
- Runtime note: the executor/host should synthesize \`parent = {"database_id": database_id}\` before sending to Notion.`,
    params: [
      { name: 'database_id', type: 'string', required: true, description: `Target database ID (hyphenated UUID).` },
      { name: 'properties', type: 'object', required: true, description: `Object mapping **column names (or property ids)** to **property values**.
...
Example:
{
  ...
  "Due": { "date": { "start": "2025-09-01" } }
      ...
      { name: '_parent', type: 'object', required: false, description: `Computed by host: \`{ "database_id": "<database_id>" }\`. Do not supply manually.` },
      { name: 'child_blocks', type: 'array', required: false, description: `Optional array of Notion blocks to append as page content (paragraph, heading, to_do, etc.).` },
      { name: 'cover', type: 'object', required: false, description: `Optional page cover object. Example external: {"type":"external","external":{"url":"https://example.com/cover.jpg"}}.` },
      { name: 'icon', type: 'object', required: false, description: `Optional page icon object. Examples: {"type":"emoji","emoji":"📝"} or {"type":"external","external":{"url":"https://..."}}.` },
      { name: 'schema_version', type: 'string', required: false, description: `Optional schema version override.` },
      { name: 'tool_version', type: 'string', required: false, description: `Optional tool version override.` },
    ],
  },
  {
    ...
    params: [
      { name: 'database_id', type: 'string', required: true, description: `Target database ID (hyphenated UUID).` },
      { name: 'property_id', type: 'string', required: false, description: `property ID to filter results by a specific property. get the property id by querying database.` },
      { name: 'schema_version', type: 'string', required: false, description: `Optional schema version override.` },
      { name: 'tool_version', type: 'string', required: false, description: `Optional tool version override.` },
    ],
  },
  ...
  },
  {
    ...
    params: [
      { name: 'database_id', type: 'string', required: true, description: `The ID of the database to update` },
      { name: 'description', type: 'string', required: false, description: `New description for the database` },
      { name: 'properties', type: 'object', required: false, description: `Property schema updates (add, rename, or reconfigure columns)` },
  ...
  },
  {
    ...
    params: [
      { name: 'block_id', type: 'string', required: true, description: `The ID of the page or block to append content to` },
      { name: 'blocks', type: 'array', required: true, description: `Array of blocks to append. Each block uses a simplified format with 'type' and 'text' fields — NOT the raw Notion API format. Do not pass Notion block objects with rich_text arrays.` },
    ],
  },
  {
    ...
    params: [
      { name: 'block_id', type: 'string', required: true, description: `The ID of the page or block whose children to retrieve` },
      { name: 'page_size', type: 'number', required: false, description: `Number of blocks to return (max 100)` },
      { name: 'start_cursor', type: 'string', required: false, description: `Cursor for pagination from a previous response` },
    ],
  },
  {
...
- If parent_page_id is provided → properties are optional`,
    params: [
      { name: '_parent', type: 'object', required: false, description: `Computed by the executor: {"database_id": "..."} OR {"page_id": "..."} derived from database_id/parent_page_id.` },
      { name: 'child_blocks', type: 'array', required: false, description: `Optional blocks to add as page content (children).` },
      { name: 'cover', type: 'object', required: false, description: `Optional page cover object.` },
      { name: 'database_id', type: 'string', required: false, description: `Create a page as a new row in this database (hyphenated UUID). Extract from the database URL (last 32 chars → hyphenate 8-4-4-4-12).` },
      { name: 'icon', type: 'object', required: false, description: `Optional page icon object.` },
      { name: 'notion_version', type: 'string', required: false, description: `Optional Notion-Version header override.` },
      { name: 'parent_page_id', type: 'string', required: false, description: `Create a child page under this page (hyphenated UUID). Extract from the parent page URL.` },
      { name: 'properties', type: 'object', required: false, description: `For database rows, supply property values keyed by property name (or id). For title properties, the key must be "title".
...
Example (database row):
{
  ...
  },
  {
    ...
    params: [
      { name: 'page_id', type: 'string', required: true, description: `The ID of the Notion page to retrieve` },
    ],
  },
  {
    ...
    params: [
      { name: 'page_size', type: 'integer', required: false, description: `Maximum number of pages to return (1–100).` },
      { name: 'query', type: 'string', required: false, description: `Text to search for across Notion pages.` },
      { name: 'sort_direction', type: 'string', required: false, description: `Direction to sort results.` },
      { name: 'sort_timestamp', type: 'string', required: false, description: `Timestamp field to sort results by.` },
      { name: 'start_cursor', type: 'string', required: false, description: `Cursor to fetch the next page of results.` },
    ],
  },
  {
    ...
    params: [
      { name: 'page_id', type: 'string', required: true, description: `The ID of the Notion page to update` },
      { name: 'archived', type: 'boolean', required: false, description: `Set to true to archive (delete) the page, false to unarchive it` },
      ...
      { name: 'properties', type: 'object', required: false, description: `Page properties to update using Notion property value shapes` },
    ],
  },
  {
    ...
    params: [
      { name: 'page_size', type: 'number', required: false, description: `Number of users to return (max 100)` },
      { name: 'start_cursor', type: 'string', required: false, description: `Cursor for pagination from a previous response` },
    ],
  },
]
