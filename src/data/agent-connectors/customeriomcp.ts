    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `API path including placeholders, e.g. '/v1/environments/{environment_id}/campaigns/{campaign_id}'. Placeholders are substituted from params.`,
      },
      {
        name: 'dry_run',
        type: 'boolean',
        required: false,
        description: `Validate and return the request without executing it.`,
      },
      {
        name: 'jq',
        type: 'string',
        required: false,
        description: `gojq expression to filter the response before returning.`,
      },
      {
        name: 'params',
        type: 'object',
        required: false,
        description: `Parameters object. Keys matching path placeholders are substituted; remaining keys become the query string.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `API path including placeholders, e.g. '/v1/environments/{environment_id}/campaigns'. Placeholders are substituted from params.`,
      },
      {
        name: 'dry_run',
        type: 'boolean',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `gojq expression to filter the response before returning. Use to trim large responses.`,
      },
      ...
      { name: 'page', type: 'number', required: false, description: `Page number (1-indexed).` },
      {
        ...
        type: 'boolean',
        required: false,
        description: `Auto-paginate and return NDJSON for the full dataset.`,
      },
      {
        name: 'params',
        type: 'object',
    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `One of: '' (list resources), 'campaigns' (resource), 'campaigns.list' (resource.method), 'GET /v1/...' (method + path), or '/v1/...' (all methods for a path).`,
      },
      {
        name: 'refresh',
        type: 'boolean',
        required: false,
        description: `Force re-download of API specs.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'boolean',
        required: false,
        description: `Force re-download of skills.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Skill path, e.g. 'campaigns' or 'campaigns/examples'. See cio_skills_list for available paths.`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `HTTP method: POST, PUT, or PATCH. Defaults to POST.`,
      },
      {
        name: 'params',
        type: 'object',
