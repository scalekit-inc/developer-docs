    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The natural-language request or feedback message to send to the assistant.`,
      },
      {
        name: 'async',
        type: 'boolean',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Controls how the task runs; use async for long-running polling-based tasks.`,
      },
      {
        name: 'long_running',
        type: 'boolean',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The unique identifier of the async task to retrieve.`,
      },
      {
        name: 'cursor',
        type: 'integer',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The user's approval decision for the pending plan.`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'array',
        required: false,
        description: `Categories of harmful content being reported; required when flagged is true.`,
      },
      {
        name: 'flagged',
        type: 'boolean',
      ...
      },
      {
        ...
        type: 'array',
        required: false,
        description: `Selected feedback option labels chosen from the widget's predefined list.`,
      },
      {
        name: 'query',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `The user's overall sentiment rating for the interaction.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The name of the Customer Journey Analytics dataview to set as the active context.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The technical name (one word) of the Adobe Experience Platform sandbox to set as the active context.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The display name or IMS Org ID of the Adobe organization to switch to.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `Action to perform on preferences; get returns current settings, clear removes all saved preferences.`,
      },
    ],
  },
]
