...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    params: [
      { name: 'updates', type: 'array', required: true, description: `No description.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'url', type: 'string', required: true, description: `No description.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'insertAfterBlockUuid', type: 'string', required: true, description: `No description.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'currentPageNumber', type: 'number', required: false, description: `No description.` },
  ...
  },
  {
    ...
    params: [
      { name: 'layout', type: 'string', required: true, description: `No description.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'hasPartialSubmissions', type: 'boolean', required: false, description: `No description.` },
      ...
      { name: 'metaSiteFaviconUrl', type: 'string', required: false, description: `No description.` },
      ...
      { name: 'redirectOnCompletionUrl', type: 'string', required: false, description: `No description.` },
      ...
      { name: 'submissionsDataRetention', type: 'string', required: false, description: `No description.` },
      { name: 'submissionsLimit', type: 'string', required: false, description: `No description.` },
      { name: 'uniqueSubmissionKey', type: 'string', required: false, description: `No description.` },
