    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The Context7-compatible library ID (e.g. '/vercel/next.js', '/mongodb/docs')`,
      },
      {
        name: 'query',
        type: 'string',
        required: true,
        description: `The user's question or task to retrieve relevant documentation for`,
      },
      {
        name: 'schema_version',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The name of the library or framework to search for (e.g. 'Next.js', 'React', 'MongoDB')`,
      },
      {
        name: 'query',
        type: 'string',
        required: true,
        description: `The user's question or task to help rank library results by relevance`,
      },
      {
        name: 'schema_version',
        type: 'string',
