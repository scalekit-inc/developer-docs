...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `One or more comma-separated CoinMarketCap cryptocurrency IDs.` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `CoinMarketCap cryptocurrency ID (e.g. Bitcoin is 1).` },
      { name: 'limit', type: 'integer', required: false, description: `Number of news articles to return. Default is 10, max is 20.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `CoinMarketCap cryptocurrency ID (e.g. Bitcoin is 1).` },
      { name: 'includeFields', type: 'array', required: false, description: `List of field names to include in the response. If omitted, all fields are returned.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `CoinMarketCap cryptocurrency ID to scope the search to a specific coin.` },
      { name: 'prompt', type: 'string', required: true, description: `Search query about the cryptocurrency in English.` },
    ],
  },
  {
    ...
    params: [
      { name: 'query', type: 'string', required: true, description: `Cryptocurrency name, symbol, or slug to search for.` },
      { name: 'limit', type: 'integer', required: false, description: `Maximum number of results to return. Default is 3, max is 5.` },
    ],
  },
  {
