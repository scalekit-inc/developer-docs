    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `ID of the Slack channel. Get it from slack_search_channels.`,
      },
      {
        name: 'emoji',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `Timestamp of the message. Get it from slack_read_channel or slack_read_thread.`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `Display name shown at the top of the canvas.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `Name for the new channel (lowercase, hyphens, max 80 chars). Omit to create a DM instead.`,
      },
      {
        name: 'is_private',
        type: 'boolean',
      ...
      },
      {
        ...
        type: 'array',
        required: false,
        description: `Slack user IDs to invite. 1 ID = DM, 2–8 IDs = group DM, up to 1000 IDs for a channel.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Level of detail in the response. Accepted values: detailed, concise, ids_only.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Only return messages before this Unix timestamp (e.g. 1640995200.000000).`,
      },
      {
        name: 'limit',
        type: 'integer',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Only return messages after this Unix timestamp (e.g. 1609459200.000000).`,
      },
      {
        name: 'response_format',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `ID of the Slack file. Get it from slack_search_public.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `ID of the Slack user. Get it from slack_search_users.`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'integer',
        required: true,
        description: `Unix timestamp (seconds) for when to send the scheduled message.`,
      },
      {
  ...
  },
  {
    ...
    params: [
      { name: 'query', type: 'string', required: true, description: `Search query string.` },
      {
        ...
        type: 'string',
        required: false,
        description: `Comma-separated channel types to filter. Accepted values: public_channel, private_channel, mpim, im.`,
      },
      {
        name: 'cursor',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Comma-separated content types to search. Accepted values: messages, files.`,
      },
      {
        name: 'context_channel_id',
        type: 'string',
        required: false,
        description: `Channel ID to boost relevance of results from that channel.`,
      },
      {
        name: 'cursor',
        type: 'string',
      ...
      },
      {
        ...
        type: 'boolean',
        required: false,
        description: `Include surrounding context messages for each result. Defaults to true.`,
      },
      {
        name: 'limit',
        type: 'integer',
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'message', type: 'string', required: true, description: `Add a message` },
      {
        ...
        type: 'string',
        required: false,
        description: `ID of a previously saved draft to delete after sending.`,
      },
      {
        name: 'reply_broadcast',
        type: 'boolean',
