...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'query', type: 'string', required: true, description: `A single, well-formed natural-language query to search Deepgram knowledge sources. Must be a complete sentence.` },
    ],
  },
]
