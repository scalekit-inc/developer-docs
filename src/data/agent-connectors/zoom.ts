...
export const tools: Tool[] = [
  {
    ...
    params: [
      ...
      { name: 'members', type: 'array', required: false, description: `List of member objects with email field to add to the channel` },
      { name: 'type', type: 'integer', required: false, description: `Channel type: 1=private, 2=private with external users, 3=public, 4=new external` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'channel_id', type: 'string', required: true, description: `The channel ID` },
      { name: 'members', type: 'array', required: true, description: `Array of member objects with email field` },
    ],
  },
  {
    ...
    params: [
      { name: 'channel_id', type: 'string', required: true, description: `The channel ID` },
      { name: 'member_id', type: 'string', required: true, description: `The member ID or email to remove` },
    ],
  },
  {
    ...
    params: [
      { name: 'channel_id', type: 'string', required: true, description: `The channel ID` },
      { name: 'next_page_token', type: 'string', required: false, description: `Token for next page of results` },
      { name: 'page_size', type: 'integer', required: false, description: `Number of members per page (max 50)` },
    ],
  },
  {
    ...
    params: [
      { name: 'channel_id', type: 'string', required: true, description: `The channel ID to list messages from` },
      { name: 'user_id', type: 'string', required: true, description: `The user ID or 'me' for the authenticated user` },
      { name: 'date', type: 'string', required: false, description: `Date to retrieve messages for (yyyy-MM-dd). Defaults to today.` },
      { name: 'next_page_token', type: 'string', required: false, description: `Token for next page` },
      { name: 'page_size', type: 'integer', required: false, description: `Number of messages per page (max 50)` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'next_page_token', type: 'string', required: false, description: `Token for next page` },
      { name: 'page_size', type: 'integer', required: false, description: `Number of channels per page (max 50)` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'to_channel', type: 'string', required: false, description: `Channel ID to send the message to` },
      { name: 'to_jid', type: 'string', required: false, description: `JID of the user to send a direct message to` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'user_id', type: 'string', required: true, description: `User ID or 'me' for the authenticated user` },
      { name: 'agenda', type: 'string', required: false, description: `Meeting description or agenda` },
      { name: 'duration', type: 'integer', required: false, description: `Meeting duration in minutes` },
      { name: 'password', type: 'string', required: false, description: `Meeting passcode (max 10 chars)` },
      { name: 'start_time', type: 'string', required: false, description: `Meeting start time in ISO 8601 UTC format` },
      { name: 'timezone', type: 'string', required: false, description: `Timezone for the meeting (e.g. America/New_York)` },
      { name: 'type', type: 'integer', required: false, description: `1=Instant, 2=Scheduled, 3=Recurring no fixed time, 8=Recurring fixed time` },
    ],
  },
  {
    ...
    params: [
      { name: 'meeting_id', type: 'string', required: true, description: `The meeting ID to delete` },
      { name: 'occurrence_id', type: 'string', required: false, description: `Occurrence ID for recurring meeting instances` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'action', type: 'string', required: false, description: `trash (move to trash, default) or delete (permanent)` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'first_name', type: 'string', required: true, description: `Registrant's first name` },
      { name: 'meeting_id', type: 'string', required: true, description: `The meeting ID` },
      { name: 'last_name', type: 'string', required: false, description: `Registrant's last name` },
      { name: 'occurrence_ids', type: 'string', required: false, description: `Comma-separated occurrence IDs for recurring meetings` },
    ],
  },
  {
    ...
    params: [
      { name: 'meeting_id', type: 'string', required: true, description: `The meeting ID` },
      { name: 'next_page_token', type: 'string', required: false, description: `Token for next page` },
      { name: 'occurrence_id', type: 'string', required: false, description: `Occurrence ID for recurring meetings` },
      { name: 'page_size', type: 'integer', required: false, description: `Number of records per page (max 300)` },
      { name: 'status', type: 'string', required: false, description: `Filter by status: pending, approved, denied` },
    ],
  },
  {
    ...
    params: [
      { name: 'action', type: 'string', required: true, description: `Action to perform: 'end' to end the meeting` },
      { name: 'meeting_id', type: 'string', required: true, description: `The meeting ID` },
    ],
  },
  {
    ...
    params: [
      { name: 'meeting_id', type: 'string', required: true, description: `The meeting ID to update` },
      ...
      { name: 'start_time', type: 'string', required: false, description: `New start time in ISO 8601 UTC format` },
      { name: 'timezone', type: 'string', required: false, description: `Timezone for the meeting` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'next_page_token', type: 'string', required: false, description: `Token for next page of results` },
      { name: 'page_size', type: 'integer', required: false, description: `Number of records per page (max 300)` },
      { name: 'type', type: 'string', required: false, description: `Filter: scheduled, live, upcoming, upcoming_meetings, previous_meetings` },
    ],
  },
  {
    ...
    params: [
      { name: 'meeting_uuid', type: 'string', required: true, description: `The meeting UUID (double-encode if contains / or //)` },
    ],
  },
  {
    ...
    params: [
      { name: 'user_id', type: 'string', required: true, description: `User ID or 'me' for the authenticated user` },
      { name: 'from', type: 'string', required: false, description: `Start date in yyyy-MM-dd format (default: current date minus 1 month)` },
      { name: 'mc', type: 'string', required: false, description: `Set to true to retrieve recordings from Zoom Room` },
      { name: 'next_page_token', type: 'string', required: false, description: `Token for next page` },
      { name: 'page_size', type: 'integer', required: false, description: `Number of records per page (max 300)` },
      { name: 'to', type: 'string', required: false, description: `End date in yyyy-MM-dd format (max 1 month range)` },
      { name: 'trash', type: 'boolean', required: false, description: `Set to true to list trashed recordings` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'action', type: 'string', required: false, description: `disassociate (default) or delete` },
      { name: 'transfer_email', type: 'string', required: false, description: `Email to transfer data to before deletion` },
    ],
  },
  {
    name: 'zoom_user_get',
