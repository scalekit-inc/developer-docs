    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `One or more URLs to fetch. Batch multiple URLs in a single call.`,
      },
      {
        name: 'maxCharacters',
        type: 'number',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Natural language description of the ideal page. Optionally include category:people or category:company to focus results.`,
      },
      {
        name: 'numResults',
        type: 'number',
