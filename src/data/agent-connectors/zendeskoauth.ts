...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: `Update a Help Center article's title, promoted status, position, comments setting, labels, and content tags.`,
    params: [
      {
        name: 'article_id',
        type: 'number',
      ...
      { name: 'title', type: 'string', required: false, description: `New title for the article.` },
    ],
  },
  {
