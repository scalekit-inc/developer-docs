    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The group ID the object belongs to.`,
      },
      {
        name: 'objectId',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'object',
        required: true,
        description: `Filter criteria. Use field names as keys with operator objects as values. Example: {"name": {"contains": "Acme"}}`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'object',
        required: true,
        description: `Filter criteria keyed by field name with operator objects.`,
      },
      {
        name: 'groupId',
        type: 'string',
        required: true,
        description: `The group ID to search within.`,
      },
      {
        name: 'objectType',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'object',
        required: true,
        description: `Filter criteria. Use field names as keys with operator objects as values. Example: {"name": {"contains": "Jane"}}`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'object',
        required: false,
        description: `Custom field values to update, keyed by field name.`,
      },
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `The type of custom object to update.`,
      },
      {
        name: 'customFields',
        type: 'object',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Updated object name or title.`,
      },
    ],
  },
  {
