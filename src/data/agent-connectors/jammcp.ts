    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Jam identifier — a UUID or a jam.dev URL`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      {
        name: 'playbackRelativeTimestamp',
        type: 'number',
        required: false,
        description: `Optional timestamp in milliseconds relative to the start of the media playback. When provided, the comment will be linked to that specific point in the video/replay.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Optional filter to limit logs to a specific log level (error, warn, info, log, debug)`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Filter by content type (e.g., 'application/json')`,
      },
      {
        name: 'host',
        type: 'string',
      ...
      },
      {
        ...
        type: 'number',
        required: false,
        description: `Filter by HTTP status code (e.g., 500) or range (e.g., '4xx', '5xx')`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `Cursor for forward pagination (folder ID)`,
      },
      {
        name: 'limit',
        type: 'number',
    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `Cursor for forward pagination (Jam ID)`,
      },
      {
        name: 'author',
        type: 'string',
        required: false,
        description: `Author filter: "me", user name, email, or user ID`,
      },
      {
        name: 'createdAt',
        type: 'string',
        required: false,
        description: `Filter by creation date: ISO date string or ISO 8601 duration (e.g., "-P7D" for last 7 days)`,
      },
      {
        name: 'folder',
        type: 'string',
        required: false,
        description: `Folder filter: folder name, folder ID, folder short ID, or "root" for unfiled Jams`,
      },
      {
        name: 'limit',
        type: 'number',
      ...
      { name: 'orderBy', type: 'string', required: false, description: `Sort order field` },
      {
        ...
        type: 'string',
        required: false,
        description: `Text search query to filter Jams by title or description`,
      },
      { name: 'type', type: 'string', required: false, description: `Filter by Jam type` },
      {
        ...
        type: 'string',
        required: false,
        description: `Filter by original page URL (partial match, case-insensitive)`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `Cursor for forward pagination (user ID)`,
      },
      {
        name: 'limit',
        type: 'number',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Search string containing a UUID or a jam.dev URL (e.g., https://jam.dev/c/{uuid})`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Target folder: folder name, folder ID, folder short ID, or "root" to move to root level`,
      },
    ],
  },
]
