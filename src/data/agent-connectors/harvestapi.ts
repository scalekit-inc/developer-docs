...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `LinkedIn Geo ID for location filtering. Overrides the location param. Use /linkedin/geo-id-search to find IDs.`,
      },
      {
        name: 'industry_id',
        type: 'string',
        required: false,
        description: `LinkedIn industry ID(s), comma-separated. Full list at https://github.com/HarvestAPI/linkedin-industry-codes-v2.`,
      },
      {
        name: 'location',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      {
        name: 'company_headquarter_locations',
        type: 'string',
        required: false,
        description: `Company headquarter location text, comma-separated (max 70).`,
      },
      {
        name: 'current_companies',
        type: 'string',
      ...
      {
        name: 'exclude_company_headquarter_locations',
        type: 'string',
        required: false,
        description: `Company headquarter locations to exclude, comma-separated (max 70).`,
      },
      {
        name: 'exclude_current_companies',
        type: 'string',
        required: false,
        description: `Current companies to exclude, comma-separated (max 50).`,
      },
      {
        name: 'exclude_current_job_titles',
        type: 'string',
        required: false,
        description: `Current job titles to exclude, comma-separated (max 70).`,
      },
      {
        name: 'exclude_function_ids',
        type: 'string',
        required: false,
        description: `Job function IDs to exclude, comma-separated (max 30).`,
      },
      {
        name: 'exclude_geo_ids',
        type: 'string',
        required: false,
        description: `LinkedIn Geo IDs to exclude, comma-separated (max 70).`,
      },
      {
        name: 'exclude_industry_ids',
        type: 'string',
        required: false,
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Job function IDs, comma-separated.`,
      },
      {
        name: 'geo_ids',
        type: 'string',
        required: false,
        description: `LinkedIn Geo IDs, comma-separated. Overrides the locations param. Use /linkedin/geo-id-search to look up IDs.`,
      },
      {
        name: 'industry_ids',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Past company IDs or LinkedIn URLs, comma-separated (max 50).`,
      },
      {
        name: 'past_job_titles',
        type: 'string',
        required: false,
        description: `Past job titles, comma-separated (max 70).`,
      },
      {
        name: 'posted_on_linkedin',
        type: 'boolean',
        required: false,
        description: `When true, returns only profiles who posted on LinkedIn in the last 30 days.`,
      },
      {
        name: 'profile_languages',
        type: 'string',
        required: false,
        description: `Profile languages, comma-separated (e.g. 'en,de').`,
      },
      {
        name: 'recently_changed_jobs',
        type: 'boolean',
        required: false,
        description: `When true, returns only profiles who changed jobs in the last 90 days.`,
      },
      {
        name: 'required_account_id',
        type: 'string',
        required: false,
        description: `Specify which private pool account to use for this request (if you have a private pool).`,
      },
      {
        name: 'sales_nav_url',
        type: 'string',
        required: false,
        description: `LinkedIn Sales Navigator search URL. Overrides all other search params except page.`,
      },
      {
        name: 'schools',
        type: 'string',
        required: false,
        description: `School IDs or LinkedIn URLs, comma-separated (max 50).`,
      },
      {
        name: 'search',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Session ID to ensure consistent results across paginated requests from the same resource.`,
      },
      {
        name: 'use_private_pool',
        type: 'boolean',
        required: false,
        description: `When true, uses your private pool of resources (if available).`,
      },
      {
        name: 'years_at_current_company_ids',
        type: 'string',
        required: false,
        description: `Years at current company filter IDs, comma-separated.`,
      },
      {
        name: 'years_of_experience_ids',
        type: 'string',
        required: false,
        description: `Years of experience filter IDs, comma-separated.`,
      },
    ],
  },
  {
