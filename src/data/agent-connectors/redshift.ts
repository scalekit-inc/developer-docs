    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Name of the table to describe. Must be non-empty.`,
      },
      {
      ...
      },
      {
        ...
        type: 'integer',
        required: false,
        description: `Maximum number of columns to return per page.`,
      },
      {
        name: 'next_token',
        type: 'string',
        required: false,
        description: `Pagination cursor from a previous redshift_describe_table response.`,
      },
      {
        name: 'schema',
        type: 'string',
        required: false,
        description: `Schema name that contains the table.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `SQL statement to execute. Must be non-empty.`,
      },
      {
        name: 'statement_name',
        type: 'string',
        required: false,
        description: `Optional label for the statement, echoed back by DescribeStatement for tracking purposes.`,
      },
      {
        name: 'with_event',
        type: 'boolean',
        required: false,
        description: `If true, AWS publishes an EventBridge event when the statement completes.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The statement ID returned by redshift_execute_sql. Must be non-empty.`,
      },
      {
        name: 'next_token',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Pagination cursor from a previous redshift_list_schemas response.`,
      },
      {
        name: 'schema_pattern',
        type: 'string',
        required: false,
        description: `LIKE pattern to filter schemas (e.g., public, my_schema%).`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Pagination cursor from a previous redshift_list_statements response.`,
      },
      {
        name: 'role_level',
        type: 'boolean',
        required: false,
        description: `When true, lists all statements run by the IAM role rather than just the current session.`,
      },
      {
        name: 'statement_name',
        type: 'string',
        required: false,
        description: `Filter statements by name label.`,
      },
      {
        name: 'status',
        type: 'string',
        required: false,
        description: `Filter by execution status (e.g., FINISHED, FAILED, ABORTED, PICKED, STARTED, SUBMITTED).`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Pagination cursor from a previous redshift_list_tables response.`,
      },
      {
        name: 'schema_pattern',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `LIKE pattern to filter tables (e.g., orders, user%).`,
      },
    ],
  },
]
