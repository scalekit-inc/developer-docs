    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The completed resolution_id returned by resolve_sample_metadata.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The job_id returned by analyze_gene_expression.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Natural language description of the experiment, e.g. "heart vs liver cells" or "KRAS knockout vs control in lung adenocarcinoma". Required unless \`resolution_id\` is provided to poll a previously-started resolution.`,
      },
      {
        name: 'resolution_id',
        type: 'string',
        required: false,
        description: `Resolution identifier from a previous response with status 'resolving'. When provided, polls that in-flight resolution and \`prompt\` may be omitted.`,
      },
    ],
  },
]
