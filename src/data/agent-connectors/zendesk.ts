...
export const tools: Tool[] = [
  {
    name: 'zendesk_attachment_delete',
  ...
  {
    name: 'zendesk_automation_create',
  ...
  {
    name: 'zendesk_automation_delete',
  ...
  {
    name: 'zendesk_automation_update',
  ...
  {
    name: 'zendesk_business_hours_schedules_list',
  ...
  {
    name: 'zendesk_group_membership_create',
  ...
  {
    name: 'zendesk_group_membership_delete',
  ...
  {
    name: 'zendesk_group_memberships_list',
  ...
  {
    name: 'zendesk_omnichannel_agent_statuses_list',
  ...
  {
    name: 'zendesk_omnichannel_agents_list',
  ...
  {
    name: 'zendesk_organization_create',
  ...
  {
    name: 'zendesk_organization_delete',
  ...
  {
    name: 'zendesk_organization_membership_create',
  ...
  {
    name: 'zendesk_organization_membership_delete',
  ...
  {
    name: 'zendesk_organization_memberships_list',
  ...
  {
    name: 'zendesk_organization_tickets_list',
  ...
  {
    name: 'zendesk_organization_update',
  ...
  {
    name: 'zendesk_organizations_autocomplete',
  ...
  {
    name: 'zendesk_organizations_search',
  ...
  {
    name: 'zendesk_support_addresses_list',
  ...
  {
    name: 'zendesk_suspended_ticket_recover',
  ...
  {
    name: 'zendesk_suspended_tickets_list',
  ...
  {
    name: 'zendesk_talk_account_overview',
  ...
  {
    name: 'zendesk_talk_agents_activity',
  ...
  {
    name: 'zendesk_talk_agents_overview',
  ...
  {
    name: 'zendesk_talk_call_legs_list',
  ...
  {
    name: 'zendesk_theme_delete',
    description: `Delete a Guide theme by its ID. Cannot delete the account's currently live theme. Returns no content on success. Use this to remove an unused theme once you have its ID from zendesk_themes_list; publish a different theme first with zendesk_theme_publish if this one is currently live.`,
    params: [
      {
        name: 'theme_id',
        type: 'string',
        required: true,
        description: `The unique ID of the Guide theme to delete. Get this from zendesk_themes_list. The account's currently live theme cannot be deleted. Example: 01ecd35c-fe4f-11ea-adc1-0242ac120002.`,
      },
    ],
  },
  {
    name: 'zendesk_theme_get',
    description: `Retrieve a single Guide theme by its ID. Returns the theme's id, name, author, version, live status, and created/updated timestamps. Use this once you have a theme_id from zendesk_themes_list to check a specific theme's details or live status.`,
    params: [
      {
        name: 'theme_id',
        type: 'string',
        required: true,
        description: `The unique ID of the Guide theme to retrieve. Get this from zendesk_themes_list. Example: 01ecd35c-fe4f-11ea-adc1-0242ac120002.`,
      },
    ],
  },
  {
    name: 'zendesk_theme_publish',
    description: `Publish a Guide theme, making it the live theme shown to end users in the Help Center. Returns the updated theme with its live status. Use this once you have a theme_id from zendesk_themes_list to switch which theme is live; use zendesk_theme_get to check a theme's current live status first.`,
    params: [
      {
        name: 'theme_id',
        type: 'string',
        required: true,
        description: `The unique ID of the Guide theme to publish and make live. Get this from zendesk_themes_list. Example: 01ecd35c-fe4f-11ea-adc1-0242ac120002.`,
      },
    ],
  },
  {
    name: 'zendesk_themes_list',
    description: `List the Guide themes installed on the account, optionally filtered by brand. Returns each theme's id, name, author, version, live status, and created/updated timestamps. Use this to browse all themes and find a theme's ID. Use zendesk_theme_get to fetch full details for one theme by ID.`,
    params: [
      {
        name: 'brand_id',
        type: 'number',
  ...
  {
    name: 'zendesk_ticket_collaborators_list',
  ...
  {
    name: 'zendesk_ticket_field_create',
  ...
  {
    name: 'zendesk_ticket_field_update',
  ...
  {
    name: 'zendesk_ticket_fields_list',
  ...
  {
    name: 'zendesk_ticket_followers_list',
  ...
  {
    name: 'zendesk_ticket_form_create',
  ...
  {
    name: 'zendesk_ticket_form_update',
  ...
  {
    name: 'zendesk_ticket_forms_list',
  ...
  {
    name: 'zendesk_ticket_related_get',
  ...
  {
    name: 'zendesk_ticket_tags_delete',
  ...
  {
    name: 'zendesk_user_identities_list',
  ...
  {
    name: 'zendesk_user_identity_create',
  ...
  {
    name: 'zendesk_users_autocomplete',
  ...
  {
    name: 'zendesk_view_tickets_list',
