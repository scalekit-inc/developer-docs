...
export const tools: Tool[] = [
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Loop ID to assign all tasks to (null to unassign)`,
      },
      {
        name: 'priority',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Loop name (e.g., "v2 Auth Refactor", "Payment Bug Fixes")`,
      },
      {
        name: 'ai_context',
        type: 'string',
        required: false,
        description: `Agent instructions for this loop: scope, constraints, architecture decisions, specific requirements. This is shown to implementing agents alongside each task.`,
      },
      {
        name: 'description',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      { name: 'loop_name', type: 'string', required: true, description: `Name for the new loop` },
      {
        ...
        type: 'array',
        required: true,
        description: `Array of task IDs to assign to the new loop`,
      },
      {
        name: 'loop_description',
        type: 'string',
        required: false,
        description: `Description for the new loop`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Task title — a concise summary of what needs to be done`,
      },
      {
        name: 'body',
        type: 'string',
        required: false,
        description: `Agent prompt: detailed instructions for the AI agent that will implement this task. Include specific requirements, acceptance criteria, and any context needed.`,
      },
      {
        name: 'loop_id',
        type: 'string',
        required: false,
        description: `Optional loop ID to assign the task to immediately`,
      },
      {
        name: 'priority',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Which workflow: triage, organize, implement, or manage`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Filter by status: open (new), approved (ready for implementation), in_progress, shipped (done), rejected`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `Array of loop IDs in priority order (first = highest priority)`,
      },
    ],
  },
  {
    ...
    params: [
      { name: 'loop_id', type: 'string', required: true, description: `The loop ID (ULID format)` },
      {
        ...
        type: 'number',
        required: true,
        description: `The priority value (0 = highest priority)`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'task_id', type: 'string', required: true, description: `The task ID (ULID format)` },
      {
        ...
        type: 'string',
        required: false,
        description: `New agent prompt (implementation instructions)`,
      },
      {
        name: 'due_date',
        type: 'string',
        required: false,
        description: `Due date in YYYY-MM-DD format (null to clear)`,
      },
      {
        name: 'loop_id',
        type: 'string',
        required: false,
        description: `Loop ID to assign to (null to unassign from loop)`,
      },
      { name: 'priority', type: 'string', required: false, description: `New priority` },
      {
        ...
        type: 'string',
        required: false,
        description: `New status: approved (approve for implementation), rejected (decline), in_progress (being worked on), shipped (done), on_hold (paused)`,
      },
