...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'accountId', type: 'string', required: true, description: `Mercury account ID. Get it from Get Accounts.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'end_before', type: 'string', required: false, description: `Cursor to fetch the page before this position.` },
      ...
      { name: 'start_after', type: 'string', required: false, description: `Cursor from the previous response to fetch the next page.` },
    ],
  },
  {
    ...
    params: [
      { name: 'accountId', type: 'string', required: true, description: `Mercury account ID. Get it from Get Accounts.` },
      { name: 'end', type: 'string', required: false, description: `Filter by end date (YYYY-MM-DD).` },
      { name: 'end_before', type: 'string', required: false, description: `Cursor to fetch the page before this position.` },
      { name: 'limit', type: 'integer', required: false, description: `Maximum number of items to return per page.` },
      { name: 'order', type: 'string', required: false, description: `Sort order: asc or desc.` },
      { name: 'start', type: 'string', required: false, description: `Filter by start date (YYYY-MM-DD).` },
      { name: 'start_after', type: 'string', required: false, description: `Cursor from the previous response to fetch the next page.` },
    ],
  },
  {
    ...
    params: [
      { name: 'attachmentId', type: 'string', required: true, description: `Mercury attachment ID.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'customerId', type: 'string', required: true, description: `Mercury customer ID. Get it from List Customers.` },
    ],
  },
  {
    ...
    params: [
      { name: 'invoiceId', type: 'string', required: true, description: `Mercury invoice ID. Get it from List Invoices.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'recipientId', type: 'string', required: true, description: `Mercury recipient ID. Get it from Get Recipients.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'safeRequestId', type: 'string', required: true, description: `Mercury SAFE request ID. Get it from Get SAFE Requests.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'accountId', type: 'string', required: true, description: `Mercury account ID. Get it from Get Accounts.` },
      { name: 'transactionId', type: 'string', required: true, description: `Mercury transaction ID. Get it from List Transactions.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'treasuryId', type: 'string', required: true, description: `Mercury treasury account ID. Get it from Get Treasury.` },
      { name: 'documentType', type: 'string', required: false, description: `Filter statements by document type.` },
      { name: 'end_before', type: 'string', required: false, description: `Cursor to fetch the page before this position.` },
      { name: 'limit', type: 'integer', required: false, description: `Maximum number of items to return per page.` },
      { name: 'order', type: 'string', required: false, description: `Sort order: asc or desc.` },
      { name: 'start_after', type: 'string', required: false, description: `Cursor from the previous response to fetch the next page.` },
  ...
  },
  {
    ...
    params: [
      { name: 'treasuryId', type: 'string', required: true, description: `Mercury treasury account ID. Get it from Get Treasury.` },
      { name: 'cursor', type: 'number', required: false, description: `Numeric pagination cursor from the previous response.` },
      { name: 'limit', type: 'integer', required: false, description: `Maximum number of items to return per page.` },
      { name: 'order', type: 'string', required: false, description: `Sort order: asc or desc.` },
    ],
  },
  {
    ...
    params: [
      { name: 'userId', type: 'string', required: true, description: `Mercury user ID. Get it from Get Users.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'webhookEndpointId', type: 'string', required: true, description: `Mercury webhook endpoint ID. Get it from Get Webhooks.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'accountId', type: 'string', required: false, description: `Mercury account ID. Get it from Get Accounts.` },
      { name: 'end_before', type: 'string', required: false, description: `Cursor to fetch the page before this position.` },
      { name: 'limit', type: 'integer', required: false, description: `Maximum number of items to return per page.` },
      { name: 'start_after', type: 'string', required: false, description: `Cursor from the previous response to fetch the next page.` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'categoryId', type: 'string', required: false, description: `Filter by custom expense category ID.` },
      { name: 'end', type: 'string', required: false, description: `Filter by end date (YYYY-MM-DD).` },
      { name: 'end_before', type: 'string', required: false, description: `Cursor to fetch the page before this position.` },
      { name: 'limit', type: 'integer', required: false, description: `Maximum number of items to return per page.` },
      { name: 'mercuryCategory', type: 'string', required: false, description: `Filter by Mercury built-in transaction category.` },
      { name: 'order', type: 'string', required: false, description: `Sort order: asc or desc.` },
      { name: 'postedEnd', type: 'string', required: false, description: `Filter transactions posted on or before this date (YYYY-MM-DD).` },
      { name: 'postedStart', type: 'string', required: false, description: `Filter transactions posted on or after this date (YYYY-MM-DD).` },
      { name: 'search', type: 'string', required: false, description: `Search term to filter transactions by description or counterparty.` },
      { name: 'start', type: 'string', required: false, description: `Filter by start date (YYYY-MM-DD).` },
      { name: 'start_after', type: 'string', required: false, description: `Cursor from the previous response to fetch the next page.` },
      { name: 'start_at', type: 'string', required: false, description: `Filter by start datetime (ISO 8601).` },
      { name: 'status', type: 'array', required: false, description: `No description.` },
    ],
  },
]
