    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The job ID returned by supadata_crawl when the crawl job was created.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The job ID returned by supadata_extract when the extraction job was created.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The job ID returned by supadata_transcript for a large file transcription job.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The full URL of the website to crawl.`,
      },
      {
        name: 'limit',
        type: 'number',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The full URL of the video to extract structured data from.`,
      },
      {
        name: 'prompt',
        type: 'string',
        required: false,
        description: `Natural language prompt describing what to extract from the video. Optional if schema is provided.`,
      },
      {
        name: 'schema',
        type: 'object',
        required: false,
        description: `JSON Schema defining the structure of the extracted output. Optional if prompt is provided.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The full URL of the website to map.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The full URL of the media content to fetch metadata for.`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Language code to filter or request content in (e.g. 'en', 'fr'). Optional.`,
      },
      {
        name: 'noLinks',
        type: 'boolean',
        required: false,
        description: `When true, strips all hyperlinks from the scraped content. Optional, defaults to false.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The full URL of the video or file to transcribe.`,
      },
      {
        name: 'chunkSize',
        type: 'number',
        required: false,
        description: `Size of text chunks to split the transcript into. Optional.`,
      },
      {
        name: 'lang',
        type: 'string',
        required: false,
        description: `Language code for the transcript (e.g. 'en', 'fr'). Optional.`,
      },
      {
        name: 'mode',
        type: 'string',
        required: false,
        description: `Transcription mode to use. Optional.`,
      },
      {
        name: 'text',
        type: 'boolean',
        required: false,
        description: `When true, returns plain text instead of structured transcript data. Optional.`,
      },
    ],
  },
]
