...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: `[STALE: upstream tool "accountQuery" is no longer present in the Pendo MCP server's tools/list as of 2026-08-19; may have been removed or replaced.] Retrieve account data and metadata, or count matching accounts.`,
    params: [
      {
        name: 'subId',
        type: 'string',
...
2. A JSON string containing a full inline pipeline produced by the buildPendoSegment tool, you must not attempt to make this field up, only pass the result of the buildPendoSegment tool. You can pass the entire \`pipeline\` VERBATIM from the buildPendoSegment tool.`,
  ...
  },
  {
    ...
    description: `[STALE: upstream tool "activityQuery" is no longer present in the Pendo MCP server's tools/list as of 2026-08-19; may have been removed or replaced.] Query aggregated activity metrics for pages, features, and track types over a date range.`,
    params: [
      {
        name: 'appId',
        type: 'string',
  ...
  },
  {
    ...
    description: `[STALE: upstream tool "agent_analytics_key_metrics" is no longer present in the Pendo MCP server's tools/list as of 2026-08-19; likely renamed to "agentAnalyticsKeyMetrics".] Return key aggregate metrics for an AI agent's conversations over a date range, with period-over-period comparison.`,
    params: [
      {
        name: 'agentId',
        type: 'string',
...
2. A JSON string containing a full inline pipeline produced by the buildPendoSegment tool, you must not attempt to make this field up, only pass the result of the buildPendoSegment tool. You can pass the entire \`pipeline\` VERBATIM from the buildPendoSegment tool.`,
  ...
  },
  {
    ...
    description: `[STALE: upstream tool "ai_agent_issue_analysis" is no longer present in the Pendo MCP server's tools/list as of 2026-08-19; likely renamed to "agentAnalyticsIssueAnalysis".] Return diagnoses, flagged tool/model usage, and user prompt content for a specific detected issue in an AI agent.`,
    params: [
      {
        name: 'agentId',
        type: 'string',
...
2. A JSON string containing a full inline pipeline produced by the buildPendoSegment tool, you must not attempt to make this field up, only pass the result of the buildPendoSegment tool. You can pass the entire \`pipeline\` VERBATIM from the buildPendoSegment tool.`,
  ...
  },
  {
    ...
    description: `[STALE: upstream tool "get_agent_context" is no longer present in the Pendo MCP server's tools/list as of 2026-08-19; likely renamed to "getAgentContext".] Fetch a grounding document describing a Pendo product resource so an LLM can answer questions about it.`,
    params: [
      {
        name: 'resource_id',
        type: 'string',
...
The maximum time range for this tool is 90 days.`,
  ...
  },
  {
    ...
    description: `[STALE: upstream tool "guideMetrics" is no longer present in the Pendo MCP server's tools/list as of 2026-08-19; likely renamed to "aggregateGuideMetrics".] Get performance metrics for a single guide over a date range, including reach, views, and completion rates.`,
    params: [
      {
        name: 'endDate',
        type: 'string',
...
2. A JSON string containing a full inline pipeline produced by the buildPendoSegment tool, you must not attempt to make this field up, only pass the result of the buildPendoSegment tool. You can pass the entire \`pipeline\` VERBATIM from the buildPendoSegment tool.`,
  ...
  },
  {
    ...
    description: `[STALE: upstream tool "list_ai_agent_issues" is no longer present in the Pendo MCP server's tools/list as of 2026-08-19; likely renamed to "listAiAgentIssues".] List detected issues in an AI agent's conversations with instance and conversation counts.`,
    params: [
      {
        name: 'agentId',
        type: 'string',
  ...
  },
  {
    ...
    description: `[STALE: upstream tool "list_ai_agents" is no longer present in the Pendo MCP server's tools/list as of 2026-08-19; likely renamed to "listAiAgents".] List all AI agents accessible in this subscription with agent IDs, names, and deployment configuration.`,
    params: [
      {
        name: 'subId',
        type: 'string',
  ...
  },
  {
    ...
    description: `[STALE: upstream tool "list_all_applications" is no longer present in the Pendo MCP server's tools/list as of 2026-08-19; likely renamed to "listAllApplications".] List all applications and subscriptions the current user has access to.`,
    params: [
      {
        name: 'userQuery',
        type: 'string',
  ...
  },
  {
    ...
    description: `[STALE: upstream tool "list_spaces" is no longer present in the Pendo MCP server's tools/list as of 2026-08-19; likely renamed to "listSpaces".] List the Pendo Spaces accessible to the current user.`,
    params: [
      {
        name: 'subId',
        type: 'string',
  ...
  },
  {
    ...
    description: `[STALE: upstream tool "list_use_cases" is no longer present in the Pendo MCP server's tools/list as of 2026-08-19; likely renamed to "listUseCases".] Return conversation clustering analysis for an AI agent, grouped by semantic topic.`,
    params: [
      {
        name: 'agentId',
        type: 'string',
...
2. A JSON string containing a full inline pipeline produced by the buildPendoSegment tool, you must not attempt to make this field up, only pass the result of the buildPendoSegment tool. You can pass the entire \`pipeline\` VERBATIM from the buildPendoSegment tool.`,
  ...
  },
  {
    ...
    description: `[STALE: upstream tool "visitorQuery" is no longer present in the Pendo MCP server's tools/list as of 2026-08-19; may have been removed or replaced.] Retrieve visitor data and metadata, or count matching visitors.`,
    params: [
      {
        name: 'appId',
        type: 'string',
