...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    params: [
      { name: 'code', type: 'string', required: true, description: `Async arrow function to execute. Must be in async () => { ... } format using codemode.<function>() calls and console.log() for output.` },
    ],
  },
]
