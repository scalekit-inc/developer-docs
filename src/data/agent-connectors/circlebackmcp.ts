    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The reason why this tool call is being done. This intent is likely to be either the user's original question or the reason to investigate further based on their question.`,
      },
      {
        name: 'meetingIds',
        type: 'array',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'array',
        required: false,
        description: `Optional array of tag IDs to filter by. When included, only results with at least one of the tags will be returned.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'array',
        required: false,
        description: `Optional array of domains to filter by. When included, only results with attendees from all of the provided domains will be returned.`,
      },
      {
        name: 'endDate',
        type: 'string',
      ...
      },
      {
        ...
        type: 'array',
        required: false,
        description: `Optional array of profile IDs to filter by. When included, only results with all of the profiles as attendees will be returned.`,
      },
      {
        name: 'searchTerm',
        type: 'string',
