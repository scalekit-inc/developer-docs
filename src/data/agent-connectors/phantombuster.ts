...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'agentId', type: 'string', required: true, description: `The unique identifier of the agent to permanently delete.` },
    ],
  },
  {
    ...
    params: [
      { name: 'agentId', type: 'string', required: true, description: `The unique identifier of the agent to retrieve.` },
    ],
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `ID of the agent to fetch output from.` },
      { name: 'fromOutputPos', type: 'number', required: false, description: `Start output from this byte position (for incremental fetching).` },
      { name: 'prevContainerId', type: 'string', required: false, description: `Retrieve output from the container after this previous container ID.` },
      { name: 'prevRuntimeEventIndex', type: 'number', required: false, description: `Return runtime events starting from this index.` },
      { name: 'prevStatus', type: 'string', required: false, description: `Previously retrieved status from user-side (for delta detection).` },
    ],
  },
  {
    ...
    params: [
      { name: 'agentId', type: 'string', required: true, description: `The unique identifier of the agent to launch.` },
      { name: 'arguments', type: 'object', required: false, description: `JSON object of input arguments to pass to the agent for this execution.` },
      { name: 'output', type: 'string', required: false, description: `Output mode for the launch response.` },
      { name: 'saveArguments', type: 'boolean', required: false, description: `Whether to persist the provided arguments as the agent's default arguments for future launches.` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'minutes', type: 'integer', required: true, description: `Number of minutes from now after which the agent will launch.` },
      { name: 'argument', type: 'object', required: false, description: `Input arguments to pass to the agent for this execution (object or JSON string).` },
      { name: 'saveArgument', type: 'boolean', required: false, description: `If true, saves the provided argument as the agent's default for future launches.` },
    ],
  },
  {
    ...
    params: [
      { name: 'argument', type: 'object', required: false, description: `Default launch argument for the agent (object or JSON string).` },
      { name: 'branch', type: 'string', required: false, description: `Script branch to use (e.g., main, staging).` },
      { name: 'executionTimeLimit', type: 'number', required: false, description: `Maximum execution time in seconds before the agent is killed.` },
      { name: 'id', type: 'string', required: false, description: `ID of the agent to update. Omit to create a new agent.` },
      { name: 'launchType', type: 'string', required: false, description: `How the agent is launched.` },
      { name: 'maxParallelism', type: 'number', required: false, description: `Maximum number of concurrent executions allowed for this agent.` },
      { name: 'maxRetryNumber', type: 'number', required: false, description: `Maximum number of retries before aborting on failure.` },
      { name: 'name', type: 'string', required: false, description: `Display name for the agent.` },
      { name: 'proxyAddress', type: 'string', required: false, description: `HTTP proxy address or proxy pool name.` },
      { name: 'proxyPassword', type: 'string', required: false, description: `Proxy authentication password.` },
      { name: 'proxyType', type: 'string', required: false, description: `Proxy configuration type.` },
      { name: 'proxyUsername', type: 'string', required: false, description: `Proxy authentication username.` },
      { name: 'script', type: 'string', required: false, description: `Script slug or name to assign to this agent.` },
    ],
  },
  {
    ...
    params: [
      { name: 'agentId', type: 'string', required: true, description: `The unique identifier of the agent to stop.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'messages', type: 'array', required: true, description: `Array of conversation messages. Each must have a role (system, assistant, or user) and content string.` },
      { name: 'model', type: 'string', required: false, description: `AI model to use for the completion.` },
      { name: 'temperature', type: 'number', required: false, description: `Sampling temperature (0–2). Lower = more deterministic, higher = more creative.` },
    ],
  },
  {
    ...
    params: [
      { name: 'name', type: 'string', required: true, description: `Name for the new branch. Only letters, numbers, underscores, and hyphens allowed. Max 50 characters.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'name', type: 'string', required: true, description: `Name of the branch to release.` },
      { name: 'scriptIds', type: 'array', required: true, description: `Array of script IDs to release on this branch.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'id', type: 'string', required: true, description: `ID of the running container to attach to.` },
    ],
  },
  {
    ...
    params: [
      ...
      { name: 'withNewerAndOlderContainerId', type: 'boolean', required: false, description: `Set to true to include the IDs of the next and previous containers for this agent.` },
      { name: 'withOutput', type: 'boolean', required: false, description: `Set to true to include the container's console output.` },
      { name: 'withResultObject', type: 'boolean', required: false, description: `Set to true to include the container's result object.` },
      { name: 'withRuntimeEvents', type: 'boolean', required: false, description: `Set to true to include runtime events (progress, notifications, etc.).` },
    ],
  },
  {
    ...
    params: [
      { name: 'containerId', type: 'string', required: true, description: `The unique identifier of the container whose output to retrieve.` },
    ],
  },
  {
    ...
    params: [
      { name: 'containerId', type: 'string', required: true, description: `The unique identifier of the container whose result to retrieve.` },
    ],
  },
  {
    ...
    params: [
      { name: 'agentId', type: 'string', required: true, description: `The unique identifier of the agent whose containers to retrieve.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'listId', type: 'string', required: true, description: `ID of the lead list to fetch leads from.` },
      { name: 'includeTotalCount', type: 'boolean', required: false, description: `Include the total count of leads in the response.` },
      { name: 'paginationOffset', type: 'integer', required: false, description: `Offset for pagination.` },
      { name: 'paginationOrder', type: 'string', required: false, description: `Sort order for pagination.` },
      { name: 'paginationSize', type: 'integer', required: false, description: `Number of leads per page.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'leads', type: 'array', required: true, description: `Array of lead objects to save.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'ip', type: 'string', required: true, description: `IPv4 or IPv6 address to look up.` },
    ],
  },
  {
    ...
    params: [
      { name: 'days', type: 'string', required: true, description: `Number of days of usage data to export. Maximum is ~180 days (6 months).` },
    ],
  },
  {
    ...
    params: [
      { name: 'days', type: 'string', required: true, description: `Number of days of usage data to export. Maximum is ~180 days (6 months).` },
      { name: 'agentId', type: 'string', required: false, description: `Filter the export to a specific agent ID.` },
    ],
  },
  {
    ...
    params: [
      { name: 'withCrmIntegrations', type: 'boolean', required: false, description: `Include the organization's CRM integrations.` },
      { name: 'withCustomPrompts', type: 'boolean', required: false, description: `Include the organization's custom prompts.` },
      { name: 'withGlobalObject', type: 'boolean', required: false, description: `Include the organization's global object in the response.` },
      { name: 'withProxies', type: 'boolean', required: false, description: `Include the organization's proxy pool configuration.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'agentGroups', type: 'array', required: true, description: `Array of agent groups. Each item is either an agent ID string or an object with id, name, and agents array.` },
    ],
  },
  {
    ...
    params: [
      { name: 'crmName', type: 'string', required: true, description: `The CRM to save the contact to.` },
      ...
      { name: 'pb_linkedin_profile_url', type: 'string', required: true, description: `LinkedIn profile URL of the contact.` },
      { name: 'company', type: 'string', required: false, description: `Company the contact works at.` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'branch', type: 'string', required: false, description: `Branch of the script to fetch.` },
      { name: 'withCode', type: 'boolean', required: false, description: `Set to true to include the script's source code in the response.` },
    ],
  },
  {
    ...
    params: [
      { name: 'branch', type: 'string', required: false, description: `Filter scripts by branch name.` },
      { name: 'exclude', type: 'string', required: false, description: `Exclude modules or non-modules from results.` },
      { name: 'org', type: 'string', required: false, description: `Filter scripts by organization.` },
    ],
  },
]
