...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'cursor', type: 'string', required: false, description: `Pagination cursor from the previous response to fetch the next batch of events.` },
      { name: 'end_time', type: 'integer', required: false, description: `Unix timestamp (seconds) to stop fetching events at.` },
      { name: 'events', type: 'string', required: false, description: `Comma-separated event types to filter. All returned by default.` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'comment_id', type: 'string', required: false, description: `The ID of the comment to reply to. If provided, this creates a reply to that comment.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'branch_data', type: 'boolean', required: false, description: `Include data on branches of the file.` },
      { name: 'depth', type: 'integer', required: false, description: `Depth of the document tree to return (1-4). Lower depth returns faster.` },
      { name: 'geometry', type: 'string', required: false, description: `Set to "paths" to export vector path data.` },
      { name: 'ids', type: 'string', required: false, description: `Comma-separated node IDs to fetch.` },
      { name: 'plugin_data', type: 'string', required: false, description: `Plugin IDs to return plugin data for.` },
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'contents_only', type: 'boolean', required: false, description: `Render only node contents without background.` },
      ...
      { name: 'svg_include_id', type: 'boolean', required: false, description: `Include id attributes on SVG elements.` },
      { name: 'svg_include_node_id', type: 'boolean', required: false, description: `Include node_id attributes on SVG elements.` },
      { name: 'svg_outline_text', type: 'boolean', required: false, description: `Outline all text in SVG output.` },
      { name: 'svg_simplify_stroke', type: 'boolean', required: false, description: `Simplify stroke operations in SVG output.` },
      { name: 'use_absolute_bounds', type: 'boolean', required: false, description: `Use absolute bounding box for rendering.` },
  ...
  },
  {
    ...
    params: [
      { name: 'file_key', type: 'string', required: true, description: `The file or branch key to update variables in.` },
      { name: 'schema_version', type: 'string', required: false, description: `Optional schema version` },
      { name: 'tool_version', type: 'string', required: false, description: `Optional tool version` },
      { name: 'variableCollections', type: 'array', required: false, description: `Variable collections to create, update, or delete.` },
      { name: 'variableModes', type: 'array', required: false, description: `Variable modes to create, update, or delete.` },
      { name: 'variableModeValues', type: 'array', required: false, description: `Variable mode values to set.` },
      { name: 'variables', type: 'array', required: false, description: `Variables to create, update, or delete.` },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      { name: 'file_key', type: 'string', required: true, description: `The key of the library Figma file.` },
      { name: 'group_by', type: 'string', required: true, description: `Group analytics results by COMPONENT, TEAM, or FILE.` },
      { name: 'cursor', type: 'string', required: false, description: `Pagination cursor from previous response.` },
    ],
  },
  {
