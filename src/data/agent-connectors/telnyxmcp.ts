...
export const tools: Tool[] = [
  {
    ...
    params: [
      { name: 'endpoint', type: 'string', required: true, description: `The name of the endpoint to get the schema for, as returned by list_api_endpoints.` },
    ],
  },
  {
    ...
    params: [
      { name: 'args', type: 'object', required: true, description: `Arguments for the endpoint, matching the schema returned by get_api_endpoint_schema. Pass as a JSON object of parameter names to values.` },
      { name: 'endpoint_name', type: 'string', required: true, description: `The name of the Telnyx API endpoint to invoke, as returned by list_api_endpoints.` },
    ],
  },
  {
    ...
    params: [
      { name: 'search_query', type: 'string', required: false, description: `Optional search query to filter endpoints. Provide a partial name, resource, operation, or tag (e.g. 'messages', 'phone numbers', 'create call').` },
    ],
  },
]
