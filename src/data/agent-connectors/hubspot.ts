    ...
    params: [
      {
        ...
        type: 'array',
        required: true,
        description: `Array of contact objects to create. Each contact requires an email address.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The object type ID of the custom object (e.g., 2-1234567)`,
      },
      {
        name: 'properties',
        type: 'string',
