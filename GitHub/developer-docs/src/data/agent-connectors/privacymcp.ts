    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Card type: SINGLE_USE (closes after first use), MERCHANT_LOCKED (locks to first merchant)`,
      },
      { name: 'memo', type: 'string', required: false, description: `Friendly name for the card` },
      {
        ...
        type: 'number',
        required: false,
        description: `Spend limit in dollars (e.g. 25.00)`,
      },
      {
        name: 'spend_limit_duration',
        type: 'string',
        required: false,
        description: `How the spend limit resets: per TRANSACTION, MONTHLY, ANNUALLY, or FOREVER (lifetime)`,
      },
      {
        name: 'state',
        type: 'string',
        required: false,
        description: `Initial card state (default: OPEN)`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Token of the card to retrieve`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: false,
        description: `Filter transactions by account token`,
      },
      {
        name: 'begin',
        type: 'string',
      ...
      },
      {
        ...
        type: 'integer',
        required: false,
        description: `Number of transactions per page (1-1000, default 20)`,
      },
      {
        name: 'result',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Token of the card to update`,
      },
      {
        name: 'memo',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'number',
        required: true,
        description: `New spend limit in dollars (e.g. 25.00)`,
      },
      {
        name: 'spend_limit_duration',
        type: 'string',
        required: false,
        description: `How the spend limit resets: per TRANSACTION, MONTHLY, ANNUALLY, or FOREVER (lifetime). If omitted, keeps the current duration.`,
      },
    ],
  },
]
