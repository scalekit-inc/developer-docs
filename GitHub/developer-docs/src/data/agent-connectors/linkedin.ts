    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `End date for the analytics period in YYYY-MM-DD format.`,
      },
      {
        name: 'date_range_start',
        type: 'string',
        required: true,
        description: `Start date for the analytics period in YYYY-MM-DD format.`,
      },
      {
        name: 'pivot',
        type: 'string',
        required: true,
        description: `Dimension to pivot analytics by. One of: CREATIVE, CAMPAIGN, CAMPAIGN_GROUP, ACCOUNT, MEMBER_COMPANY, MEMBER_COUNTRY_V2, MEMBER_REGION_V2, MEMBER_JOB_TITLE.`,
      },
      {
        name: 'time_granularity',
        type: 'string',
        required: true,
        description: `Time granularity for grouping analytics data. One of: DAILY, MONTHLY, ALL.`,
      },
      {
        name: 'campaigns',
        type: 'string',
        required: false,
        description: `Campaign URN to filter analytics (e.g. 'urn:li:sponsoredCampaign:712345678'). Provide this or account_id.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `The image URN returned from the initializeUpload response (e.g. urn:li:image:C4E22AQGadflBbEegg).`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `The campaign type. One of: SPONSORED_UPDATES, TEXT_AD, SPONSORED_INMAILS, DYNAMIC. Defaults to TEXT_AD.`,
      },
      {
        name: 'locale_country',
        type: 'string',
        required: false,
        description: `ISO 3166-1 alpha-2 country code for the campaign locale (e.g. US). Defaults to US.`,
      },
      {
        name: 'locale_language',
        type: 'string',
        required: false,
        description: `ISO 639-1 language code for the campaign locale (e.g. en). Defaults to en.`,
      },
      {
        name: 'status',
        type: 'string',
        required: false,
        description: `Initial campaign status. One of: ACTIVE, PAUSED, DRAFT. Defaults to DRAFT.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'integer',
        required: false,
        description: `Start time for the campaign group as Unix epoch milliseconds. If omitted, the group starts immediately.`,
      },
      {
        name: 'status',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `URL-encoded URN of the parent post. Example: urn%3Ali%3AugcPost%3A7123456789.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `The numeric ID of the campaign this creative belongs to.`,
      },
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `URN of the person or organization that owns the image (e.g. urn:li:person:{id} or urn:li:organization:{id}).`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `URN of the organization whose followers to search within.`,
      },
      {
        name: 'count',
        type: 'integer',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `Comma-separated list of recipient person URNs. Recipients must be first-degree connections of the authenticated member.`,
      },
      {
        name: 'subject',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Raw (unencoded) URN of the person or organization liking the post, e.g. urn:li:person:abc123.`,
      },
      {
        name: 'entity_urn',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `URL-encoded URN of the post or entity to list reactions for. Example: urn%3Ali%3AugcPost%3A7123456789.`,
      },
      {
        name: 'count',
        type: 'integer',
