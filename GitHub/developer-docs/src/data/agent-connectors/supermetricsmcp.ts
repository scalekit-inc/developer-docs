    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Data source identifier (e.g. \`GA4\`, \`FA\`, \`ADWORDS\`). Use \`data_source_discovery\` to list available IDs.`,
      },
      {
        name: 'compress',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Text filter to narrow discovery results.`,
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Ad account or profile ID for the selected data source.`,
      },
      {
        name: 'ds_id',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Resource-type-specific parameters. See ResourceParams for which fields apply to each resource_type.`,
      },
      {
        name: 'resource_type',
        type: 'string',
        required: false,
        description: `Type of resource to retrieve (e.g. \`CAMPAIGN\`, \`AD_GROUP\`).`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `New budget type: DAILY or LIFETIME. LIA: only LIFETIME at campaign level. AC: LIFETIME only works on AUDIENCE campaigns.`,
      },
      {
        name: 'end_date',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Replace extensions (removes old, adds new) — AW/AC. Ignored on FA/TIK.`,
      },
      {
        name: 'name',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Platform-specific settings to update. AW/AC/FA: {bidding_config: {target_roas (float, e.g. 3.5 = 350%), target_cpa (float, e.g. 5.0 = $5)}}. AW: {ad_schedule, bid_adjustments}. FA: {campaign_budget_optimization (true=CBO on, false=CBO off)}.`,
      },
      {
        name: 'remove_ad_group_ids',
        type: 'string',
        required: false,
        description: `Ad group / ad set IDs to remove`,
      },
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Replace campaign targeting (removes old, adds new)`,
      },
      {
        name: 'url_tags',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Detailed description. Include relevant context: tools used, errors encountered, data sources involved, trace IDs`,
      },
      {
        name: 'subject',
        type: 'string',
        required: true,
        description: `Brief summary of the feedback or issue`,
      },
      {
        name: 'type',
        type: 'string',
        required: true,
        description: `Type of contact: 'feedback' for product feedback/feature requests, 'support' for technical issues, 'sales' for sales enquiries and demo requests`,
      },
      {
        name: 'category',
        type: 'string',
        required: false,
        description: `Support ticket category. Only used when type is 'support'`,
      },
      {
        name: 'company',
        type: 'string',
        required: false,
        description: `Contact's company name. Required when type is 'sales'`,
      },
      {
        name: 'country',
        type: 'string',
        required: false,
        description: `Contact's country. Required when type is 'sales'`,
      },
      {
        name: 'ds_id',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Contact's first name. Required when type is 'sales'`,
      },
      {
        name: 'industry',
        type: 'string',
        required: false,
        description: `Contact's industry. Used when type is 'sales'`,
      },
      {
        name: 'lastname',
        type: 'string',
        required: false,
        description: `Contact's last name. Required when type is 'sales'`,
      },
    ],
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `End of the comparison period (YYYY-MM-DD). Required when \`compare_type\` is \`custom\`.`,
      },
      {
        name: 'compare_show',
        type: 'string',
...
- 'value': raw value from the comparison period`,
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Start of the comparison period (YYYY-MM-DD). Required when \`compare_type\` is \`custom\`.`,
      },
      {
        name: 'compare_type',
        type: 'string',
        required: false,
        description: `Select how to compare results to an earlier period:
...
- 'custom': user-defined period (requires compare_start_date and compare_end_date)`,
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Preset date range (e.g. \`last_30_days\`, \`last_month\`). Use instead of \`start_date\`/\`end_date\`.`,
      },
      {
        name: 'ds_accounts',
        type: 'string',
        required: false,
        description: `List of account IDs to query data from.`,
      },
      {
        name: 'end_date',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `List of metric and dimension field names to include. Use \`field_discovery\` to find valid field names.`,
      },
      {
        name: 'filters',
        type: 'string',
        required: false,
        description: `List of field filters to narrow the query results.`,
      },
      {
        name: 'max_rows',
        type: 'string',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `All data source-specific settings from data_source_discovery config mode. Pass as a JSON object. IMPORTANT: Every setting_id from data_source_discovery (report_type, common_settings, report-type-specific settings) MUST be passed inside this object — do NOT pass them as separate root-level parameters. Example: {"report_type": "TopIosApps", "country": "US", "list_type": "top-free"}`,
      },
      {
        name: 'start_date',
        type: 'string',
    ...
    params: [
      {
        ...
        type: 'string',
        required: true,
        description: `Schedule ID returned by \`data_query\` for async result retrieval.`,
      },
      {
        name: 'compress',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: `Action to perform on the resource (e.g. \`browse_assets\`).`,
      },
      {
        name: 'asset_type',
        type: 'string',
        required: false,
        description: `Type of creative asset to manage (e.g. \`IMAGE\`, \`VIDEO\`).`,
      },
      {
        name: 'params',
        type: 'string',
        required: false,
        description: `Internal action-specific parameters (used by the picker UI).`,
      },
    ],
  },
  {
