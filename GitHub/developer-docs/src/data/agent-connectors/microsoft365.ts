  ...
  },
  {
    ...
    params: [
      ...
      { name: 'subject', type: 'string', required: true, description: `No description.` },
      {
        ...
        type: 'string',
        required: true,
        description: `The user ID or userPrincipalName (email) of the target user whose data you are accessing (e.g., colleague@company.com or an object ID). Access must be granted via application permissions or delegated sharing.`,
      },
      {
        name: 'attendees_optional',
        type: 'string',
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: true,
        description: `The email address or user ID of the shared mailbox to read the message from (e.g., support@company.com or a user object ID).`,
      },
    ],
  },
  {
