...
| PY-603    | Pylon #603  | SaaSKit          | Validate OIDC id_token in Ruby          | yes        | FAQ `<details>`       | `authenticate/fsa/complete-login.mdx`                                     | User authentication      | **Done** (PR #745 rev)   | #585         |
| PY-658    | Pylon #658  | MCP Auth         | Build CLI OAuth client (PKCE + DCR)     | yes        | Cookbook (oclif)      | `cookbooks/` — defer to issue                                             | Resources / cookbooks    | Defer — cookbook         | #601         |
